...
/* renamed from: mv.h */
public final class C18474h extends C20664g<Boolean> {
    /* renamed from: b */
    ...
    public final Object mo6591f(Context context, C18299a aVar, String str) throws IOException, AppDataPartLoadFailedException, ServerException {
        ...
        if (aVar2 != null && ((Boolean) aVar2.mo51505b(C20199a.f51300s0)).booleanValue()) {
            return Boolean.TRUE;
        }
        throw new AppDataPartLoadFailedException("Ride sharing not supported in the current metro configuration.", (String) null, (Throwable) null);
    }
}
