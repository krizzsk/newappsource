...
public class InterstitialAd implements FullScreenAd {
    ...
    @Keep
    public interface InterstitialAdLoadConfigBuilder extends C2289Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface InterstitialLoadAdConfig extends C2289Ad.LoadAdConfig {
    }
