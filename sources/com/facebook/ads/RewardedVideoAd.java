...
public class RewardedVideoAd implements FullScreenAd {
    ...
    @Keep
    public interface RewardedVideoAdLoadConfigBuilder extends C2289Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface RewardedVideoLoadAdConfig extends C2289Ad.LoadAdConfig {
    }
