...
public class RewardedInterstitialAd implements FullScreenAd {
    ...
    @Keep
    public interface RewardedInterstitialAdLoadConfigBuilder extends C2289Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface RewardedInterstitialLoadAdConfig extends C2289Ad.LoadAdConfig {
    }
