...
final class C21976lr implements C21982lx {
    ...
    public C21976lr(C21985lz.C21986a aVar, byte[] bArr, byte[] bArr2) {
        ...
        instance.init(C21979lu.m53617b(aVar), new SecretKeySpec(bArr, "DESede"), new IvParameterSpec(bArr2));
        C21050d dVar = C21050d.f52856a;
        this.f55489a = instance;
    }

    /* renamed from: a */
    public byte[] mo55806a(byte[] bArr, int i, int i2) {
        C24362h.m61211f(bArr, "bytes");
        byte[] doFinal = this.f55489a.doFinal(bArr, i, i2);
