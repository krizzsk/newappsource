...
public final class MutableOptionsBundle extends OptionsBundle implements MutableConfig {
    ...
    public <ValueT> void insertOption(Config.Option<ValueT> option, Config.OptionPriority optionPriority, ValueT valuet) {
        ...
        if (map.get(optionPriority2).equals(valuet) || !C12685f.m32408a(optionPriority2, optionPriority)) {
            map.put(optionPriority, valuet);
            return;
        }
        StringBuilder k = C13555b.m33972k("Option values conflicts: ");
        k.append(option.getId());
        k.append(", existing value (");
        k.append(optionPriority2);
        k.append(")=");
        k.append(map.get(optionPriority2));
