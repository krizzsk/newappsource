...
import com.veriff.sdk.camera.camera2.internal.compat.quirk.StillCaptureFlashStopRepeatingQuirk;
...
public class StillCaptureFlow {
    ...
    public boolean shouldStopRepeatingBeforeCapture(java.util.List<android.hardware.camera2.CaptureRequest> r3, boolean r4) {
        ...
        L_0x002c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.veriff.sdk.camera.camera2.internal.compat.workaround.StillCaptureFlow.shouldStopRepeatingBeforeCapture(java.util.List, boolean):boolean");
    }
}
