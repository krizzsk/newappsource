...
public class JsonReader implements Closeable {
    ...
    static {
        C13820i.INSTANCE = new C13820i() {
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof C16605e) {
                    C16605e eVar = (C16605e) jsonReader;
                    eVar.getClass();
                    eVar.mo49366a(JsonToken.NAME);
                    Map.Entry entry = (Map.Entry) ((Iterator) eVar.mo49367e()).next();
                    eVar.mo49369j(entry.getValue());
                    eVar.mo49369j(new C13454k((String) entry.getKey()));
                    return;
                }
                ...
                if (i == 13) {
                    ...
                    k.append(jsonReader.locationString());
        ...
        while (true) {
            if (i == i2) {
                ...
                if (fillBuffer(1)) {
                    ...
                    StringBuilder k = C13555b.m33972k("End of input");
                    ...
                    while (i5 < i6) {
                        ...
                        if (c3 < '0' || c3 > '9') {
                            if (c3 >= 'a' && c3 <= 'f') {
                                ...
                                StringBuilder k = C13555b.m33972k("\\u");
                                k.append(new String(this.buffer, this.pos, 4));
    ...
    public String locationString() {
        StringBuilder s = C0016g.m35s(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        s.append(getPath());
        return s.toString();
    }
    ...
    public int nextInt() throws IOException {
        ...
        k3.append(this.peekedString);
        k3.append(locationString());
    ...
    public void skipValue() throws IOException {
        ...
        int i4 = i3 - 1;
        iArr[i4] = iArr[i4] + 1;
        this.pathNames[i3 - 1] = StringUtils.NULL_USER_ID_SUBSTITUTE_STRING;
    }
