...
public class JsonWriter implements Closeable, Flushable {
    ...
    private static final String[] REPLACEMENT_CHARS = new String[RecyclerView.C1119a0.FLAG_IGNORE];
    ...
    public JsonWriter nullValue() throws IOException {
        ...
        beforeValue();
        this.out.write(StringUtils.NULL_USER_ID_SUBSTITUTE_STRING);
        return this;
    }
    ...
    public JsonWriter value(boolean z) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(z ? InneractiveMediationDefs.SHOW_HOUSE_AD_YES : "false");
        return this;
    }
