...
public class ModuleAvailabilityResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "areModulesAvailable", mo65739id = 1)
    private final boolean zaa;
    @SafeParcelable.Field(getter = "getAvailabilityStatus", mo65739id = 2)
    ...
    @KeepForSdk
    public ModuleAvailabilityResponse(@SafeParcelable.Param(mo65742id = 1) boolean z, @SafeParcelable.Param(mo65742id = 2) int i) {
        this.zaa = z;
        this.zab = i;
    }
