...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusMessage", mo65739id = 2)
    private final String zzd;
    @SafeParcelable.Field(getter = "getPendingIntent", mo65739id = 3)
    private final PendingIntent zze;
    @SafeParcelable.Field(getter = "getConnectionResult", mo65739id = 4)
    ...
    public Status(@SafeParcelable.Param(mo65742id = 1000) int i, @SafeParcelable.Param(mo65742id = 1) int i2, @SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo65742id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
