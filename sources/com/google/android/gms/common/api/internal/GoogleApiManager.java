...
public class GoogleApiManager implements Handler.Callback {
    ...
    /* access modifiers changed from: private */
    public long zae = InstallSheetPresenter.LOADING_TIMER_DELAY_IN_MILLIS;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public final Set zar = new C6304d();
    private final Set zas = new C6304d();
    /* access modifiers changed from: private */
    ...
    public static Status zaH(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, C25541a.m63882l("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
            ...
            case 5:
                ...
                if (zabq != null) {
                    if (connectionResult.getErrorCode() != 13) {
                        ...
                        zabq.zaD(new Status(17, C25541a.m63882l("Error resolution was canceled by the user, original error message: ", this.zal.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                        break;
                    }
                } else {
                    StringBuilder r = C25541a.m63887r("Could not find API instance ", i, " while trying to fail enqueued calls.");
                    Log.wtf("GoogleApiManager", r.toString(), new Exception());
                    break;
                }
            case 6:
