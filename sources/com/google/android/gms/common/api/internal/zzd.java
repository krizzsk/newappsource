...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = DesugarCollections.synchronizedMap(new C6302b());
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzd3 = (zzd) fragmentActivity.getSupportFragmentManager().mo3923A("SupportLifecycleFragmentImpl");
            if (zzd3 == null || zzd3.isRemoving()) {
                zzd3 = new zzd();
                FragmentManager supportFragmentManager = fragmentActivity.getSupportFragmentManager();
                C0909a K = C0017h.m54K(supportFragmentManager, supportFragmentManager);
                K.mo4041e(0, zzd3, "SupportLifecycleFragmentImpl", 1);
                K.mo4043i();
            }
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(C13437d.m33706k("LifecycleCallback with tag ", str, " already added to this fragment."));
    }
