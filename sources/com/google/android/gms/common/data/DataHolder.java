...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public int zad;
    public boolean zae;
    @SafeParcelable.Field(getter = "getColumns", mo65739id = 1)
    private final String[] zag;
    @SafeParcelable.Field(getter = "getWindows", mo65739id = 2)
    private final CursorWindow[] zah;
    @SafeParcelable.Field(getter = "getStatusCode", mo65739id = 3)
    private final int zai;
    @SafeParcelable.Field(getter = "getMetadata", mo65739id = 4)
    ...
    public DataHolder(@SafeParcelable.Param(mo65742id = 1000) int i, @SafeParcelable.Param(mo65742id = 1) String[] strArr, @SafeParcelable.Param(mo65742id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo65742id = 3) int i2, @SafeParcelable.Param(mo65742id = 4) Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
