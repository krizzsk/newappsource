...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(C16759e.m42349e("Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (getFieldId(readHeader) == 20293) {
            ...
            throw new ParseException(C13715c.m34244j("Size read is invalid start=", dataPosition, " end=", i), parcel);
        }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new ParseException(C0016g.m31o(C0016g.m35s("Expected size ", i3, " got ", i2, " (0x"), Integer.toHexString(i2), ")"), parcel);
        }
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        int readSize = readSize(parcel, i);
        if (readSize != i2) {
            throw new ParseException(C0016g.m31o(C0016g.m35s("Expected size ", i2, " got ", readSize, " (0x"), Integer.toHexString(readSize), ")"), parcel);
        }
    }
}
