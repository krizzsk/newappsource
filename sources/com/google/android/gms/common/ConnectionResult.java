...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo65739id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getResolution", mo65739id = 3)
    private final PendingIntent zzc;
    @SafeParcelable.Field(getter = "getErrorMessage", mo65739id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(mo65742id = 1) int i, @SafeParcelable.Param(mo65742id = 2) int i2, @SafeParcelable.Param(mo65742id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo65742id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        return C25541a.m63878h("UNKNOWN_ERROR_CODE(", i, ")");
                }
        }
    }
    ...
    public String toString() {
        ...
        stringHelper.add(InAppMessageBase.MESSAGE, this.zzd);
