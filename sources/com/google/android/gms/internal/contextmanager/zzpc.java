...
final class zzpc {
    private static final zzoz zza = new zzpa();

    static {
        if (zzox.zzx() && zzox.zzy()) {
            int i = zzkp.zza;
        }
    }
    ...
    public static String zzd(byte[] bArr, int i, int i2) throws zzmp {
        int i3;
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r11 < i4) {
                ...
                if (zzoy.zzd(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzoy.zzc(b2, bArr[i6], bArr[i8], cArr, i3);
                        r11 = i8 + 1;
                        i3++;
                    } else {
                        throw zzmp.zzc();
                    ...
                    int i9 = i6 + 1;
                    int i11 = i9 + 1;
                    zzoy.zza(b2, bArr[i6], bArr[i9], bArr[i11], cArr, i3);
                    i3 += 2;
                    r11 = i11 + 1;
                } else {
                    throw zzmp.zzc();
