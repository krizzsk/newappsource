...
final class zzlw extends zzko<Float> implements RandomAccess, zznv {
    private static final zzlw zza;
    private float[] zzb;
    private int zzc;

    static {
        zzlw zzlw = new zzlw(new float[0], 0);
        zza = zzlw;
        zzlw.zzb();
    }
    ...
    public final /* bridge */ /* synthetic */ zzmm zzd(int i) {
        if (i >= this.zzc) {
            return new zzlw(Arrays.copyOf(this.zzb, i), this.zzc);
        }
