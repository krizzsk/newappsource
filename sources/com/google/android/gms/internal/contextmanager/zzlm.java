...
final class zzlm extends zzko<Double> implements RandomAccess, zznv {
    private static final zzlm zza;
    private double[] zzb;
    private int zzc;

    static {
        zzlm zzlm = new zzlm(new double[0], 0);
        zza = zzlm;
        zzlm.zzb();
    }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzmn.zzc(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* bridge */ /* synthetic */ zzmm zzd(int i) {
        if (i >= this.zzc) {
            return new zzlm(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzlm(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
