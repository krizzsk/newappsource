...
final class zzli extends zzlk {
    ...
    public zzli(byte[] bArr, int i, int i2) {
        super((zzlh) null);
        if (bArr != null) {
    ...
    public final void zzb(byte b) throws IOException {
        try {
            ...
            throw new zzlj(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzlj(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzD2 == zzD) {
                int i2 = i + zzD2;
                this.zzd = i2;
                int zzb2 = zzpc.zzb(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzq((zzb2 - i) - zzD2);
                this.zzd = zzb2;
                return;
            ...
            byte[] bArr = this.zzb;
            int i3 = this.zzd;
            this.zzd = zzpc.zzb(str, bArr, i3, this.zzc - i3);
        } catch (zzpb e) {
            this.zzd = i;
            zzH(str, e);
    ...
    public final void zzs(long j) throws IOException {
        if (!zzlk.zzc || this.zzc - this.zzd < 10) {
            while ((j & -128) != 0) {
                byte[] bArr = this.zzb;
                int i = this.zzd;
                this.zzd = i + 1;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzox.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
            this.zzd = i4 + 1;
            zzox.zzn(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
