...
public final class zzcg extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTemporaryExposureKeyListCallbackAsBinder", mo65739id = 2, type = "android.os.IBinder")
    public zzdy zza;
    @SafeParcelable.Field(getter = "getTemporaryExposureKeyHistoryResultCallbackAsBinder", mo65739id = 1, type = "android.os.IBinder")
    private zzdv zzb;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzcg) {
            zzcg zzcg = (zzcg) obj;
            if (!Objects.equal(this.zzb, zzcg.zzb) || !Objects.equal(this.zza, zzcg.zza)) {
                return false;
            }
            return true;
        }
    ...
    public zzcg(@com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo65742id = 1) android.os.IBinder r4, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo65742id = 2) android.os.IBinder r5) {
        /*
            r3 = this;
            r0 = 0
    ...
    public /* synthetic */ zzcg(zzcf zzcf) {
    }
}
