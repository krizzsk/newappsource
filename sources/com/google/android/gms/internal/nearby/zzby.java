...
public final class zzby extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getPackageConfigurationCallbackAsBinder", mo65739id = 1, type = "android.os.IBinder")
    public zzdu zza;
    ...
    public zzby(@com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo65742id = 1) android.os.IBinder r3) {
        /*
            r2 = this;
    ...
    public /* synthetic */ zzby(zzbx zzbx) {
    }
}
