...
final class zzfk implements C19449c<zzhp> {
    ...
    static {
        ...
        zzd = new C19448b("inputsFormats", C16530d.m42017j(hashMap3));
        zzcw f4 = C13715c.m34240f(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(f4.annotationType(), f4);
        zze = new C19448b("outputFormats", C16530d.m42017j(hashMap4));
        zzcw f5 = C13715c.m34240f(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(f5.annotationType(), f5);
        zzf = new C19448b("modelInitializationMs", C16530d.m42017j(hashMap5));
    }
