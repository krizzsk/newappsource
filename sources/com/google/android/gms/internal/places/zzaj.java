...
public abstract class zzaj extends zzt {
    ...
    public static class zzb extends zzaj {
        ...
        public final void zzo(int i) throws IOException {
            if (!zzaj.zzer || zzp.zzy() || zzak() < 5) {
                ...
                this.position = i5 + 1;
                zzdy.zzb(bArr4, (long) i5, (byte) (i | RecyclerView.C1119a0.FLAG_IGNORE));
                int i6 = i >>> 7;
                if ((i6 & -128) == 0) {
                ...
                this.position = i8 + 1;
                zzdy.zzb(bArr6, (long) i8, (byte) (i6 | RecyclerView.C1119a0.FLAG_IGNORE));
                int i9 = i6 >>> 7;
                if ((i9 & -128) == 0) {
                    byte[] bArr7 = this.buffer;
                    int i11 = this.position;
                    this.position = i11 + 1;
                    zzdy.zzb(bArr7, (long) i11, (byte) i9);
                    return;
                }
                byte[] bArr8 = this.buffer;
                int i12 = this.position;
                this.position = i12 + 1;
                zzdy.zzb(bArr8, (long) i12, (byte) (i9 | RecyclerView.C1119a0.FLAG_IGNORE));
                int i13 = i9 >>> 7;
                if ((i13 & -128) == 0) {
                    byte[] bArr9 = this.buffer;
                    int i14 = this.position;
                    this.position = i14 + 1;
                    zzdy.zzb(bArr9, (long) i14, (byte) i13);
                    return;
                }
                byte[] bArr10 = this.buffer;
                int i15 = this.position;
                this.position = i15 + 1;
                zzdy.zzb(bArr10, (long) i15, (byte) (i13 | RecyclerView.C1119a0.FLAG_IGNORE));
                byte[] bArr11 = this.buffer;
                int i16 = this.position;
                this.position = i16 + 1;
                zzdy.zzb(bArr11, (long) i16, (byte) (i13 >>> 7));
            }
        }
        ...
        public final void zzc(long j) throws IOException {
            if (!zzaj.zzer || zzak() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zzdy.zzb(bArr3, (long) i3, (byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    public static int zzc(int i, zzck zzck, zzda zzda) {
        return zzb(zzck, zzda) + zzr(i);
    }
    ...
    public static int zzc(int i, zzck zzck) {
        return zzd(zzck) + zzr(3) + zzi(2, i) + (zzr(1) << 1);
    }
    ...
    @Deprecated
    public static int zzd(int i, zzck zzck, zzda zzda) {
        int zzr = zzr(i) << 1;
        zzm zzm = (zzm) zzck;
        int zzw = zzm.zzw();
        if (zzw == -1) {
