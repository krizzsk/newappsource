...
final class zzdc {
    ...
    public static int zzp(int i, List<Long> list, boolean z) {
        ...
        return (zzaj.zzr(i) * list.size()) + zze(list);
    }
    ...
    public static int zzq(int i, List<Long> list, boolean z) {
        ...
        return (zzaj.zzr(i) * size) + zzf(list);
    }
    ...
    public static int zzr(int i, List<Long> list, boolean z) {
        ...
        return (zzaj.zzr(i) * size) + zzg(list);
    }
    ...
    public static int zzs(int i, List<Integer> list, boolean z) {
        ...
        return (zzaj.zzr(i) * size) + zzh(list);
    }
    ...
    public static int zzt(int i, List<Integer> list, boolean z) {
        ...
        return (zzaj.zzr(i) * size) + zzi(list);
    }
    ...
    public static int zzu(int i, List<Integer> list, boolean z) {
        ...
        return (zzaj.zzr(i) * size) + zzj(list);
    }
    ...
    public static int zzv(int i, List<Integer> list, boolean z) {
        ...
        return (zzaj.zzr(i) * size) + zzk(list);
    }
    ...
    public static <T> void zzb(zzcd zzcd, T t, T t2, long j) {
    ...
    public static <T, FT extends zzax<FT>> void zzb(zzar<FT> zzar, T t, T t2) {
    ...
    public static int zze(int i, List<zzck> list, zzda zzda) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    public static <T, UT, UB> void zzb(zzds<UT, UB> zzds, T t, T t2) {
    ...
    public static int zzd(int i, Object obj, zzda zzda) {
    ...
    public static <UT, UB> UB zzb(int i, List<Integer> list, zzbf zzbf, UB ub, zzds<UT, UB> zzds) {
        if (zzbf == null) {
            return ub;
        }
    ...
    public static int zzd(int i, List<?> list, zzda zzda) {
        int i2;
        int size = list.size();
        if (size == 0) {
            return 0;
