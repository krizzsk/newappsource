...
final class zzav<FieldDescriptorType extends zzax<FieldDescriptorType>> {
    ...
    public final zzdb<FieldDescriptorType, Object> zzfj = zzdb.zzal(16);
    ...
    public static void zzb(zzaj zzaj, zzef zzef, int i, Object obj) throws IOException {
        if (zzef == zzef.GROUP) {
            zzck zzck = (zzck) obj;
            zzbd.zzg(zzck);
            zzaj.zzc(i, 3);
    ...
    public static int zzc(zzax<?> zzax, Object obj) {
        ...
        if (zzax.zzba()) {
            ...
            return zzaj.zzz(i) + zzaj.zzr(zzaw) + i;
        }
    ...
    public static int zzb(zzef zzef, int i, Object obj) {
        int zzr = zzaj.zzr(i);
        if (zzef == zzef.GROUP) {
            zzbd.zzg((zzck) obj);
            zzr <<= 1;
