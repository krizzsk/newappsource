...
public final class zzi extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUserAccountName", mo65739id = 1)
    private final String zzav;
    @SafeParcelable.Field(getter = "getPlaceAliases", mo65739id = 6)
    private final List<zzg> zzdd;

    @SafeParcelable.Constructor
    public zzi(@SafeParcelable.Param(mo65742id = 1) String str, @SafeParcelable.Param(mo65742id = 2) String str2, @SafeParcelable.Param(mo65742id = 6) List<zzg> list) {
        this.zzav = str;
        this.placeId = str2;
        this.zzdd = list;
    }
