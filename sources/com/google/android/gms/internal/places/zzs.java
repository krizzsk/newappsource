...
final class zzs {
    public static int zzb(byte[] bArr, int i, zzr zzr) {
        int i2 = i + 1;
        byte b = bArr[i];
        if (b < 0) {
    ...
    public static int zzc(byte[] bArr, int i, zzr zzr) {
        int i2 = i + 1;
        long j = (long) bArr[i];
        if (j >= 0) {
            zzr.zzea = j;
    ...
    public static int zzf(byte[] bArr, int i, zzr zzr) throws zzbk {
    ...
    public static int zzd(byte[] bArr, int i, zzr zzr) throws zzbk {
        int zzb = zzb(bArr, i, zzr);
        int i2 = zzr.zzdz;
        if (i2 < 0) {
            throw zzbk.zzbq();
    ...
    public static int zze(byte[] bArr, int i, zzr zzr) throws zzbk {
        int zzb = zzb(bArr, i, zzr);
        int i2 = zzr.zzdz;
        if (i2 < 0) {
            throw zzbk.zzbq();
    ...
    public static int zzb(int i, byte[] bArr, int i2, zzr zzr) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b = bArr[i2];
        if (b >= 0) {
    ...
    public static int zzb(zzda zzda, byte[] bArr, int i, int i2, int i3, zzr zzr) throws IOException {
        zzco zzco = (zzco) zzda;
    ...
    public static int zzb(int i, byte[] bArr, int i2, int i3, zzbh<?> zzbh, zzr zzr) {
        zzbe zzbe = (zzbe) zzbh;
    ...
    public static int zzb(byte[] bArr, int i, zzbh<?> zzbh, zzr zzr) throws IOException {
        zzbe zzbe = (zzbe) zzbh;
        int zzb = zzb(bArr, i, zzr);
        int i2 = zzr.zzdz + zzb;
        while (zzb < i2) {
    ...
    public static int zzb(zzda<?> zzda, int i, byte[] bArr, int i2, int i3, zzbh<?> zzbh, zzr zzr) throws IOException {
    ...
    public static int zzb(int i, byte[] bArr, int i2, int i3, zzdr zzdr, zzr zzr) throws zzbk {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
                ...
                while (true) {
                    ...
                    int zzb3 = zzb(i7, bArr, zzb2, i3, zzdi, zzr);
                    i7 = i8;
                    i2 = zzb3;
                }
                if (i2 > i3 || i7 != i6) {
    ...
    public static int zzb(int i, byte[] bArr, int i2, int i3, zzr zzr) throws zzbk {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
