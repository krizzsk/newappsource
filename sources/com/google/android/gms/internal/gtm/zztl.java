...
final class zztl extends zzto {
    ...
    public final void zzb(byte b) throws IOException {
        try {
            ...
            throw new zztm(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zztm(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zze(int i, zztd zztd) throws IOException {
        zzq((i << 3) | 2);
        zzq(zztd.zzd());
        zztd.zzi(this);
    }
    ...
    public final void zzs(long j) throws IOException {
        if (!zzto.zzc || this.zzc - this.zzd < 10) {
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzxy.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
