...
final class zzfe extends zzbs {
    ...
    private final URL zzj(zzex zzex, String str) {
        ...
        if (zzex.zzh()) {
            ...
            zzw();
            String zzj = zzct.zzj();
            str2 = C13715c.m34246l(new StringBuilder(C16530d.m42011d(zzi.length(), 1, zzj.length(), str.length())), zzi, zzj, "?", str);
        } else {
            zzw();
            String zzk = zzct.zzk();
            zzw();
            String zzj2 = zzct.zzj();
            str2 = C13715c.m34246l(new StringBuilder(C16530d.m42011d(zzk.length(), 1, zzj2.length(), str.length())), zzk, zzj2, "?", str);
        }
        try {
            return new URL(str2);
        } catch (MalformedURLException e) {
    ...
    public final HttpURLConnection zzb(URL url) throws IOException {
        ...
        if (openConnection instanceof HttpURLConnection) {
            ...
            httpURLConnection.setRequestProperty(HttpHeader.USER_AGENT, this.zzb);
