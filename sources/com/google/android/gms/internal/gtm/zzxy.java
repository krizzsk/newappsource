...
final class zzxy {
    ...
    public static void zzD(Object obj, long j, byte b) {
        long j2 = -4 & j;
        zzxx zzxx = zzg;
        int zzj = zzxx.zzj(obj, j2);
        int i = ((~((int) j)) & 3) << 3;
        zzxx.zzn(obj, j2, ((255 & b) << i) | (zzj & (~(ValidationUtils.APPBOY_STRING_MAX_LENGTH << i))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        zzxx zzxx = zzg;
        int i = (((int) j) & 3) << 3;
        zzxx.zzn(obj, j2, ((255 & b) << i) | (zzxx.zzj(obj, j2) & (~(ValidationUtils.APPBOY_STRING_MAX_LENGTH << i))));
    }
