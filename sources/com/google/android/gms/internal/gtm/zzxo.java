...
abstract class zzxo<T, B> {
    ...
    public abstract void zzk(B b, int i, zztd zztd);
    ...
    public abstract void zzr(T t, zztp zztp) throws IOException;

    public abstract void zzs(T t, zztp zztp) throws IOException;
}
