...
public abstract class zzam extends zzai implements List, RandomAccess {
    private static final zzaz zza = new zzak(zzar.zza, 0);

    public static zzaj zzg() {
        return new zzaj(4);
    }

    public static zzam zzh(Object[] objArr) {
        return zzi(objArr, objArr.length);
    }

    public static zzam zzi(Object[] objArr, int i) {
        if (i == 0) {
            return zzar.zza;
        }
    ...
    /* renamed from: zzl */
    public final zzaz listIterator(int i) {
