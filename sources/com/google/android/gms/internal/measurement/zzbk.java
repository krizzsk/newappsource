...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String str, zzg zzg, List list) {
        ...
        int i = 0;
        if (ordinal == 3) {
            zzap zzb = zzg.zzb((zzap) C0016g.m26i(zzbl.ASSIGN, 2, list, 0));
            ...
            zzap zzb4 = zzg.zzb((zzap) C0016g.m26i(zzbl.GET, 1, list, 0));
            ...
            zzap zzb5 = zzg.zzb((zzap) C0016g.m26i(zzbl.SET_PROPERTY, 3, list, 0));
            ...
            if (ordinal != 18) {
                if (ordinal == 35 || ordinal == 36) {
                    zzap zzb8 = zzg.zzb((zzap) C0016g.m26i(zzbl.GET_PROPERTY, 2, list, 0));
                ...
                switch (ordinal) {
                    case 62:
                        zzap zzb10 = zzg.zzb((zzap) C0016g.m26i(zzbl.TYPEOF, 1, list, 0));
