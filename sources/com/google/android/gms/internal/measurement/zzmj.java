...
class zzmj extends AbstractMap {
    ...
    public /* synthetic */ zzmj(int i, zzmi zzmi) {
        this.zza = i;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzmd) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object zzl(int i) {
        zzn();
        Object value = ((zzmd) this.zzb.remove(i)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzmh(this, (zzmg) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzmj.zzb()) {
            return entrySet().equals(zzmj.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzmj.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzmj.zzc);
        }
        return true;
    }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb2; i2++) {
            i += ((zzmd) this.zzb.get(i2)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzmd zzmd = (zzmd) this.zzb.remove(i2 - 1);
            zzm().put(zzmd.zza(), zzmd.getValue());
        }
        this.zzb.add(i, new zzmd(this, comparable, obj));
        return null;
    }
