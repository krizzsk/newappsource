...
public final class zzbi extends zzaw {
    ...
    public final zzap zza(String str, zzg zzg, List list) {
        ...
        if (ordinal == 0) {
            zzap zzb = zzg.zzb((zzap) C0016g.m26i(zzbl.ADD, 2, list, 0));
            ...
            return new zzah(Double.valueOf(zzg.zzb((zzap) C0016g.m26i(zzbl.DIVIDE, 2, list, 0)).zzh().doubleValue() / zzg.zzb((zzap) list.get(1)).zzh().doubleValue()));
        } else {
            if (ordinal == 59) {
                zzap zzb3 = zzg.zzb((zzap) C0016g.m26i(zzbl.SUBTRACT, 2, list, 0));
                ...
                switch (ordinal) {
                    case 44:
                        return new zzah(Double.valueOf(zzg.zzb((zzap) C0016g.m26i(zzbl.MODULUS, 2, list, 0)).zzh().doubleValue() % zzg.zzb((zzap) list.get(1)).zzh().doubleValue()));
                    case 45:
                        return new zzah(Double.valueOf(zzg.zzb((zzap) C0016g.m26i(zzbl.MULTIPLY, 2, list, 0)).zzh().doubleValue() * zzg.zzb((zzap) list.get(1)).zzh().doubleValue()));
                    case 46:
                        return new zzah(Double.valueOf(-zzg.zzb((zzap) C0016g.m26i(zzbl.NEGATE, 1, list, 0)).zzh().doubleValue()));
                    default:
