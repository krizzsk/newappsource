...
final class zzis extends zzio implements RandomAccess, zzls {
    ...
    static {
        zzis zzis = new zzis(new boolean[0], 0);
        zza = zzis;
        zzis.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzis.zzb, 0, this.zzb, this.zzc, zzis.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzis zzis = (zzis) obj;
        if (this.zzc != zzis.zzc) {
            return false;
        }
        boolean[] zArr = zzis.zzb;
