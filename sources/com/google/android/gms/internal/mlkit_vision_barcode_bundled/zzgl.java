...
class zzgl extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzgi) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzgi) this.zzb.get(zzk)).getValue();
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb2; i2++) {
            i += ((zzgi) this.zzb.get(i2)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzgi zzgi = (zzgi) this.zzb.remove(i2 - 1);
            zzm().put(zzgi.zza(), zzgi.getValue());
        }
