...
final class zzdk extends zzcm implements RandomAccess, zzft {
    ...
    static {
        zzdk zzdk = new zzdk(new double[0], 0);
        zza = zzdk;
        zzdk.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzdk.zzb, 0, this.zzb, this.zzc, zzdk.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzdk zzdk = (zzdk) obj;
        if (this.zzc != zzdk.zzc) {
            return false;
        }
        double[] dArr = zzdk.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzel.zzc(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
