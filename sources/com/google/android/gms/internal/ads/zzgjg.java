...
public abstract class zzgjg implements Iterable, Serializable {
    private static final Comparator zza = new zzgix();
    public static final zzgjg zzb = new zzgjc(zzgky.zzd);
    private static final zzgjf zzd = new zzgjf((zzgje) null);
    private int zzc = 0;
    ...
    private static zzgjg zzc(Iterator it, int i) {
        if (i <= 0) {
            ...
            int i2 = i >>> 1;
            zzgjg zzc2 = zzc(it, i2);
            zzgjg zzc3 = zzc(it, i - i2);
            if (Integer.MAX_VALUE - zzc2.zzd() >= zzc3.zzd()) {
                return zzgmq.zzG(zzc2, zzc3);
            }
            throw new IllegalArgumentException(C13715c.m34244j("ByteString would be too long: ", zzc2.zzd(), "+", zzc3.zzd()));
        }
    }
    ...
    public static zzgjd zzt() {
        return new zzgjd(RecyclerView.C1119a0.FLAG_IGNORE);
    }

    /* JADX WARNING: type inference failed for: r3v0, types: [java.util.Collection, java.lang.Iterable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.google.android.gms.internal.ads.zzgjg zzu(java.lang.Iterable r3) {
        /*
        ...
        L_0x0019:
            ...
            com.google.android.gms.internal.ads.zzgjg r3 = zzb
            return r3
        L_0x001e:
            java.util.Iterator r3 = r3.iterator()
            com.google.android.gms.internal.ads.zzgjg r3 = zzc(r3, r1)
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgjg.zzu(java.lang.Iterable):com.google.android.gms.internal.ads.zzgjg");
    }
    ...
    public abstract void zzo(zzgiv zzgiv) throws IOException;
