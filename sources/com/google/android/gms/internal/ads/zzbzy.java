...
public final class zzbzy {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:21:0x0097 A[Catch:{ Exception -> 0x00ae }] */
    ...
    public zzbzy(android.content.Context r7) {
        ...
        L_0x0065:
            ...
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ NameNotFoundException -> 0x005e }
            r4.<init>()     // Catch:{ NameNotFoundException -> 0x005e }
            r4.append(r3)     // Catch:{ NameNotFoundException -> 0x005e }
            r4.append(r1)     // Catch:{ NameNotFoundException -> 0x005e }
            r4.append(r0)     // Catch:{ NameNotFoundException -> 0x005e }
            java.lang.String r0 = r4.toString()     // Catch:{ NameNotFoundException -> 0x005e }
        L_0x0087:
            r6.zzx = r0
            com.google.android.gms.common.wrappers.PackageManagerWrapper r0 = com.google.android.gms.common.wrappers.Wrappers.packageManager(r7)     // Catch:{ Exception -> 0x00ae }
            java.lang.String r3 = "com.android.vending"
            r4 = 128(0x80, float:1.794E-43)
            android.content.pm.PackageInfo r0 = r0.getPackageInfo(r3, r4)     // Catch:{ Exception -> 0x00ae }
            if (r0 == 0) goto L_0x00af
            int r3 = r0.versionCode     // Catch:{ Exception -> 0x00ae }
            java.lang.String r0 = r0.packageName     // Catch:{ Exception -> 0x00ae }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00ae }
            r4.<init>()     // Catch:{ Exception -> 0x00ae }
            r4.append(r3)     // Catch:{ Exception -> 0x00ae }
            r4.append(r1)     // Catch:{ Exception -> 0x00ae }
            r4.append(r0)     // Catch:{ Exception -> 0x00ae }
    ...
    public zzbzy(Context context, zzbzz zzbzz) {
        zzc(context);
        zze(context);
        zzd(context);
