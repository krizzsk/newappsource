...
final class zzgjr extends zzgjv {
    private final byte[] zza;
    private final int zzb;
    private int zzc;

    public zzgjr(byte[] bArr, int i, int i2) {
        super((zzgju) null);
        if (bArr != null) {
    ...
    public final void zzO(byte b) throws IOException {
        try {
            ...
            throw new zzgjs(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), 1}), e);
        }
    }
    ...
    public final void zzQ(int i, zzgjg zzgjg) throws IOException {
        zzs((i << 3) | 2);
        zzs(zzgjg.zzd());
        zzgjg.zzo(this);
    }
    ...
    public final void zze(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzgjs(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzn(int i, zzgly zzgly, zzgmr zzgmr) throws IOException {
        zzs((i << 3) | 2);
    ...
    public final void zzp(String str) throws IOException {
        ...
        try {
            ...
            if (zzE2 == zzE) {
                int i2 = i + zzE2;
                this.zzc = i2;
                int zzd = zzgnx.zzd(str, this.zza, i2, this.zzb - i2);
                this.zzc = i;
                zzs((zzd - i) - zzE2);
                this.zzc = zzd;
                return;
            ...
            byte[] bArr = this.zza;
            int i3 = this.zzc;
            this.zzc = zzgnx.zzd(str, bArr, i3, this.zzb - i3);
        } catch (zzgnw e) {
            this.zzc = i;
            zzJ(str, e);
    ...
    public final void zzu(long j) throws IOException {
        if (!zzgjv.zzb || this.zzb - this.zzc < 10) {
            while ((j & -128) != 0) {
                byte[] bArr = this.zza;
                int i = this.zzc;
                this.zzc = i + 1;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzc;
                this.zzc = i3 + 1;
                zzgns.zzq(bArr3, (long) i3, (byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                j >>>= 7;
            }
            byte[] bArr4 = this.zza;
            int i4 = this.zzc;
            this.zzc = i4 + 1;
            zzgns.zzq(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
