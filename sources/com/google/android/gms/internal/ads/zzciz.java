...
public final class zzciz extends zzchi implements zzayx, zzawv, zzbah, zzasp, zzarf {
    ...
    public zzciz(Context context, zzchq zzchq, zzchr zzchr) {
        ...
        this.zze = zzcio;
        zzavs zzavs = zzavs.zza;
        zzfnu zzfnu = zzs.zza;
        zzazw zzazw = new zzazw(context, zzavs, 0, zzfnu, this, -1);
        this.zzf = zzazw;
        zzate zzate = new zzate(zzavs, (zzats) null, true, zzfnu, this);
        this.zzg = zzate;
        zzaxv zzaxv = new zzaxv((zzaya) null);
        this.zzh = zzaxv;
        if (zze.zzc()) {
        ...
        int i = 0;
        zzari zza = zzarj.zza(new zzarx[]{zzate, zzazw}, zzaxv, zzcio);
        this.zzj = zza;
        zza.zze(this);
        this.zzo = 0;
        this.zzq = 0;
