...
public final class zzdng {
    ...
    private zzbla zzr;
    private String zzs;
    private final C6313h zzt = new C6313h();
    private final C6313h zzu = new C6313h();
    private float zzv;
    private String zzw;
    ...
    public static zzdng zzab(zzbuk zzbuk) {
        try {
            ...
            zzdng.zze = zzr2;
            zzdng.zzU(GroupedInventoryCardActivity.EXTRA_BODY, zzm2);
            zzdng.zzh = zzf2;
            zzdng.zzU("call_to_action", zzn2);
            zzdng.zzm = (View) zzah(zzbuk.zzk());
            zzdng.zzo = zzl2;
            zzdng.zzU(Payload.TYPE_STORE, zzq2);
            zzdng.zzU(InAppPurchaseMetaData.KEY_PRICE, zzp2);
            zzdng.zzp = zze2;
            zzdng.zzq = zzi2;
            return zzdng;
    ...
    public static zzdng zzad(zzbuk zzbuk) {
        try {
            return zzag(zzaf(zzbuk.zzg(), (zzbuo) null), zzbuk.zzh(), (View) zzah(zzbuk.zzj()), zzbuk.zzo(), zzbuk.zzr(), zzbuk.zzm(), zzbuk.zzf(), zzbuk.zzn(), (View) zzah(zzbuk.zzk()), zzbuk.zzl(), zzbuk.zzq(), zzbuk.zzp(), zzbuk.zze(), zzbuk.zzi(), (String) null, BitmapDescriptorFactory.HUE_RED);
        } catch (RemoteException e) {
    ...
    public static zzdng zzae(zzbul zzbul) {
        try {
            return zzag(zzaf(zzbul.zzf(), (zzbuo) null), zzbul.zzg(), (View) zzah(zzbul.zzi()), zzbul.zzo(), zzbul.zzp(), zzbul.zzm(), zzbul.zze(), zzbul.zzn(), (View) zzah(zzbul.zzj()), zzbul.zzk(), (String) null, (String) null, -1.0d, zzbul.zzh(), zzbul.zzl(), BitmapDescriptorFactory.HUE_RED);
        } catch (RemoteException e) {
    ...
    private static zzdng zzag(zzdk zzdk, zzbks zzbks, View view, String str, List list, String str2, Bundle bundle, String str3, View view2, IObjectWrapper iObjectWrapper, String str4, String str5, double d, zzbla zzbla, String str6, float f) {
        ...
        zzdng.zze = list;
        String str8 = str2;
        zzdng.zzU(GroupedInventoryCardActivity.EXTRA_BODY, str2);
        zzdng.zzh = bundle;
        String str9 = str3;
        ...
        String str10 = str4;
        zzdng.zzU(Payload.TYPE_STORE, str4);
        String str11 = str5;
        zzdng.zzU(InAppPurchaseMetaData.KEY_PRICE, str5);
        zzdng.zzp = d;
        zzdng.zzq = zzbla;
        zzdng.zzU("advertiser", str6);
        zzdng.zzP(f);
        return zzdng;
    }
    ...
    public final synchronized C6313h zzh() {
        return this.zzt;
    }

    public final synchronized C6313h zzi() {
        return this.zzu;
    }
    ...
    public final synchronized String zzw() {
        return zzD(GroupedInventoryCardActivity.EXTRA_BODY);
    }
