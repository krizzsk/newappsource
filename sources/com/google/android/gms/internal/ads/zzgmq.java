...
final class zzgmq extends zzgjg {
    ...
    private zzgmq(zzgjg zzgjg, zzgjg zzgjg2) {
        ...
        int zzd2 = zzgjg.zzd();
        this.zzf = zzd2;
        this.zzc = zzgjg2.zzd() + zzd2;
        this.zzg = Math.max(zzgjg.zzf(), zzgjg2.zzf()) + 1;
    }

    public static zzgjg zzG(zzgjg zzgjg, zzgjg zzgjg2) {
        if (zzgjg2.zzd() == 0) {
            return zzgjg;
        }
        if (zzgjg.zzd() == 0) {
    ...
    public final zzgjg zzk(int i, int i2) {
        int zzq = zzgjg.zzq(i, i2, this.zzc);
        if (zzq == 0) {
            return zzgjg.zzb;
        }
        if (zzq == this.zzc) {
    ...
    public final zzgjo zzl() {
        ...
        if (z) {
            return new zzgjk(arrayList, i, true, (zzgjj) null);
        }
