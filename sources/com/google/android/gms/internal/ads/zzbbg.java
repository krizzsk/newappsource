...
public final class zzbbg {
    ...
    public final Activity zza() {
        synchronized (this.zza) {
            zzbbe zzbbe = this.zzb;
            if (zzbbe == null) {
                return null;
            }
            Activity zza2 = zzbbe.zza();
            return zza2;
        }
    }
    ...
    public final Context zzb() {
        synchronized (this.zza) {
            ...
            Context zzb2 = zzbbe.zzb();
            return zzb2;
        }
    }

    public final void zzc(zzbbf zzbbf) {
        synchronized (this.zza) {
            if (this.zzb == null) {
                this.zzb = new zzbbe();
            }
    ...
    public final void zzd(android.content.Context r4) {
        ...
        L_0x0016:
            ...
            com.google.android.gms.internal.ads.zzcfi.zzj(r4)     // Catch:{ all -> 0x0034 }
            monitor-exit(r0)     // Catch:{ all -> 0x0034 }
            return
        L_0x001f:
            com.google.android.gms.internal.ads.zzbbe r2 = r3.zzb     // Catch:{ all -> 0x0034 }
            if (r2 != 0) goto L_0x002a
            com.google.android.gms.internal.ads.zzbbe r2 = new com.google.android.gms.internal.ads.zzbbe     // Catch:{ all -> 0x0034 }
        ...
        L_0x0034:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbbg.zzd(android.content.Context):void");
    }

    public final void zze(zzbbf zzbbf) {
        synchronized (this.zza) {
            zzbbe zzbbe = this.zzb;
            if (zzbbe != null) {
                zzbbe.zzh(zzbbf);
