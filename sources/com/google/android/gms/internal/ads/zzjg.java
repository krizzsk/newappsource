...
final class zzjg {
    ...
    private final zzje zzv(zzci zzci, Object obj, int i, int i2, long j, long j2) {
        ...
        return new zzje(zzsb, j3, j, -9223372036854775807L, zzg2, false, false, false, false);
    }
    ...
    public final boolean zzn() {
        ...
        if (zzjd.zzf.zzi || !zzjd.zzr() || this.zzj.zzf.zze == -9223372036854775807L || this.zzk >= 100) {
            return false;
        }
        return true;
    }
        ...
        while (zzjd != null) {
            ...
            if (zzjd2 == null) {
                ...
                if (zzt == null) {
                    ...
                    return false;
                } else if (zzje2.zzb == zzt.zzb && zzje2.zza.equals(zzt.zza)) {
                    zzje = zzt;
                } else if (!zzm(zzjd2)) {
                    return true;
                } else {
