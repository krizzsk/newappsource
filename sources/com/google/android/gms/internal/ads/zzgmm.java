...
final class zzgmm {
    ...
    public static /* bridge */ /* synthetic */ zzgjg zza(zzgmm zzgmm, zzgjg zzgjg, zzgjg zzgjg2) {
        zzgmm.zzb(zzgjg);
        zzgmm.zzb(zzgjg2);
    ...
    private final void zzb(zzgjg zzgjg) {
        if (zzgjg.zzh()) {
            ...
            throw new IllegalArgumentException("Has a new type of ByteString been created? Found ".concat(String.valueOf(zzgjg.getClass())));
        }
    }
    ...
    public /* synthetic */ zzgmm(zzgml zzgml) {
    }
}
