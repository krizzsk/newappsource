...
public class zzyi {
    ...
    public zzyi(zzyf zzyf, zzyh zzyh, long j, long j2, long j3, long j4, long j5, long j6, int i) {
        this.zzb = zzyh;
        this.zzd = i;
        this.zza = new zzyc(zzyf, j, 0, j3, j4, j5, j6);
    }

    public static final int zzf(zzyt zzyt, long j, zzzs zzzs) {
        if (j == zzyt.zzf()) {
            return 0;
        }
        zzzs.zza = j;
    ...
    public static final boolean zzg(zzyt zzyt, long j) throws IOException {
        long zzf = j - zzyt.zzf();
        if (zzf < 0 || zzf > 262144) {
            return false;
        }
