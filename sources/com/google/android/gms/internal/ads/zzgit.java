...
final class zzgit {
    public static int zza(byte[] bArr, int i, zzgis zzgis) throws zzgla {
    ...
    public static int zzc(zzgmr zzgmr, byte[] bArr, int i, int i2, int i3, zzgis zzgis) throws IOException {
    ...
    public static int zzd(com.google.android.gms.internal.ads.zzgmr r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.ads.zzgis r10) throws java.io.IOException {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
    ...
    public static int zze(zzgmr zzgmr, int i, byte[] bArr, int i2, int i3, zzgkx zzgkx, zzgis zzgis) throws IOException {
    ...
    public static int zzf(byte[] bArr, int i, zzgkx zzgkx, zzgis zzgis) throws IOException {
    ...
    public static int zzg(byte[] bArr, int i, zzgis zzgis) throws zzgla {
        int zzj = zzj(bArr, i, zzgis);
        int i2 = zzgis.zza;
        if (i2 < 0) {
            throw zzgla.zzf();
    ...
    public static int zzh(byte[] bArr, int i, zzgis zzgis) throws zzgla {
        int zzj = zzj(bArr, i, zzgis);
        int i2 = zzgis.zza;
        if (i2 < 0) {
            throw zzgla.zzf();
    ...
    public static int zzi(int i, byte[] bArr, int i2, int i3, zzgnj zzgnj, zzgis zzgis) throws zzgla {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
    ...
    public static int zzj(byte[] bArr, int i, zzgis zzgis) {
        int i2 = i + 1;
        byte b = bArr[i];
        if (b < 0) {
    ...
    public static int zzk(int i, byte[] bArr, int i2, zzgis zzgis) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b = bArr[i2];
        if (b >= 0) {
    ...
    public static int zzl(int i, byte[] bArr, int i2, int i3, zzgkx zzgkx, zzgis zzgis) {
        zzgkp zzgkp = (zzgkp) zzgkx;
        int zzj = zzj(bArr, i2, zzgis);
        zzgkp.zzh(zzgis.zza);
        while (zzj < i3) {
    ...
    public static int zzm(byte[] bArr, int i, zzgis zzgis) {
        int i2 = i + 1;
        long j = (long) bArr[i];
        if (j >= 0) {
            zzgis.zzb = j;
