...
public final class zzayl {
    ...
    public final synchronized int zza() {
        return this.zzc * SQLiteDatabase.OPEN_FULLMUTEX;
    }
    ...
    public final synchronized zzayf zzb() {
        ...
        if (i > 0) {
            ...
            zzayf = new zzayf(new byte[SQLiteDatabase.OPEN_FULLMUTEX], 0);
        }
        return zzayf;
    }
    ...
    public final synchronized void zzg() {
        int max = Math.max(0, zzazn.zzd(this.zzb, SQLiteDatabase.OPEN_FULLMUTEX) - this.zzc);
        int i = this.zzd;
        if (max < i) {
