...
public final class zzdy {
    ...
    public final void zzA(zzdx zzdx, int i) {
        zzB(zzdx.zza, 0, i);
        zzdx.zzh(0);
    }
    ...
    public final int zzh() {
        ...
        throw new IllegalStateException(C16759e.m42349e("Top bit not zero: ", zzg));
    }
    ...
    public final int zzn() {
        ...
        throw new IllegalStateException(C16759e.m42349e("Top bit not zero: ", zze));
    }
    ...
    public final long zzt() {
        ...
        throw new IllegalStateException(C0016g.m29l("Top bit not zero: ", zzr));
    }
        ...
        if (i != 0) {
            while (i2 < i) {
                ...
                if ((b & 192) == 128) {
                    ...
                    throw new NumberFormatException(C0016g.m29l("Invalid UTF-8 sequence continuation byte: ", j));
                }
            }
            this.zzb += i;
            return j;
        }
        throw new NumberFormatException(C0016g.m29l("Invalid UTF-8 sequence first byte: ", j));
    }
    ...
    public final String zzw(int i) {
        ...
        String zzI = zzeg.zzI(this.zza, i3, i2);
        this.zzb += i;
        return zzI;
    }
