...
final class zzfzw implements zzghi {
    ...
    public zzfzw(zzgfm zzgfm) throws GeneralSecurityException {
    ...
    public final zzgan zzb(byte[] bArr) throws GeneralSecurityException {
        ...
        if (bArr.length != this.zzb) {
            ...
            return new zzgan((zzfwd) zzfxi.zzg(this.zza, (zzgco) zzc2.zzaj(), cls));
            ...
            return new zzgan((zzfwd) zzfxi.zzg(this.zza, (zzgbq) zzc5.zzaj(), cls));
