...
public final class zzdog {
    ...
    public final /* synthetic */ void zza(ViewGroup viewGroup) {
        ...
        if (zzdng.zzc() == 2 || zzdng.zzc() == 1) {
            ...
            this.zza.zzI(this.zzb.zzf, DiskLruCache.VERSION_1, z);
        }
    }
    ...
    public final /* synthetic */ void zzb(zzdpb zzdpb) {
        ...
        viewGroup = null;
        Context context2 = zzdpb.zzf().getContext();
        ...
        if (zzdng.zze() != null) {
            ...
            zzbkk zzbkk = new zzbkk(context2, zzbkj, layoutParams);
