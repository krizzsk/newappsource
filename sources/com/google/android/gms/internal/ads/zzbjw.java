...
public final class zzbjw {
    public static final zzbja zza = zzbja.zzb("gads:dynamite_load:fail:sample_rate", 10000);
    public static final zzbja zzb = zzbja.zzd("gads:report_dynamite_crash_in_background_thread", false);
    public static final zzbja zzc = zzbja.zzc("gads:public_beta:traffic_multiplier", "1.0");
