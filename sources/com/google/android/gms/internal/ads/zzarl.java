...
final class zzarl implements zzari {
    ...
    public zzarl(zzarx[] zzarxArr, zzayd zzayd, zzcio zzcio, byte[] bArr) {
        ...
        zzayd.getClass();
        this.zzb = zzayd;
        zzayb zzayb = new zzayb(new zzaxt[2], (byte[]) null);
        this.zzc = zzayb;
        this.zzo = zzasd.zza;
        this.zzg = new zzasc();
        this.zzh = new zzasb();
        ...
        zzark zzark = new zzark(this, looper);
        this.zzd = zzark;
        zzarn zzarn = new zzarn(0, 0);
        this.zzt = zzarn;
        this.zze = new zzarq(zzarxArr, zzayd, zzcio, this.zzj, 0, zzark, zzarn, this, (byte[]) null);
    }
    ...
    public final long zzb() {
        ...
        return zzard.zzb(this.zzt.zzd) + zzard.zzb(0);
    }
    ...
    public final long zzc() {
        ...
        this.zzo.zzd(this.zzt.zza, this.zzh, false);
        return zzard.zzb(this.zzt.zzc) + zzard.zzb(0);
    }
