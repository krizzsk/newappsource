...
public final class zzagj implements zzaga {
    ...
    private final zzagp zzb = new zzagp(7, RecyclerView.C1119a0.FLAG_IGNORE);
    private final zzagp zzc = new zzagp(8, RecyclerView.C1119a0.FLAG_IGNORE);
    private final zzagp zzd = new zzagp(6, RecyclerView.C1119a0.FLAG_IGNORE);
    private long zze;
