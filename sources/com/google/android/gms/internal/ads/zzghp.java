...
public final class zzghp implements zzfwd {
    ...
    public zzghp(zzgic zzgic, zzfwv zzfwv, int i) {
        this.zza = zzgic;
        this.zzb = zzfwv;
        this.zzc = i;
    }
    ...
    public final byte[] zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        if (length >= i) {
            ...
            this.zzb.zza(copyOfRange2, zzghf.zzc(bArr2, copyOfRange, copyOf));
    ...
    public final byte[] zzb(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        return zzghf.zzc(zzb2, this.zzb.zzb(zzghf.zzc(bArr2, zzb2, copyOf)));
    }
}
