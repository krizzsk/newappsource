...
public final class zzesr implements zzeta {
    ...
    public final /* bridge */ /* synthetic */ void zzf(Object obj) {
        ...
        bundle.putString("extra_caps", (String) zzay.zzc().zzb(zzbhy.zzcK));
        bundle.putInt("target_api", this.zze);
        bundle.putInt("dv", this.zzf);
        bundle.putInt("lv", this.zzg);
        Bundle zza2 = zzfcj.zza(bundle, "sdk_env");
        zza2.putBoolean("mf", ((Boolean) zzbjo.zza.zze()).booleanValue());
        ...
        Bundle zza3 = zzfcj.zza(zza2, "build_meta");
        zza3.putString("cl", "448117567");
