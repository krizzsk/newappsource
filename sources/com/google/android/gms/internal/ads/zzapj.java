...
public final class zzapj implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzapj(Context context, zzaov zzaov) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzapi zzapi = new zzapi(this);
            this.zzf = zzapi;
            this.zzb.registerReceiver(zzapi, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0038:
            ...
            com.google.android.gms.internal.ads.zzaos r0 = r3.zzj     // Catch:{ Exception -> 0x0041 }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x0041 }
        L_0x0041:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzapj.zzi(android.view.View):void");
    }
