...
final class zzjn {
    ...
    public zzjn(zzjm zzjm, zzki zzki, Handler handler, zzmv zzmv) {
        ...
        zzsk.zzb(handler, zzki);
        zzpd.zzb(handler, zzki);
    }
        ...
        if (!list.isEmpty()) {
            ...
            for (int i2 = i; i2 < list.size() + i; i2++) {
                ...
                if (i2 > 0) {
                    ...
                    zzci zzA = zzjl2.zza.zzA();
                    zzjl.zzc(zzA.zzc() + zzjl2.zzd);
                } else {
                    zzjl.zzc(0);
                }
                zzp(i2, zzjl.zza.zzA().zzc());
    ...
    public final zzrz zzo(zzsb zzsb, zzvw zzvw, long j) {
        ...
        zzsb zzc2 = zzsb.zzc(((Pair) obj).second);
        zzjl zzjl = (zzjl) this.zzd.get(obj2);
        zzjl.getClass();
        this.zzi.add(zzjl);
        zzjk zzjk = (zzjk) this.zzh.get(zzjl);
        if (zzjk != null) {
