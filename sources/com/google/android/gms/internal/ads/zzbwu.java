...
public class zzbwu {
    ...
    public zzbwu(zzcli zzcli, String str) {
        this.zza = zzcli;
        this.zzb = str;
    }
    ...
    public final void zzg(String str) {
        try {
            JSONObject put = new JSONObject().put(InAppMessageBase.MESSAGE, str).put(Events.PROPERTY_ACTION, this.zzb);
            zzcli zzcli = this.zza;
            if (zzcli != null) {
                zzcli.zze("onError", put);
            }
        } catch (JSONException e) {
