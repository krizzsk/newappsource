...
public final class zzetg implements zzeta {
    ...
    public zzetg(boolean z, boolean z2, String str, boolean z3, boolean z4, boolean z5, String str2, ArrayList arrayList, String str3, String str4, String str5, boolean z6, String str6, long j) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = str;
        this.zzd = z3;
    ...
    public final /* bridge */ /* synthetic */ void zzf(Object obj) {
        ...
        zza2.putString(BillingClientBuilderBridgeCommon.buildMethodName, this.zzk);
        zza2.putLong("remaining_data_partition_space", this.zzn);
        Bundle zza3 = zzfcj.zza(zza2, Browser.TARGET_BROWSER);
        zza2.putBundle(Browser.TARGET_BROWSER, zza3);
        zza3.putBoolean("is_browser_custom_tabs_capable", this.zzl);
        if (!TextUtils.isEmpty(this.zzj)) {
            Bundle zza4 = zzfcj.zza(zza2, "play_store");
