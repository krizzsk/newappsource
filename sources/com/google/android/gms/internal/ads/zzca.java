...
public final class zzca {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && zzca.class == obj.getClass()) {
            zzca zzca = (zzca) obj;
            if (this.zzc == zzca.zzc && this.zzf == zzca.zzf && this.zzg == zzca.zzg && this.zzh == zzca.zzh && this.zzi == zzca.zzi && this.zzj == zzca.zzj && zzfoo.zza(this.zzb, zzca.zzb) && zzfoo.zza(this.zze, zzca.zze) && zzfoo.zza(this.zzd, zzca.zzd)) {
                return true;
            }
            return false;
        }
