...
public final class zzfny {
    ...
    public static PendingIntent zza(Context context, int i, Intent intent, int i2, int i3) {
        ...
        zzfos.zzf(z, "Cannot set any dangerous parts of intent to be mutable.");
        if (intent.getComponent() != null) {
            z2 = true;
        } else {
            z2 = false;
        }
        zzfos.zzf(z2, "Must set component on Intent.");
        if (zzb(0, 1)) {
            ...
            zzfos.zzf(z3, "Must set PendingIntent.FLAG_IMMUTABLE for SDK >= 23 if no parts of intent are mutable.");
        }
