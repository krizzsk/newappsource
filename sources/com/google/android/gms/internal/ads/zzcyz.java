...
public final class zzcyz {
    ...
    public zzcyz(zzeas zzeas, zzfby zzfby, zzfge zzfge, zzcsm zzcsm, zzeiq zzeiq, zzdgw zzdgw, zzfbs zzfbs, zzebw zzebw, zzday zzday, Executor executor, zzebj zzebj, zzefd zzefd) {
        this.zza = zzeas;
        this.zzb = zzfby;
        this.zzc = zzfge;
        this.zzd = zzcsm;
    ...
    public final zzfvj zzj(zzfvj zzfvj) {
        zzfbs zzfbs = this.zzg;
        if (zzfbs != null) {
            zzfge zzfge = this.zzc;
            return zzffo.zzc(zzfva.zzi(zzfbs), zzffy.SERVER_TRANSACTION, zzfge).zza();
        }
        zzt.zzc().zzj();
