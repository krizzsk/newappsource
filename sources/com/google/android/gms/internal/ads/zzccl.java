...
public final class zzccl implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public zzccl(Context context, zzg zzg, zzcdn zzcdn) {
    ...
    private final void zzb(String str, int i) {
        Context context;
        boolean z = false;
        if (!((Boolean) zzay.zzc().zzb(zzbhy.zzat)).booleanValue() ? str.isEmpty() || str.charAt(0) != '1' : i == 0 || str.isEmpty() || (str.charAt(0) != '1' && !str.equals("-1"))) {
            z = true;
        }
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzar)).booleanValue()) {
            this.zzc.zzH(z);
            if (((Boolean) zzay.zzc().zzb(zzbhy.zzff)).booleanValue() && z && (context = this.zza) != null) {
    ...
    public final void onSharedPreferenceChanged(android.content.SharedPreferences r9, java.lang.String r10) {
        /*
            r8 = this;
            com.google.android.gms.internal.ads.zzbhq r0 = com.google.android.gms.internal.ads.zzbhy.zzav
            ...
            boolean r0 = com.google.android.gms.internal.ads.zzcck.zza(r10, r5)
            if (r0 == 0) goto L_0x004a
            com.google.android.gms.internal.ads.zzbhq r10 = com.google.android.gms.internal.ads.zzbhy.zzat
        ...
        L_0x004a:
            ...
            boolean r0 = com.google.android.gms.internal.ads.zzcck.zza(r10, r0)
            if (r0 != 0) goto L_0x0060
            java.lang.String r0 = "IABTCF_TCString"
            boolean r0 = com.google.android.gms.internal.ads.zzcck.zza(r10, r0)
            if (r0 != 0) goto L_0x0060
            boolean r0 = com.google.android.gms.internal.ads.zzcck.zza(r10, r2)
        ...
        L_0x00df:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzccl.onSharedPreferenceChanged(android.content.SharedPreferences, java.lang.String):void");
    }

    public final void zza() {
        this.zzb.registerOnSharedPreferenceChangeListener(this);
        onSharedPreferenceChanged(this.zzb, "gad_has_consent_for_cookies");
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzav)).booleanValue()) {
