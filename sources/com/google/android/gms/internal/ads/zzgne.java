...
class zzgne extends AbstractMap {
    ...
    public /* synthetic */ zzgne(int i, zzgnd zzgnd) {
        this.zza = i;
    }
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzgnc(this, (zzgnb) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzgne.zzb()) {
            return entrySet().equals(zzgne.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzgne.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzgne.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzgmy zzgmy = (zzgmy) this.zzb.remove(i2 - 1);
            zzm().put(zzgmy.zza(), zzgmy.getValue());
        }
