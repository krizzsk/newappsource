...
public interface zzbuf extends IInterface {
    ...
    void zzr(zzblu zzblu, String str) throws RemoteException;

    void zzs(zzcaw zzcaw) throws RemoteException;

    void zzt(zzcba zzcba) throws RemoteException;
