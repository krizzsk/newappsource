        ...
        if ((obj instanceof MediationBannerAdapter) || (obj instanceof Adapter)) {
            ...
            if (obj2 instanceof MediationBannerAdapter) {
                try {
                    ...
                    mediationBannerAdapter.requestBannerAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzbva(zzbuf2), zzS(str3, zzl2, str4), adSize2, zzbur, bundle);
                } catch (Throwable th) {
                    zzcfi.zzh("", th);
                    throw new RemoteException();
                }
        ...
        if ((obj instanceof MediationInterstitialAdapter) || (obj instanceof Adapter)) {
            ...
            if (obj2 instanceof MediationInterstitialAdapter) {
                try {
                    ...
                    boolean z = zzl2.zzr;
                    int i3 = i2;
                    zzbur zzbur = new zzbur(date, i, hashSet, location, zzT, i3, z, zzl2.zzt, zzU(str3, zzl2));
                    Bundle bundle2 = zzl2.zzm;
                    if (bundle2 != null) {
                    ...
                    mediationInterstitialAdapter.requestInterstitialAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzbva(zzbuf2), zzS(str3, zzl2, str4), zzbur, bundle);
                } catch (Throwable th) {
                    zzcfi.zzh("", th);
                    throw new RemoteException();
                }
        ...
        if ((obj instanceof MediationNativeAdapter) || (obj instanceof Adapter)) {
            ...
            if (obj2 instanceof MediationNativeAdapter) {
                try {
                    ...
                    zzbko zzbko2 = zzbko;
                    List list3 = list;
                    zzbvc zzbvc = new zzbvc(date, i, hashSet, location, zzT, i3, zzbko2, list3, z, zzl2.zzt, zzU(str3, zzl2));
                    Bundle bundle2 = zzl2.zzm;
                    if (bundle2 != null) {
                    ...
                    mediationNativeAdapter.requestNativeAd((Context) ObjectWrapper.unwrap(iObjectWrapper), this.zzb, zzS(str3, zzl2, str4), zzbvc, bundle);
                } catch (Throwable th) {
                    zzcfi.zzh("", th);
                    throw new RemoteException();
                }
