...
public final class zzdyk {
    ...
    public zzdyk(Context context) {
        ...
        this.zzc = ((Integer) zzay.zzc().zzb(zzbhy.zzhE)).intValue();
        this.zzd = ((Integer) zzay.zzc().zzb(zzbhy.zzhF)).intValue();
    }
    ...
    public final JSONObject zza() throws JSONException {
        ...
        if (this.zze.isEmpty()) {
            try {
                drawable = (Drawable) Wrappers.packageManager(this.zza).getApplicationLabelAndIcon(this.zzb.packageName).f19680b;
