...
public final class zzcdp {
    ...
    public static String zzb(Uri uri, Context context) {
        ...
        String str = (String) zzay.zzc().zzb(zzbhy.zzac);
        String uri2 = uri.toString();
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzab)).booleanValue() && uri2.contains(str)) {
    ...
    public static String zzc(String str, Context context, boolean z) {
        String zza;
        if ((((Boolean) zzay.zzc().zzb(zzbhy.zzaj)).booleanValue() && !z) || !zzt.zzn().zzu(context) || TextUtils.isEmpty(str) || (zza = zzt.zzn().zza(context)) == null) {
            return str;
        }
        String str2 = (String) zzay.zzc().zzb(zzbhy.zzac);
        if (!((Boolean) zzay.zzc().zzb(zzbhy.zzab)).booleanValue() || !str.contains(str2)) {
