...
final class zzfzf extends zzgap {
    ...
    public zzfzf(zzfzg zzfzg, Class cls) {
        super(cls);
        this.zza = zzfzg;
    }
    ...
    public final /* bridge */ /* synthetic */ void zzd(zzgly zzgly) throws GeneralSecurityException {
        ...
        if (zzgdd.zza() != 64) {
            throw new InvalidAlgorithmParameterException(C25541a.m63878h("invalid key size: ", zzgdd.zza(), ". Valid keys must have 64 bytes."));
        }
    }
}
