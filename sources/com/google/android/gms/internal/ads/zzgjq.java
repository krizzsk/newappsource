...
abstract class zzgjq extends zzgjv {
    ...
    public final void zzf(int i) {
        if (zzgjv.zzb) {
            ...
            while ((i & -128) != 0) {
                ...
                int i2 = this.zzc;
                this.zzc = i2 + 1;
                zzgns.zzq(bArr, (long) i2, (byte) ((i & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                i >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i3 = this.zzc;
            this.zzc = i3 + 1;
            zzgns.zzq(bArr2, (long) i3, (byte) i);
    ...
    public final void zzg(long j) {
        if (zzgjv.zzb) {
            ...
            while ((j & -128) != 0) {
                ...
                int i = this.zzc;
                this.zzc = i + 1;
                zzgns.zzq(bArr, (long) i, (byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                j >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i2 = this.zzc;
            this.zzc = i2 + 1;
            zzgns.zzq(bArr2, (long) i2, (byte) ((int) j));
