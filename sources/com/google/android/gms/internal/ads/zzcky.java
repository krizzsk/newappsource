...
final class zzcky extends zzek implements zzfo {
    ...
    private final zzfn zzf = new zzfn();
    private zzew zzg;
    ...
    public zzcky(String str, zzft zzft, int i, int i2, long j, long j2) {
        super(true);
        zzcw.zzc(str);
        this.zze = str;
        this.zzc = i;
    ...
    public final long zzb(zzew zzew) throws zzfk {
        long j;
        this.zzg = zzew;
        this.zzn = 0;
        long j2 = zzew.zzf;
        ...
        throw new zzckw(headerField, zzew);
    }
    ...
    @VisibleForTesting
    public final HttpURLConnection zzk(long j, long j2, int i) throws zzfk {
