    ...
    private final void zzl(long j) throws zzbp {
        ...
        while (!this.zzf.isEmpty() && ((zzadu) this.zzf.peek()).zza == j) {
            ...
            if (zzadu.zzd == 1836019574) {
                ...
                zzzh zzzh = new zzzh();
                zzadv zzb2 = zzadu.zzb(1969517665);
                if (zzb2 != null) {
                    Pair zza2 = zzaed.zza(zzb2);
                    zzbl zzbl5 = (zzbl) zza2.first;
                    zzbl zzbl6 = (zzbl) zza2.second;
                    if (zzbl5 != null) {
                        zzzh.zzb(zzbl5);
                    }
                    zzbl2 = zzbl6;
                ...
                zzadu zza3 = zzadu.zza(1835365473);
                if (zza3 != null) {
                    zzbl3 = zzaed.zzb(zza3);
                } else {
                    zzbl3 = null;
                }
                ...
                while (true) {
                    ...
                    if (zzaew.zzb == 0) {
                        ...
                        zzab zzb3 = zzaet.zzf.zzb();
                        zzb3.zzL(i2);
                        long j6 = max;
                        if (zzaet.zzb == 2 && j5 > 0 && (i3 = zzaew.zzb) > 1) {
                            zzb3.zzE(((float) i3) / (((float) j5) / 1000000.0f));
                        }
                        if (zzaet.zzb == 1 && zzzh.zza()) {
                            zzb3.zzC(zzzh.zza);
                            zzb3.zzD(zzzh.zzb);
                        }
                        int i6 = zzaet.zzb;
                        ...
                        if (this.zzh.isEmpty()) {
                            ...
                            zzbl4 = new zzbl(this.zzh);
                        }
                        zzblArr[1] = zzbl4;
                        zzbl zzbl8 = new zzbl(new zzbk[0]);
                        if (i6 == 1) {
                            if (zzbl != null) {
                                zzbl8 = zzbl;
                            }
                        } else if (i6 == 2 && zzbl7 != null) {
                            int i7 = 0;
                            while (true) {
                                if (i7 >= zzbl7.zza()) {
                                    break;
                                }
                                zzbk zzb4 = zzbl7.zzb(i7);
                                if (zzb4 instanceof zzacp) {
                                    zzacp zzacp = (zzacp) zzb4;
                                    if ("com.android.capture.fps".equals(zzacp.zza)) {
                                        zzbl8 = new zzbl(zzacp);
                                        break;
                                    }
                                }
                                i7++;
                        ...
                        for (int i8 = 0; i8 < 2; i8++) {
                            zzbl8 = zzbl8.zzd(zzblArr[i8]);
                        }
                        if (zzbl8.zza() > 0) {
                            zzb3.zzM(zzbl8);
                        }
                        zzaen.zzc.zzk(zzb3.zzY());
                        if (zzaet.zzb == 2) {
                            if (i5 == -1) {
                                i5 = arrayList.size();
                            }
                ...
                for (int i9 = 0; i9 < zzaenArr.length; i9++) {
                    jArr[i9] = new long[zzaenArr[i9].zzb.zzb];
                    jArr2[i9] = zzaenArr[i9].zzb.zzf[0];
                }
                int i11 = 0;
                while (i11 < zzaenArr.length) {
                    long j7 = Long.MAX_VALUE;
                    int i12 = -1;
                    for (int i13 = 0; i13 < zzaenArr.length; i13++) {
                        if (!zArr[i13]) {
                            long j8 = jArr2[i13];
                            if (j8 <= j7) {
                                i12 = i13;
                    ...
                    long[] jArr3 = jArr[i12];
                    jArr3[i14] = j2;
                    zzaew zzaew2 = zzaenArr[i12].zzb;
                    j2 += (long) zzaew2.zzd[i14];
                    int i15 = i14 + 1;
                    iArr[i12] = i15;
                    if (i15 < jArr3.length) {
                        jArr2[i12] = zzaew2.zzf[i15];
                    } else {
                        zArr[i12] = true;
                        i11++;
                    }
