...
public final class zzbzs extends AbstractSafeParcelable {
    ...
    public zzbzs(@SafeParcelable.Param(mo65742id = 2) ParcelFileDescriptor parcelFileDescriptor) {
        ...
        if (this.zza == null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        zzcfv.zza.execute(new zzbzr(autoCloseOutputStream, marshall));
    ...
    public final SafeParcelable zza(Parcelable.Creator creator) {
        if (this.zzc) {
            ...
            try {
                ...
                zzcfi.zzh("Could not read from parcel file descriptor", e);
                IOUtils.closeQuietly((Closeable) dataInputStream);
                return null;
            } catch (Throwable th2) {
                IOUtils.closeQuietly((Closeable) dataInputStream);
