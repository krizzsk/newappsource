...
public final /* synthetic */ class zzeqs implements Callable {
    public static final /* synthetic */ zzeqs zza = new zzeqs();

    private /* synthetic */ zzeqs() {
    }

    public final Object call() {
        Bundle bundle = new Bundle();
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzH)).booleanValue()) {
