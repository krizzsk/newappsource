...
final class zzgjm extends zzgjo {
    ...
    public /* synthetic */ zzgjm(InputStream inputStream, int i, zzgjl zzgjl) {
        super((zzgjn) null);
    ...
    public final zzgjg zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj2 <= i - i2 && zzj2 > 0) {
            zzgjg zzw = zzgjg.zzw(this.zzf, i2, zzj2);
            this.zzi += zzj2;
            return zzw;
        } else if (zzj2 == 0) {
            return zzgjg.zzb;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i2 = this.zzi;
            if (zzj2 <= i - i2) {
                String str = new String(this.zzf, i2, zzj2, zzgky.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
        ...
        if (zzj2 > this.zzg) {
            return new String(zzN(zzj2, false), zzgky.zzb);
        }
        zzL(zzj2);
        String str2 = new String(this.zzf, this.zzi, zzj2, zzgky.zzb);
        this.zzi += zzj2;
        return str2;
    }
