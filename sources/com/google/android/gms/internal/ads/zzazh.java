...
public final class zzazh {
    ...
    public zzazh(byte[] bArr, int i, int i2) {
        this.zza = bArr;
        this.zzc = i;
        this.zzb = i2;
        zzg();
    ...
    public final int zza(int i) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            if (i6 != 0) {
                byte[] bArr = this.zza;
                b2 = ((bArr[i3] & 255) >>> (8 - i6)) | ((bArr[this.zzc] & 255) << i6);
            } else {
        ...
        if (i > 0) {
            int i7 = this.zzd + i;
            byte b4 = (byte) (ValidationUtils.APPBOY_STRING_MAX_LENGTH >> (8 - i));
            if (zzh(this.zzc + 1)) {
                i2 = this.zzc + 2;
            } else {
                i2 = this.zzc + 1;
            ...
            if (i7 > 8) {
                byte[] bArr2 = this.zza;
                b = (b4 & (((255 & bArr2[i2]) >> (16 - i7)) | ((bArr2[this.zzc] & 255) << (i7 - 8)))) | b3;
                this.zzc = i2;
            } else {
