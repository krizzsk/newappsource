...
final class zzgkh extends zzgiq implements RandomAccess, zzgmf {
    private static final zzgkh zza;
    private float[] zzb;
    private int zzc;

    static {
        zzgkh zzgkh = new zzgkh(new float[0], 0);
        zza = zzgkh;
        zzgkh.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgkh.zzb, 0, this.zzb, this.zzc, zzgkh.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgkh zzgkh = (zzgkh) obj;
        if (this.zzc != zzgkh.zzc) {
            return false;
        }
        float[] fArr = zzgkh.zzb;
