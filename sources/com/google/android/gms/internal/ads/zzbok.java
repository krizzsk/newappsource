...
public final class zzbok {
    ...
    public static zzfvj zzb(zzcli zzcli, String str) {
        ...
        zzfur zzv = zzfur.zzv(zzcli.zzT());
        zzbnq zzbnq = zzbnq.zza;
        zzfvk zzfvk = zzcfv.zzf;
        return zzfva.zzf(zzfva.zzm(zzfva.zzf(zzv, Throwable.class, zzbnq, zzfvk), new zzbnr(zzb2), zzfvk), Throwable.class, new zzbns(zzb2), zzfvk);
    }
    ...
    public static /* synthetic */ void zzc(com.google.android.gms.internal.ads.zzcmj r16, java.util.Map r17) {
        ...
        L_0x0066:
            ...
            com.google.android.gms.internal.ads.zzcfi.zzh(r0, r15)
        L_0x0075:
            r0 = r14
        L_0x0076:
            r13 = 1
    ...
    public static void zzd(Map map, zzdjf zzdjf) {
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzie)).booleanValue() && map.containsKey("sc") && ((String) map.get("sc")).equals(DiskLruCache.VERSION_1) && zzdjf != null) {
            zzdjf.zzq();
        }
    }
}
