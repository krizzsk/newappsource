...
final class zzaar extends zzaat {
    ...
    private static Double zzg(zzdy zzdy) {
        return Double.valueOf(Double.longBitsToDouble(zzdy.zzr()));
    }
    ...
    private static java.lang.Object zzh(com.google.android.gms.internal.ads.zzdy r4, int r5) {
        /*
        ...
        L_0x007a:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaar.zzh(com.google.android.gms.internal.ads.zzdy, int):java.lang.Object");
    }

    private static String zzi(zzdy zzdy) {
        int zzo = zzdy.zzo();
        int zzc2 = zzdy.zzc();
        zzdy.zzG(zzo);
        return new String(zzdy.zzH(), zzc2, zzo);
    }

    private static HashMap zzj(zzdy zzdy) {
        int zzn = zzdy.zzn();
        HashMap hashMap = new HashMap(zzn);
        for (int i = 0; i < zzn; i++) {
            String zzi = zzi(zzdy);
            Object zzh = zzh(zzdy, zzdy.zzk());
            if (zzh != null) {
                hashMap.put(zzi, zzh);
            }
        }
    ...
    public final boolean zza(zzdy zzdy) {
        return true;
    }

    public final boolean zzb(zzdy zzdy, long j) {
        if (zzdy.zzk() != 2 || !"onMetaData".equals(zzi(zzdy)) || zzdy.zza() == 0 || zzdy.zzk() != 8) {
            return false;
        }
        HashMap zzj = zzj(zzdy);
        Object obj = zzj.get(InAppMessageBase.DURATION);
