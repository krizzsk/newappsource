...
public final class zzbbl extends Thread {
    ...
    public zzbbl() {
        ...
        this.zzj = ((Integer) zzay.zzc().zzb(zzbhy.zzQ)).intValue();
        this.zzk = ((Integer) zzay.zzc().zzb(zzbhy.zzR)).intValue();
        this.zzl = ((Integer) zzay.zzc().zzb(zzbhy.zzS)).intValue();
        this.zze = ((Long) zzbjg.zzf.zze()).intValue();
        this.zzm = (String) zzay.zzc().zzb(zzbhy.zzU);
        this.zzn = ((Boolean) zzay.zzc().zzb(zzbhy.zzV)).booleanValue();
        this.zzo = ((Boolean) zzay.zzc().zzb(zzbhy.zzW)).booleanValue();
        this.zzp = ((Boolean) zzay.zzc().zzb(zzbhy.zzX)).booleanValue();
    ...
    public final void run() {
        /*
            r6 = this;
        L_0x0000:
            com.google.android.gms.internal.ads.zzbbg r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ all -> 0x00a8 }
        ...
        L_0x002a:
            ...
            if (r0 == 0) goto L_0x00b2
            com.google.android.gms.internal.ads.zzbbg r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            android.app.Activity r0 = r0.zza()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            if (r0 != 0) goto L_0x006d
            java.lang.String r0 = "ContentFetchThread: no activity. Sleeping."
            com.google.android.gms.internal.ads.zzcfi.zze(r0)     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x008e:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcer r2 = com.google.android.gms.ads.internal.zzt.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x009d:
            ...
            com.google.android.gms.internal.ads.zzbbh r0 = new com.google.android.gms.internal.ads.zzbbh     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00a8:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcer r1 = com.google.android.gms.ads.internal.zzt.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00dc:
            ...
            com.google.android.gms.internal.ads.zzcfi.zze(r1)     // Catch:{ InterruptedException -> 0x00dc }
    ...
    @VisibleForTesting
    public final zzbbk zzb(View view, zzbbb zzbbb) {
        if (view == null) {
        ...
        if ((view instanceof TextView) && !(view instanceof EditText)) {
            ...
            zzbbb.zzk(text.toString(), globalVisibleRect, view.getX(), view.getY(), (float) view.getWidth(), (float) view.getHeight());
            ...
            zzbbb.zzh();
            webView.post(new zzbbj(this, zzbbb, webView, globalVisibleRect));
            ...
            for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                zzbbk zzb2 = zzb(viewGroup.getChildAt(i3), zzbbb);
                i += zzb2.zza;
                i2 += zzb2.zzb;
            }
    ...
    public final void zzc(android.view.View r11) {
        /*
            r10 = this;
            com.google.android.gms.internal.ads.zzbbb r9 = new com.google.android.gms.internal.ads.zzbbb     // Catch:{ Exception -> 0x0083 }
            ...
            com.google.android.gms.internal.ads.zzbbg r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ Exception -> 0x0083 }
            ...
            com.google.android.gms.internal.ads.zzbhq r2 = com.google.android.gms.internal.ads.zzbhy.zzT     // Catch:{ Exception -> 0x0083 }
            com.google.android.gms.internal.ads.zzbhw r3 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ Exception -> 0x0083 }
        ...
        L_0x0053:
            return
        L_0x0054:
            com.google.android.gms.internal.ads.zzbbk r11 = r10.zzb(r11, r9)     // Catch:{ Exception -> 0x0083 }
        ...
        L_0x0073:
            com.google.android.gms.internal.ads.zzbbc r11 = r10.zzd     // Catch:{ Exception -> 0x0083 }
    ...
    @VisibleForTesting
    public final void zzd(zzbbb zzbbb, WebView webView, String str, boolean z) {
        zzbbb.zzg();
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString(MessageButton.TEXT);
                if (this.zzn || TextUtils.isEmpty(webView.getTitle())) {
                    zzbbb.zzl(optString, z, webView.getX(), webView.getY(), (float) webView.getWidth(), (float) webView.getHeight());
                } else {
