...
final class zzgjk extends zzgjo {
    ...
    public /* synthetic */ zzgjk(Iterable iterable, int i, boolean z, zzgjj zzgjj) {
        super((zzgjn) null);
        this.zzh = i;
        this.zze = iterable;
    ...
    private final void zzK() throws zzgla {
        if (this.zzf.hasNext()) {
            zzN();
            return;
        }
    ...
    private final void zzL(byte[] bArr, int i, int i2) throws IOException {
        if (i2 <= zzJ()) {
            ...
            while (i3 > 0) {
                ...
                long j = (long) min;
                zzgns.zzo(this.zzm, bArr, (long) (i2 - i3), j);
                i3 -= min;
                this.zzm += j;
            }
        } else if (i2 > 0) {
    ...
    public final int zzi() throws IOException {
        ...
        if (j - j2 >= 4) {
            this.zzm = 4 + j2;
            zza = (zzgns.zza(j2) & 255) | ((zzgns.zza(1 + j2) & 255) << 8) | ((zzgns.zza(2 + j2) & 255) << 16);
            zza2 = zzgns.zza(j2 + 3);
        } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0087, code lost:
        if (com.google.android.gms.internal.ads.zzgns.zza(r4) >= 0) goto L_0x0089;
     */
    ...
    public final long zzq() throws IOException {
        ...
        if (j - j2 >= 8) {
            this.zzm = 8 + j2;
            zza = (((long) zzgns.zza(j2)) & 255) | ((((long) zzgns.zza(1 + j2)) & 255) << 8) | ((((long) zzgns.zza(2 + j2)) & 255) << 16) | ((((long) zzgns.zza(3 + j2)) & 255) << 24) | ((((long) zzgns.zza(4 + j2)) & 255) << 32) | ((((long) zzgns.zza(5 + j2)) & 255) << 40) | ((((long) zzgns.zza(6 + j2)) & 255) << 48);
            zza2 = zzgns.zza(j2 + 7);
        } else {
            zza = (((long) zza()) & 255) | ((((long) zza()) & 255) << 8) | ((((long) zza()) & 255) << 16) | ((((long) zza()) & 255) << 24) | ((((long) zza()) & 255) << 32) | ((((long) zza()) & 255) << 40) | ((((long) zza()) & 255) << 48);
            zza2 = zza();
        }
        return zza | ((((long) zza2) & 255) << 56);
    }
    ...
    public final long zzr() throws IOException {
        ...
        if (this.zzo != j4) {
            long j5 = j4 + 1;
            byte zza = zzgns.zza(j4);
            if (zza >= 0) {
                this.zzm++;
                return (long) zza;
            } else if (this.zzo - this.zzm >= 10) {
                long j6 = j5 + 1;
                byte zza2 = zza ^ (zzgns.zza(j5) << 7);
                if (zza2 < 0) {
                    b = zza2 ^ Byte.MIN_VALUE;
                } else {
                    long j7 = j6 + 1;
                    byte zza3 = zza2 ^ (zzgns.zza(j6) << 14);
                    if (zza3 >= 0) {
                        j = (long) (zza3 ^ 16256);
                    } else {
                        j6 = j7 + 1;
                        byte zza4 = zza3 ^ (zzgns.zza(j7) << 21);
                        if (zza4 < 0) {
                            b = zza4 ^ -2080896;
                        } else {
                            j7 = j6 + 1;
                            long zza5 = ((long) zza4) ^ (((long) zzgns.zza(j6)) << 28);
                            if (zza5 >= 0) {
                                j3 = 266354560;
                            } else {
                                long j8 = j7 + 1;
                                long zza6 = zza5 ^ (((long) zzgns.zza(j7)) << 35);
                                if (zza6 < 0) {
                                    j2 = -34093383808L;
                                } else {
                                    j7 = j8 + 1;
                                    zza5 = zza6 ^ (((long) zzgns.zza(j8)) << 42);
                                    if (zza5 >= 0) {
                                        j3 = 4363953127296L;
                                    } else {
                                        j8 = j7 + 1;
                                        zza6 = zza5 ^ (((long) zzgns.zza(j7)) << 49);
                                        if (zza6 < 0) {
                                            j2 = -558586000294016L;
                                        } else {
                                            j7 = j8 + 1;
                                            j = (zza6 ^ (((long) zzgns.zza(j8)) << 56)) ^ 71499008037633920L;
                                            if (j < 0) {
                                                long j9 = 1 + j7;
                                                if (((long) zzgns.zza(j7)) >= 0) {
                                                    j6 = j9;
                                                    this.zzm = j6;
                                                    return j;
                                                }
    ...
    public final String zzy() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            long j3 = this.zzm;
            if (j <= j2 - j3) {
                String zzg2 = zzgnx.zzg(this.zzg, (int) (j3 - this.zzn), zzj2);
                this.zzm += j;
                return zzg2;
            }
        }
