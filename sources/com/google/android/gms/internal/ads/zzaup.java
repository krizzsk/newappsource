...
final class zzaup {
    ...
    public final long zze(zzatu zzatu, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.zzc == 0) {
            if (!zzatu.zzh(this.zzb, 0, 1, z)) {
                return -1;
            }
        ...
        if (i2 != 1) {
            zzatu.zzh(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
