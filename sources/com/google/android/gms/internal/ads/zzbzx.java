...
public final class zzbzx {
    ...
    public zzbzx(JSONObject jSONObject) {
        ...
        if (optString == null) {
            ...
            list = Arrays.asList(optString.split(AppboyConfigurationProvider.LOCALE_TO_API_KEY_MAPPING_SEPARATOR));
        }
        this.zza = list;
    ...
    private static boolean zzj(String str) {
        return str != null && (str.equals(DiskLruCache.VERSION_1) || str.equals(InneractiveMediationDefs.SHOW_HOUSE_AD_YES));
    }
