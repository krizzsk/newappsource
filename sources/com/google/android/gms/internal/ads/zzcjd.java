...
final class zzcjd implements zzayr {
    ...
    private final zzayq zzf = new zzayq();
    ...
    public zzcjd(String str, zzayx zzayx, int i, int i2, long j, long j2) {
        zzayy.zzb(str);
        this.zze = str;
        this.zzg = zzayx;
        this.zzc = i;
    ...
    public final int zza(byte[] bArr, int i, int i2) throws zzayo {
        ...
        try {
            ...
            throw new zzayo(e, this.zzh, 2);
        }
    }

    public final long zzb(zzayk zzayk) throws zzayo {
        long j;
        this.zzh = zzayk;
        this.zzn = 0;
        long j2 = zzayk.zzc;
        ...
        throw new zzcjb(headerField, zzayk);
    }
    ...
    @VisibleForTesting
    public final HttpURLConnection zzf(long j, long j2, int i) throws zzayo {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty(HttpHeader.USER_AGENT, this.zze);
            ...
            try {
                ...
                try {
                    ...
                    zzg();
                    throw new zzayo(e, this.zzh, i);
                }
            } catch (IOException e2) {
                zzg();
                throw new zzayo("Unable to connect to ".concat(String.valueOf(uri2)), e2, this.zzh, i);
            }
        } catch (IOException e3) {
            throw new zzayo("Unable to connect to ".concat(String.valueOf(uri)), e3, this.zzh, i);
        }
    }
}
