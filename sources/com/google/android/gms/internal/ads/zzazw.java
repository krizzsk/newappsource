...
public final class zzazw extends zzavq {
    ...
    public final int zzH(zzavs zzavs, zzars zzars) throws zzavv {
        ...
        if (zze2 && (i3 = zzars.zzj) > 0 && (i4 = zzars.zzk) > 0) {
            if (zzazn.zza >= 21) {
                zze2 = zzc2.zzf(i3, i4, (double) zzars.zzl);
            } else {
                if (i3 * i4 <= zzawa.zza()) {
                    zze2 = true;
                } else {
    ...
    public final boolean zzZ(MediaCodec mediaCodec, boolean z, zzars zzars, zzars zzars2) {
        ...
        if (i > zzazv.zza || zzars2.zzk > zzazv.zzb || zzars2.zzg > zzazv.zzc) {
            return false;
        }
        return true;
    }
