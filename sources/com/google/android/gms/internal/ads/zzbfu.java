...
public final class zzbfu extends zzgko implements zzglz {
    ...
    public static /* synthetic */ void zzA(zzbfu zzbfu, int i) {
        zzbfu.zzo = i - 1;
        zzbfu.zzf |= RecyclerView.C1119a0.FLAG_IGNORE;
    }

    public static /* synthetic */ void zzB(zzbfu zzbfu, int i) {
        zzbfu.zzq = i - 1;
        zzbfu.zzf |= 512;
    }
    ...
    public static /* synthetic */ void zzl(zzbfu zzbfu, long j) {
        zzbfu.zzf |= 1;
        zzbfu.zzg = j;
    }

    public static /* synthetic */ void zzm(zzbfu zzbfu, long j) {
        zzbfu.zzf |= 4;
        zzbfu.zzi = j;
    }

    public static /* synthetic */ void zzn(zzbfu zzbfu, long j) {
        zzbfu.zzf |= 8;
        zzbfu.zzj = j;
    }

    public static /* synthetic */ void zzo(zzbfu zzbfu, Iterable iterable) {
    ...
    public static /* synthetic */ void zzp(zzbfu zzbfu, zzbfp zzbfp) {
        zzbfp.getClass();
        zzbfu.zzl = zzbfp;
        zzbfu.zzf |= 16;
    }

    public static /* synthetic */ void zzq(zzbfu zzbfu, int i) {
        zzbfu.zzf |= 256;
        zzbfu.zzp = i;
    }

    public static /* synthetic */ void zzr(zzbfu zzbfu, zzbfy zzbfy) {
        zzbfu.zzr = zzbfy.zza();
        zzbfu.zzf |= 1024;
    }

    public static /* synthetic */ void zzx(zzbfu zzbfu, int i) {
        zzbfu.zzh = i - 1;
        zzbfu.zzf |= 2;
    }

    public static /* synthetic */ void zzy(zzbfu zzbfu, int i) {
        zzbfu.zzm = i - 1;
        zzbfu.zzf |= 32;
    }

    public static /* synthetic */ void zzz(zzbfu zzbfu, int i) {
        zzbfu.zzn = i - 1;
        zzbfu.zzf |= 64;
    }
    ...
    public final Object zzb(int i, Object obj, Object obj2) {
        ...
        if (i2 == 2) {
            ...
            return zzgko.zzaM(zze, "\u0001\f\u0000\u0001\u0001\f\f\u0000\u0001\u0000\u0001ဂ\u0000\u0002ဌ\u0001\u0003ဂ\u0002\u0004ဂ\u0003\u0005\u001e\u0006ဉ\u0004\u0007ဌ\u0005\bဌ\u0006\tဌ\u0007\nင\b\u000bဌ\t\fဌ\n", new Object[]{"zzf", "zzg", "zzh", zzgks, "zzi", "zzj", "zzk", zzbej.zzc(), "zzl", "zzm", zzgks, "zzn", zzgks, "zzo", zzgks, "zzp", "zzq", zzgks, "zzr", zzbfy.zzc()});
        } else if (i2 == 3) {
            return new zzbfu();
        } else {
            if (i2 == 4) {
