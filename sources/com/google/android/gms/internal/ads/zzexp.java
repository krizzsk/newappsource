...
final class zzexp implements zzfuw {
    ...
    public zzexp(zzexq zzexq, zzemr zzemr, zzfhq zzfhq, zzfhg zzfhg, zzcwr zzcwr) {
        this.zze = zzexq;
        this.zza = zzemr;
        this.zzb = zzfhq;
        this.zzc = zzfhg;
        ...
        synchronized (this.zze) {
            ...
            if (zzcvu.zzc() != null) {
                ...
                if (parent instanceof ViewGroup) {
                    ...
                    zzcfi.zzj("Banner view provided from " + str + " already has a parent view. Removing its old parent.");
                    ((ViewGroup) parent).removeView(zzcvu.zzc());
                }
            }
            zzbhq zzbhq = zzbhy.zzgL;
