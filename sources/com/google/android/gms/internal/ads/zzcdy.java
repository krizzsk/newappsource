...
public abstract class zzcdy extends zzaqw implements zzcdz {
    ...
    public static zzcdz zzb(IBinder iBinder) {
        ...
        if (queryLocalInterface instanceof zzcdz) {
            return (zzcdz) queryLocalInterface;
        }
        return new zzcdx(iBinder);
    }
    ...
    public final boolean zzbI(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case 1:
                ...
                zzced zzced = (zzced) zzaqx.zza(parcel, zzced.CREATOR);
                IBinder readStrongBinder = parcel.readStrongBinder();
                if (readStrongBinder != null) {
                    IInterface queryLocalInterface = readStrongBinder.queryLocalInterface("com.google.android.gms.ads.internal.signals.ISignalCallback");
                    if (queryLocalInterface instanceof zzcdw) {
                        zzcdw = (zzcdw) queryLocalInterface;
                    } else {
                        zzcdw = new zzcdu(readStrongBinder);
                    }
                }
                zzaqx.zzc(parcel);
                zze(asInterface, zzced, zzcdw);
