    ...
    public zzcel(String str, long j) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                this.zzg = jSONObject;
                if (jSONObject.optInt(ServerParameters.STATUS, -1) != 1) {
                    this.zzh = false;
                        ...
                        if (!TextUtils.isEmpty(optString)) {
                            if (!TextUtils.isEmpty(optString2)) {
                                if ("interstitial".equalsIgnoreCase(optString)) {
                                    ...
                                    this.zzc.put(optString2, new zzbtu(optJSONObject2));
                                }
                            }
                        }
                    }
                ...
                if (((Boolean) zzay.zzc().zzb(zzbhy.zzfl)).booleanValue() && (optJSONObject = this.zzg.optJSONObject("common_settings")) != null) {
                    this.zzj = optJSONObject.optBoolean("is_prefetching_enabled", false);
                }
            } catch (JSONException e) {
                zzcfi.zzk("Exception occurred while processing app setting json", e);
                zzt.zzo().zzt(e, "AppSettings.parseAppSettingsJson");
            }
        }
    }
