...
public final class zzdqg {
    ...
    private final zzfvj zzp(JSONObject jSONObject, zzfbg zzfbg, zzfbj zzfbj) {
        zzfvj zzb2 = this.zzi.zzb(jSONObject.optString("base_url"), jSONObject.optString("html"), zzfbg, zzfbj, zzk(jSONObject.optInt("width", 0), jSONObject.optInt("height", 0)));
    ...
    public final zzfvj zzh(JSONObject jSONObject, zzfbg zzfbg, zzfbj zzfbj) {
        ...
        boolean z = false;
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzhS)).booleanValue() && optJSONObject.has("html")) {
            z = true;
        }
        if (TextUtils.isEmpty(optString)) {
            if (!z) {
