...
interface zzgmj {
    ...
    @Deprecated
    void zzC(List list, zzgmr zzgmr, zzgka zzgka) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgmr zzgmr, zzgka zzgka) throws IOException;
    ...
    @Deprecated
    Object zzr(zzgmr zzgmr, zzgka zzgka) throws IOException;

    Object zzs(zzgmr zzgmr, zzgka zzgka) throws IOException;
