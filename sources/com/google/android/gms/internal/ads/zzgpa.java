...
public final class zzgpa extends zzgko implements zzglz {
    ...
    public static /* synthetic */ void zzg(zzgpa zzgpa, String str) {
        str.getClass();
        zzgpa.zze |= 4;
        zzgpa.zzh = str;
    }

    public static /* synthetic */ void zzh(zzgpa zzgpa, String str) {
        str.getClass();
        zzgpa.zze |= 8;
        zzgpa.zzi = str;
    }

    public static /* synthetic */ void zzi(zzgpa zzgpa, zzgoe zzgoe) {
        zzgoe.getClass();
        zzgpa.zzk = zzgoe;
        zzgpa.zze |= 32;
    }

    public static /* synthetic */ void zzj(zzgpa zzgpa, zzgox zzgox) {
        zzgox.getClass();
    ...
    public static /* synthetic */ void zzk(zzgpa zzgpa, String str) {
        zzgpa.zze |= 64;
        zzgpa.zzm = str;
    }

    public static /* synthetic */ void zzl(zzgpa zzgpa) {
        zzgpa.zze &= -65;
        zzgpa.zzm = zzb.zzm;
    }

    public static /* synthetic */ void zzm(zzgpa zzgpa, zzgor zzgor) {
        zzgor.getClass();
        zzgpa.zzn = zzgor;
        zzgpa.zze |= RecyclerView.C1119a0.FLAG_IGNORE;
    }

    public static /* synthetic */ void zzn(zzgpa zzgpa, zzgoz zzgoz) {
        zzgoz.getClass();
        zzgpa.zzu = zzgoz;
        zzgpa.zze |= 8192;
    }

    public static /* synthetic */ void zzo(zzgpa zzgpa, Iterable iterable) {
    ...
    public static /* synthetic */ void zzp(zzgpa zzgpa, Iterable iterable) {
    ...
    public static /* synthetic */ void zzq(zzgpa zzgpa, int i) {
        zzgpa.zzf = i - 1;
        zzgpa.zze |= 1;
    }
