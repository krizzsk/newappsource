...
abstract class zzgnu {
    public static final String zzd(ByteBuffer byteBuffer, int i, int i2) throws zzgla {
        if ((i | i2 | ((byteBuffer.limit() - i) - i2)) >= 0) {
            ...
            while (r11 < i3) {
                ...
                if (zzgnt.zzd(b2)) {
                    ...
                    int i9 = i6 + 1;
                    int i11 = i9 + 1;
                    zzgnt.zza(b2, byteBuffer.get(i6), byteBuffer.get(i9), byteBuffer.get(i11), cArr, i5);
                    i5 += 2;
                    r11 = i11 + 1;
                } else {
                    throw zzgla.zzd();
    ...
    public abstract String zzb(byte[] bArr, int i, int i2) throws zzgla;
