...
public final class zzeev extends zzbxj {
    ...
    public static void zzd(Context context, zzdwg zzdwg, zzfgo zzfgo, zzeen zzeen, String str, String str2, Map map) {
        ...
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzhf)).booleanValue()) {
            ...
            zza2.zzb("gqi", str);
            zza2.zzb(Events.PROPERTY_ACTION, str2);
            if (true == zzt.zzo().zzv(context)) {
                str4 = "online";
            }
    ...
    public static void zzh(Activity activity, zzl zzl, zzbr zzbr, zzeen zzeen, zzdwg zzdwg, zzfgo zzfgo, String str, String str2) {
        ...
        if (zzd2 == null) {
            ...
            str6 = zzd2.getString(C25559R.string.offline_opt_in_decline);
        }
        zzeen zzeen2 = zzeen;
        String str7 = str;
        zzdwg zzdwg2 = zzdwg;
    ...
    public final void zzg(IObjectWrapper iObjectWrapper, String str, String str2) {
        ...
        int i = zzfny.zza | 1073741824;
        PendingIntent zza2 = zzfny.zza(context, 0, intent, i, 0);
        Intent intent2 = new Intent();
        intent2.setClass(context, AdService.class);
        intent2.setAction("offline_notification_dismissed");
        intent2.putExtra("offline_notification_action", "offline_notification_dismissed");
        intent2.putExtra("gws_query_id", str2);
        PendingIntent zza3 = zzfny.zza(context, 0, intent2, i, 0);
        Resources zzd2 = zzt.zzo().zzd();
        C4522y yVar = new C4522y(context, "offline_notification_channel");
        if (zzd2 == null) {
            str3 = "View the ad you saved when you were offline";
        } else {
            str3 = zzd2.getString(C25559R.string.offline_notification_title);
        }
        yVar.mo20032d(str3);
        if (zzd2 == null) {
            str4 = "Tap to open ad";
        } else {
            str4 = zzd2.getString(C25559R.string.offline_notification_text);
        }
        yVar.mo20031c(str4);
        yVar.mo20034f(16, true);
        yVar.f15644y.deleteIntent = zza3;
        yVar.f15626g = zza2;
        yVar.f15644y.icon = context.getApplicationInfo().icon;
        ((NotificationManager) context.getSystemService("notification")).notify(str2, 54321, yVar.mo20030a());
