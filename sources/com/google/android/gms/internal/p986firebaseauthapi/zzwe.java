...
public final class zzwe {
    ...
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        /*
            ...
            switch(r0) {
                ...
                case 17095: goto L_0x00c3;
                case 17096: goto L_0x00c3;
        ...
        L_0x00f1:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p986firebaseauthapi.zzwe.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static FirebaseException zzb(Status status, AuthCredential authCredential, String str, String str2) {
        ...
        firebaseAuthUserCollisionException.mo43276b(authCredential);
        firebaseAuthUserCollisionException.mo43277c(str);
        firebaseAuthUserCollisionException.mo43278d(str2);
        return firebaseAuthUserCollisionException;
    }

    public static FirebaseAuthMultiFactorException zzc(FirebaseAuth firebaseAuth, zzso zzso, FirebaseUser firebaseUser) {
        firebaseAuth.getClass();
        zzso.getClass();
        Pair pair = (Pair) zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<MultiFactorInfo> zzc = zzso.zzc();
        ...
        List<MultiFactorInfo> zzc2 = zzso.zzc();
        String zzb = zzso.zzb();
        Preconditions.checkNotNull(zzc2);
        Preconditions.checkNotEmpty(zzb);
        zzag zzag = new zzag();
        zzag.f36434d = new ArrayList();
        for (MultiFactorInfo multiFactorInfo2 : zzc2) {
            if (multiFactorInfo2 instanceof PhoneMultiFactorInfo) {
                zzag.f36434d.add((PhoneMultiFactorInfo) multiFactorInfo2);
            }
        }
        zzag.f36433c = zzb;
        C19107d dVar = firebaseAuth.f36381a;
        dVar.mo51535a();
        return new FirebaseAuthMultiFactorException(str, str2, new zzae(arrayList, zzag, dVar.f48569b, zzso.zza(), (zzx) firebaseUser));
    }
