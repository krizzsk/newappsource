...
public final class zzqi extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getNewPassword", mo65739id = 2)
    private final String zzb;
    @SafeParcelable.Field(getter = "getTenantId", mo65739id = 3)
    private final String zzc;

    @SafeParcelable.Constructor
    public zzqi(@SafeParcelable.Param(mo65742id = 1) String str, @SafeParcelable.Param(mo65742id = 2) String str2, @SafeParcelable.Param(mo65742id = 3) String str3) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
    }
