...
public final class zzza extends AbstractSafeParcelable implements zzwp<zzza> {
    ...
    @SafeParcelable.Field(getter = "getRefreshToken", mo65739id = 2)
    private String zzb;
    @SafeParcelable.Field(getter = "getAccessToken", mo65739id = 3)
    private String zzc;
    @SafeParcelable.Field(getter = "getExpiresIn", mo65739id = 4)
    private Long zzd;
    @SafeParcelable.Field(getter = "getTokenType", mo65739id = 5)
    private String zze;
    @SafeParcelable.Field(getter = "getIssuedAt", mo65739id = 6)
    private Long zzf;

    static {
        Class<zzza> cls = zzza.class;
    }
    ...
    public static zzza zzd(String str) {
        try {
            ...
            zzza zzza = new zzza();
            zzza.zzb = jSONObject.optString("refresh_token", (String) null);
            zzza.zzc = jSONObject.optString("access_token", (String) null);
            zzza.zzd = Long.valueOf(jSONObject.optLong("expires_in"));
            zzza.zze = jSONObject.optString("token_type", (String) null);
            zzza.zzf = Long.valueOf(jSONObject.optLong("issued_at"));
            return zzza;
    ...
    public zzza(@SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) String str2, @SafeParcelable.Param(mo65742id = 4) Long l, @SafeParcelable.Param(mo65742id = 5) String str3, @SafeParcelable.Param(mo65742id = 6) Long l2) {
        this.zzb = str;
        this.zzc = str2;
        this.zzd = l;
        this.zze = str3;
