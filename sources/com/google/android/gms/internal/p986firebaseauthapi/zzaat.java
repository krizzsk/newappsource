...
final class zzaat extends zzaap implements RandomAccess, zzadt {
    private static final zzaat zza;
    private boolean[] zzb;
    private int zzc;

    static {
        zzaat zzaat = new zzaat(new boolean[0], 0);
        zza = zzaat;
        zzaat.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzaat.zzb, 0, this.zzb, this.zzc, zzaat.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzaat.zzc) {
            return false;
        }
        boolean[] zArr = zzaat.zzb;
