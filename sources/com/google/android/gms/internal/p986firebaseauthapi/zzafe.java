...
/* renamed from: com.google.android.gms.internal.firebase-auth-api.zzafe */
final class zzafe {
    private static final zzafb zza = new zzafc();
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r11 < i4) {
                ...
                if (zzafa.zzd(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzafa.zzb(b2, bArr[i6], bArr[i8], cArr, i3);
                        r11 = i8 + 1;
                        i3++;
                    } else {
                        throw zzacp.zzd();
                    ...
                    int i9 = i6 + 1;
                    int i11 = i9 + 1;
                    zzafa.zza(b2, bArr[i6], bArr[i9], bArr[i11], cArr, i3);
                    i3 += 2;
                    r11 = i11 + 1;
                } else {
                    throw zzacp.zzd();
