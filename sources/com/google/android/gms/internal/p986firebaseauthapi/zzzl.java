...
public final class zzzl extends AbstractSafeParcelable implements zzwp<zzzl> {
    ...
    private String zzb;
    @SafeParcelable.Field(getter = "getNewEmail", mo65739id = 3)
    private String zzc;
    @SafeParcelable.Field(getter = "getRequestType", mo65739id = 4)
    private String zzd;
    @SafeParcelable.Field(getter = "getMfaInfo", mo65739id = 5)
    private zzze zze;

    static {
        Class<zzzl> cls = zzzl.class;
    }
    ...
    public final /* bridge */ /* synthetic */ com.google.android.gms.internal.p986firebaseauthapi.zzwp zza(java.lang.String r17) throws com.google.android.gms.internal.p986firebaseauthapi.zzui {
        /*
            r16 = this;
            r1 = r16
            r2 = r17
        ...
        L_0x00a4:
            ...
            com.google.android.gms.internal.firebase-auth-api.zzze r0 = com.google.android.gms.internal.p986firebaseauthapi.zzze.zzb(r0)     // Catch:{ JSONException -> 0x00b7, NullPointerException -> 0x00b5 }
        ...
        L_0x00b8:
            ...
            com.google.android.gms.internal.firebase-auth-api.zzui r0 = com.google.android.gms.internal.p986firebaseauthapi.zzaam.zza(r0, r3, r2)
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p986firebaseauthapi.zzzl.zza(java.lang.String):com.google.android.gms.internal.firebase-auth-api.zzwp");
    }
    ...
    public zzzl(@SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) String str2, @SafeParcelable.Param(mo65742id = 4) String str3, @SafeParcelable.Param(mo65742id = 5) zzze zzze) {
        this.zzb = str;
        this.zzc = str2;
        this.zzd = str3;
        this.zze = zzze;
