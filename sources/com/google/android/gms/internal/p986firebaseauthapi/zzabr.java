...
final class zzabr extends zzaap implements RandomAccess, zzadt {
    private static final zzabr zza;
    private double[] zzb;
    private int zzc;

    static {
        zzabr zzabr = new zzabr(new double[0], 0);
        zza = zzabr;
        zzabr.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzabr.zzb, 0, this.zzb, this.zzc, zzabr.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzabr.zzc) {
            return false;
        }
        double[] dArr = zzabr.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzacn.zzc(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
