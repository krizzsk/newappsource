...
final class zzabq {
    ...
    private zzabq(zzabp zzabp) {
        zzacn.zzf(zzabp, "output");
        this.zza = zzabp;
        zzabp.zze = this;
    }

    public static zzabq zza(zzabp zzabp) {
        zzabq zzabq = zzabp.zze;
        return zzabq != null ? zzabq : new zzabq(zzabp);
    }
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzabp.zzE((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
                zzabp zzabp = this.zza;
                int intValue2 = ((Integer) list.get(i2)).intValue();
                zzabp.zzs((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            zzabp zzabp2 = this.zza;
            int intValue3 = ((Integer) list.get(i2)).intValue();
            zzabp2.zzr(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzabp.zzF((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
                zzabp zzabp = this.zza;
                long longValue2 = ((Long) list.get(i2)).longValue();
                zzabp.zzu((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzabp2.zzt(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzG(int i, List list) throws IOException {
        ...
        if (list instanceof zzacu) {
            ...
            while (i2 < list.size()) {
                Object zzf = zzacu.zzf(i2);
                if (zzf instanceof String) {
                    this.zza.zzo(i, (String) zzf);
                } else {
                    this.zza.zzQ(i, (zzabe) zzf);
                }
                i2++;
            }
            return;
    ...
    public final void zzI(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzabp.zzE(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
    ...
    public final void zzK(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzabp.zzF(((Long) list.get(i4)).longValue());
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, zzabe zzabe) throws IOException {
        this.zza.zzQ(i, zzabe);
    }
    ...
    public final void zzj(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzabp.zzy(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
    ...
    public final void zzq(int i, Object obj, zzady zzady) throws IOException {
        zzabp zzabp = this.zza;
        zzabp.zzq(i, 3);
        zzady.zzn((zzadm) obj, zzabp.zze);
        zzabp.zzq(i, 4);
    }
    ...
    public final void zzv(int i, Object obj, zzady zzady) throws IOException {
        this.zza.zzn(i, (zzadm) obj, zzady);
    }
