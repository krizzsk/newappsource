...
final class zzaci extends zzaap implements RandomAccess, zzadt {
    private static final zzaci zza;
    private int[] zzb;
    private int zzc;

    static {
        zzaci zzaci = new zzaci(new int[0], 0);
        zza = zzaci;
        zzaci.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzaci.zzb, 0, this.zzb, this.zzc, zzaci.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final /* bridge */ /* synthetic */ zzacm zzd(int i) {
        if (i >= this.zzc) {
            return new zzaci(Arrays.copyOf(this.zzb, i), this.zzc);
        }
