...
final class zzabn extends zzabk {
    ...
    public final void zzv(String str) throws IOException {
        ...
        try {
            ...
            if (i3 > i4) {
                ...
                int zzb = zzafe.zzb(str, bArr, 0, length);
                zzs(zzb);
                zzp(bArr, 0, zzb);
                return;
            }
            ...
            if (zzE2 == zzE) {
                int i5 = i + zzE2;
                this.zzc = i5;
                int zzb2 = zzafe.zzb(str, this.zza, i5, this.zzb - i5);
                this.zzc = i;
                i2 = (zzb2 - i) - zzE2;
                zzf(i2);
                this.zzc = zzb2;
                ...
                i2 = zzafe.zzc(str);
                zzf(i2);
                this.zzc = zzafe.zzb(str, this.zza, this.zzc, i2);
            }
            this.zzd += i2;
        } catch (zzafd e) {
            this.zzd -= this.zzc - i;
