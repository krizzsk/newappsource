...
public final class zzx extends GmsClient<zzi> {
    ...
    public final String zzb(String str) {
        ...
        try {
            ...
            if (packageManager == null || (applicationInfo = packageManager.getApplicationInfo(this.zzap.getPackageName(), RecyclerView.C1119a0.FLAG_IGNORE)) == null || (bundle = applicationInfo.metaData) == null) {
                return null;
            }
