...
public class zzk implements SafetyNetApi {
    ...
    public static class zzi implements SafetyNetApi.SafeBrowsingResult {
        ...
        public final List<SafeBrowsingThreat> getDetectedThreats() {
            ...
            try {
                JSONArray jSONArray = new JSONObject(this.zzm).getJSONArray(LinksConfiguration.KEY_MATCHES);
    ...
    public boolean isVerifyAppsEnabled(Context context) {
        ...
        try {
            ...
            boolean z = false;
            if (build.blockingConnect(3, timeUnit).isSuccess()) {
                SafetyNetApi.zzc await = isVerifyAppsEnabled(build).await(3, timeUnit);
