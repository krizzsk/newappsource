...
final class zzer implements C19449c {
    ...
    static {
        ...
        zze = new C19448b("loadDurationMs", C16530d.m42017j(hashMap4));
        zzah f5 = C13555b.m33967f(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(f5.annotationType(), f5);
        zzf = new C19448b("sessionDurationMs", C16530d.m42017j(hashMap5));
        zzah f6 = C13555b.m33967f(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(f6.annotationType(), f6);
        zzg = new C19448b("sessionTotalInferenceDurationMs", C16530d.m42017j(hashMap6));
    }
