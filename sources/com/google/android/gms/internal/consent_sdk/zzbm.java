...
final class zzbm implements zzg {
    ...
    public zzbm(Application application, zzbi zzbi, Handler handler, Executor executor, zzh zzh2, zzak zzak, zzay zzay, zzam zzam) {
    ...
    public final /* synthetic */ void zzc() {
        ...
        try {
            jSONObject.put(ServerParameters.APP_NAME, application.getPackageManager().getApplicationLabel(application.getApplicationInfo()).toString());
    ...
    public final void zzd(String str) {
        ...
        String queryParameter = parse.getQueryParameter(Events.PROPERTY_ACTION);
