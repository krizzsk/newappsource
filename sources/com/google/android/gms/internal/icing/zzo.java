...
public final class zzo extends AbstractSafeParcelable implements Result {
    ...
    public zzo(@SafeParcelable.Param(mo65742id = 1) Status status, @SafeParcelable.Param(mo65742id = 2) List<zzx> list, @SafeParcelable.Param(mo65742id = 3) String[] strArr) {
        this.zza = status;
        this.zzb = list;
        this.zzc = strArr;
    }
