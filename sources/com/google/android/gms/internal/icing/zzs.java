...
public final class zzs extends AbstractSafeParcelable {
    ...
    public zzs(@SafeParcelable.Param(mo65742id = 1) String str, @SafeParcelable.Param(mo65742id = 2) String str2, @SafeParcelable.Param(mo65742id = 3) boolean z, @SafeParcelable.Param(mo65742id = 4) int i, @SafeParcelable.Param(mo65742id = 5) boolean z2, @SafeParcelable.Param(mo65742id = 6) String str3, @SafeParcelable.Param(mo65742id = 7) zzm[] zzmArr, @SafeParcelable.Param(mo65742id = 11) String str4, @SafeParcelable.Param(mo65742id = 12) zzu zzu) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = z;
        this.zzd = i;
