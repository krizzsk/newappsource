...
public final class zzfs {
                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (55296 <= charAt2 && charAt2 <= 57343) {
                            if (Character.codePointAt(charSequence, i2) >= 65536) {
                                ...
                                throw new IllegalArgumentException(C13715c.m34241g(39, "Unpaired surrogate at index ", i2));
                            }
                        }
                    }
                    i2++;
    ...
    private final void zzap(int i) throws IOException {
        while ((i & -128) != 0) {
            zzao((i & 127) | RecyclerView.C1119a0.FLAG_IGNORE);
            i >>>= 7;
        }
        zzao(i);
    }
                    ...
                    if (i4 == length) {
                        ...
                        while (i4 < length) {
                            ...
                            if (charAt2 < 128 && i2 < i5) {
                                ...
                                int i9 = i8 + 1;
                                array[i8] = (byte) (((charAt2 >>> 6) & 63) | RecyclerView.C1119a0.FLAG_IGNORE);
                                i3 = i9 + 1;
                                ...
                                if (i11 != charSequence.length()) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        int i13 = i12 + 1;
                                        array[i12] = (byte) (((codePoint >>> 12) & 63) | RecyclerView.C1119a0.FLAG_IGNORE);
                                        int i14 = i13 + 1;
                                        array[i13] = (byte) (((codePoint >>> 6) & 63) | RecyclerView.C1119a0.FLAG_IGNORE);
                                        i2 = i14 + 1;
                                        array[i14] = (byte) ((codePoint & 63) | RecyclerView.C1119a0.FLAG_IGNORE);
                                        i4 = i11;
                                        i4++;
                                    } else {
                                        i4 = i11;
                ...
                while (i4 < length2) {
                    ...
                    if (charAt4 >= 128) {
                        if (charAt4 < 2048) {
                            ...
                            i = ((charAt4 >>> 6) & 63) | RecyclerView.C1119a0.FLAG_IGNORE;
                        } else {
                            int i15 = i4 + 1;
                            if (i15 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(charAt4, charAt5)) {
                                    ...
                                    byteBuffer.put((byte) (((codePoint2 >>> 12) & 63) | RecyclerView.C1119a0.FLAG_IGNORE));
                                    byteBuffer.put((byte) (((codePoint2 >>> 6) & 63) | RecyclerView.C1119a0.FLAG_IGNORE));
                                    byteBuffer.put((byte) ((codePoint2 & 63) | RecyclerView.C1119a0.FLAG_IGNORE));
                                    i4 = i15;
                                    i4++;
                                } else {
                                    i4 = i15;
                            ...
                            throw new IllegalArgumentException(C13715c.m34241g(39, "Unpaired surrogate at index ", i4 - 1));
                        }
    ...
    public final void zzn(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzao((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE);
            j >>>= 7;
        }
        zzao((int) j);
    }
