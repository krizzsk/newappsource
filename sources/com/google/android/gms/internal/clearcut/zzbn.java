...
public abstract class zzbn extends zzba {
        ...
        public final void zzb(long j) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    this.position = i3 + 1;
                    zzfd.zza(bArr3, (long) i3, (byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                    j >>>= 7;
                }
        ...
        public final void zzo(int i) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    zzfd.zza(bArr3, (long) i4, (byte) ((i & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                    i >>>= 7;
                }
                byte[] bArr4 = this.buffer;
    ...
    public static final class zzd extends zzbn {
        ...
        public final void zzb(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzgd.put((byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                j >>>= 7;
            }
            try {
        ...
        public final void zzo(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzgd.put((byte) ((i & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                i >>>= 7;
            }
            try {
        ...
        public final void zzb(long j) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while (true) {
                    ...
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((((int) j) & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                    j >>>= 7;
                }
            } else {
                while (true) {
        ...
        public final void zzo(int i) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while ((i & -128) != 0) {
                    long j2 = this.zzgi;
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((i & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                    i >>>= 7;
                }
                j = this.zzgi;
            } else {
                while (true) {
                    ...
                    if (j >= this.zzgg) {
                        ...
                        this.zzgi = j + 1;
                        zzfd.zza(j, (byte) ((i & 127) | RecyclerView.C1119a0.FLAG_IGNORE));
                        i >>>= 7;
                    }
                }
            }
    ...
    public static int zzb(int i, zzcv zzcv) {
        int zzh = zzh(2, i);
        return zza(3, zzcv) + zzh + (zzr(1) << 1);
    }

    public static int zzb(int i, zzdo zzdo, zzef zzef) {
        return zzb(zzdo, zzef) + zzr(i);
    }
    ...
    public static int zzd(int i, zzbb zzbb) {
        int zzh = zzh(2, i);
        return zzc(3, zzbb) + zzh + (zzr(1) << 1);
    }

    public static int zzd(int i, zzdo zzdo) {
        int zzh = zzh(2, i);
        return zzc(3, zzdo) + zzh + (zzr(1) << 1);
    }
