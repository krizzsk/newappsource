...
final class zzfj extends zzfg {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:12:0x0042 A[LOOP:1: B:12:0x0042->B:37:0x0101, LOOP_START, PHI: r2 r4 r9 r10 
      PHI: (r2v2 long) = (r2v0 long), (r2v3 long) binds: [B:8:0x003a, B:37:0x0101] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r4v5 long) = (r4v4 long), (r4v7 long) binds: [B:8:0x003a, B:37:0x0101] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r9v3 int) = (r9v2 int), (r9v5 int) binds: [B:8:0x003a, B:37:0x0101] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r10v1 char) = (r10v0 char), (r10v2 char) binds: [B:8:0x003a, B:37:0x0101] A[DONT_GENERATE, DONT_INLINE]] */
