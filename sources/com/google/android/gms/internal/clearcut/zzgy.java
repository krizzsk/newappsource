...
public final class zzgy extends zzfu<zzgy> implements Cloneable {
    ...
    public final int hashCode() {
        Class<zzgy> cls = zzgy.class;
        int hashCode = zzfy.hashCode(this.zzbiy);
        int hashCode2 = (zzfy.hashCode(this.zzbja) + ((zzfy.hashCode(this.zzbiz) + ((hashCode + ((((553293455 + zzfy.hashCode((Object[]) this.zzbiw)) * 31) + zzfy.hashCode((Object[]) this.zzbix)) * 31)) * 31)) * 31)) * 31;
        zzfw zzfw = this.zzrj;
        return hashCode2 + ((zzfw == null || zzfw.isEmpty()) ? 0 : this.zzrj.hashCode());
    }
    ...
    public final int zzen() {
        ...
        if (jArr2 != null && jArr2.length > 0) {
            ...
            while (true) {
                ...
                i12 += zzfs.zzo(jArr[i11]);
                i11++;
            }
            zzen = zzen + i12 + (jArr.length * 1);
        }
        long[] jArr3 = this.zzbja;
        if (jArr3 == null || jArr3.length <= 0) {
            return zzen;
        ...
        while (true) {
            long[] jArr4 = this.zzbja;
            if (i >= jArr4.length) {
                return zzen + i13 + (jArr4.length * 1);
            }
            i13 += zzfs.zzo(jArr4[i]);
            i++;
        }
    }
