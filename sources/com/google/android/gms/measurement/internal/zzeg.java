...
@VisibleForTesting
final class zzeg extends SQLiteOpenHelper {
    public final /* synthetic */ zzeh zza;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public zzeg(zzeh zzeh, Context context, String str) {
    ...
    public final SQLiteDatabase getWritableDatabase() throws SQLiteException {
        try {
            ...
            C16530d.m42018k(this.zza.zzs, "Opening the local database failed, dropping and recreating it");
            this.zza.zzs.zzf();
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        zzan.zza(this.zza.zzs.zzay(), sQLiteDatabase, "messages", "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", (String[]) null);
    }
