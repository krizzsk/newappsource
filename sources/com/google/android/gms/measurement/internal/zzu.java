...
final class zzu {
    ...
    public final zzfo zza(int i) {
        ...
        zzgg zzf2 = zzgh.zzf();
        zzf2.zzb(zzlb.zzr(this.zze));
        zzf2.zzd(zzlb.zzr(this.zzf));
        Map map = this.zzg;
        if (map == null) {
            arrayList = null;
        } else {
    ...
    public final void zzc(zzy zzy) {
        ...
        if (zzy.zzg != null) {
            ...
            zzny.zzc();
            zzag zzf2 = this.zza.zzs.zzf();
            String str = this.zzb;
            zzea zzea = zzeb.zzW;
            if (zzf2.zzs(str, zzea) && zzy.zzb()) {
                list.clear();
            }
            zzny.zzc();
            if (this.zza.zzs.zzf().zzs(this.zzb, zzea)) {
    ...
    public /* synthetic */ zzu(zzaa zzaa, String str, zzgh zzgh, BitSet bitSet, BitSet bitSet2, Map map, Map map2, zzt zzt) {
        this.zza = zzaa;
        this.zzb = str;
        this.zze = bitSet;
        this.zzf = bitSet2;
