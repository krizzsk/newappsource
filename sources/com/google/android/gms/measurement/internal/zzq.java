...
public final class zzq extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "Integer.MIN_VALUE", mo65739id = 11)
    ...
    @SafeParcelable.Field(defaultValue = "true", mo65739id = 16)
    ...
    @SafeParcelable.Field(defaultValue = "", mo65739id = 25)
    public final String zzv;
    @SafeParcelable.Field(defaultValue = "", mo65739id = 26)
    ...
    public zzq(@SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) String str2, @SafeParcelable.Param(mo65742id = 4) String str3, @SafeParcelable.Param(mo65742id = 5) String str4, @SafeParcelable.Param(mo65742id = 6) long j, @SafeParcelable.Param(mo65742id = 7) long j2, @SafeParcelable.Param(mo65742id = 8) String str5, @SafeParcelable.Param(mo65742id = 9) boolean z, @SafeParcelable.Param(mo65742id = 10) boolean z2, @SafeParcelable.Param(mo65742id = 11) long j3, @SafeParcelable.Param(mo65742id = 12) String str6, @SafeParcelable.Param(mo65742id = 13) long j4, @SafeParcelable.Param(mo65742id = 14) long j5, @SafeParcelable.Param(mo65742id = 15) int i, @SafeParcelable.Param(mo65742id = 16) boolean z3, @SafeParcelable.Param(mo65742id = 18) boolean z4, @SafeParcelable.Param(mo65742id = 19) String str7, @SafeParcelable.Param(mo65742id = 21) Boolean bool, @SafeParcelable.Param(mo65742id = 22) long j6, @SafeParcelable.Param(mo65742id = 23) List list, @SafeParcelable.Param(mo65742id = 24) String str8, @SafeParcelable.Param(mo65742id = 25) String str9, @SafeParcelable.Param(mo65742id = 26) String str10, @SafeParcelable.Param(mo65742id = 27) String str11) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzj = j3;
