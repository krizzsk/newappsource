...
final class zzig implements Runnable {
    ...
    public zzig(zzih zzih, String str, URL url, byte[] bArr, Map map, zzfw zzfw, byte[] bArr2) {
        this.zza = zzih;
    ...
    private final void zzb(int i, Exception exc, byte[] bArr, Map map) {
        this.zza.zzs.zzaz().zzp(new zzif(this, i, exc, bArr, map));
    }
    ...
    public final void run() {
        /*
            ...
            r0 = 0
            r1 = 0
            com.google.android.gms.measurement.internal.zzih r2 = r9.zza     // Catch:{ IOException -> 0x0092, all -> 0x0084 }
            ...
            com.google.android.gms.measurement.internal.zzfy r4 = r2.zzs     // Catch:{ IOException -> 0x0092, all -> 0x0084 }
            r4.zzf()     // Catch:{ IOException -> 0x0092, all -> 0x0084 }
            r4 = 60000(0xea60, float:8.4078E-41)
            r3.setConnectTimeout(r4)     // Catch:{ IOException -> 0x0092, all -> 0x0084 }
            com.google.android.gms.measurement.internal.zzfy r2 = r2.zzs     // Catch:{ IOException -> 0x0092, all -> 0x0084 }
    ...
    public final /* synthetic */ void zza(int i, Exception exc, byte[] bArr, Map map) {
        zzfw zzfw = this.zzd;
        zzfw.zza.zzC(this.zzc, i, exc, bArr, map);
    }
}
