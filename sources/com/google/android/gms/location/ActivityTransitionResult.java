...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", mo65739id = 1)
    private final List zza;
    @SafeParcelable.Field(getter = "getExtras", mo65739id = 2)
    private Bundle zzb;

    public ActivityTransitionResult(@SafeParcelable.Param(mo65742id = 1) List<ActivityTransitionEvent> list) {
        this.zzb = null;
    ...
    public ActivityTransitionResult(@SafeParcelable.Param(mo65742id = 1) List list, @SafeParcelable.Param(mo65742id = 2) Bundle bundle) {
        this(list);
        this.zzb = bundle;
    }
}
