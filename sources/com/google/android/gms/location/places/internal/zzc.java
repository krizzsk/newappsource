...
public final class zzc extends AbstractSafeParcelable implements AutocompletePrediction {
    ...
    public zzc(@SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) List<Integer> list, @SafeParcelable.Param(mo65742id = 5) int i, @SafeParcelable.Param(mo65742id = 1) String str2, @SafeParcelable.Param(mo65742id = 4) List<zzb> list2, @SafeParcelable.Param(mo65742id = 6) String str3, @SafeParcelable.Param(mo65742id = 7) List<zzb> list3, @SafeParcelable.Param(mo65742id = 8) String str4, @SafeParcelable.Param(mo65742id = 9) List<zzb> list4) {
        this.placeId = str;
        this.zzg = list;
        this.zzbe = i;
        this.zzbc = str2;
