...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo65739id = 3)
    private final String tag;
    @SafeParcelable.VersionField(mo65748id = 1)
    private final int versionCode;
    @SafeParcelable.Field(getter = "getPlaceId", mo65739id = 2)
    private final String zza;
    @SafeParcelable.Field(getter = "getSource", mo65739id = 4)
    private final String zzb;

    @SafeParcelable.Constructor
    public PlaceReport(@SafeParcelable.Param(mo65742id = 1) int i, @SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) String str2, @SafeParcelable.Param(mo65742id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
