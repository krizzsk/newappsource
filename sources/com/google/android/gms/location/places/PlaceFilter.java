...
public final class PlaceFilter extends zzb {
    ...
    private PlaceFilter(Collection<Integer> collection, boolean z, Collection<String> collection2, Collection<zzp> collection3) {
        this((List<Integer>) zzb.zzb((Collection) null), z, zzb.zzb(collection2), (List<zzp>) zzb.zzb((Collection) null));
    }

    @SafeParcelable.Constructor
    public PlaceFilter(@SafeParcelable.Param(mo65742id = 1) List<Integer> list, @SafeParcelable.Param(mo65742id = 3) boolean z, @SafeParcelable.Param(mo65742id = 6) List<String> list2, @SafeParcelable.Param(mo65742id = 4) List<zzp> list3) {
        this.zzs = list;
        this.zzt = z;
        this.zzu = list3;
        this.zzv = list2;
