...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public String toString() {
        ...
        C16530d.m42019l(sb, "ActivityRecognitionResult [probableActivities=", valueOf, ", timeMillis=");
        sb.append(j);
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(mo65742id = 1) List list, @SafeParcelable.Param(mo65742id = 2) long j, @SafeParcelable.Param(mo65742id = 3) long j2, @SafeParcelable.Param(mo65742id = 4) int i, @SafeParcelable.Param(mo65742id = 5) Bundle bundle) {
        boolean z = true;
