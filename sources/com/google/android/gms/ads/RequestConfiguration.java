...
public class RequestConfiguration {
    ...
    public static class Builder {
        ...
        public RequestConfiguration build() {
            return new RequestConfiguration(this.zza, this.zzb, this.zzc, this.zzd, (zze) null);
        }
    ...
    public /* synthetic */ RequestConfiguration(int i, int i2, String str, List list, zze zze2) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
        this.zze = list;
