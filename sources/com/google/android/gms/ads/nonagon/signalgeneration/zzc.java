...
public final class zzc {
    ...
    public zzc(zzdwl zzdwl) {
        ...
        this.zze = DesugarCollections.synchronizedMap(new zzb(this));
    }
    ...
    private final void zzh(zzdwb zzdwb, ArrayDeque arrayDeque, String str) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            concurrentHashMap.put(Events.PROPERTY_ACTION, "ev");
            this.zzi.put("e_r", str);
            this.zzi.put("e_id", (String) pair2.first);
            if (this.zzd) {
                try {
                    JSONObject jSONObject = new JSONObject((String) pair2.second);
                    pair = new Pair(zzf.zza(jSONObject.getJSONObject(InAppMessageBase.EXTRAS).getString("query_info_type")), jSONObject.getString("request_agent"));
    ...
    public final synchronized String zzb(String str, zzdwb zzdwb) {
        ...
        if (pair != null) {
            ...
            this.zze.remove(str);
            zzdwb.zza().put("mhit", InneractiveMediationDefs.SHOW_HOUSE_AD_YES);
            return str2;
        }
