...
public final class zzdu {
                        ...
                        if (zzn2 != null) {
                            if (((Boolean) zzbjm.zze.zze()).booleanValue()) {
                                if (((Boolean) zzay.zzc().zzb(zzbhy.zziq)).booleanValue()) {
                                    zzcfb.zza.post(new zzds(this, zzn2));
                                }
                            }
    ...
    public final void zzv(AppEventListener appEventListener) {
        ...
        try {
            ...
            if (zzbs != null) {
                if (appEventListener != null) {
                    zzbba = new zzbba(appEventListener);
                } else {
                    zzbba = null;
                }
                zzbs.zzG(zzbba);
    ...
    public final void zzx(OnPaidEventListener onPaidEventListener) {
        try {
            ...
            zzbs zzbs = this.zzj;
            if (zzbs != null) {
                zzbs.zzP(new zzez(onPaidEventListener));
            }
        } catch (RemoteException e) {
            zzcfi.zzl("#007 Could not call remote method.", e);
        }
    ...
    @VisibleForTesting
    public zzdu(ViewGroup viewGroup, AttributeSet attributeSet, boolean z, zzp zzp2, zzbs zzbs, int i) {
        zzq zzq;
        this.zzb = new zzbtw();
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                if (viewGroup.isInEditMode()) {
                    ...
                    zzb2.zzk(viewGroup, zzq, "Ads by Google");
                }
            } catch (IllegalArgumentException e) {
                zzaw.zzb().zzj(viewGroup, new zzq(context, AdSize.BANNER), e.getMessage(), e.getMessage());
            }
        }
    }
}
