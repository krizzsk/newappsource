...
public final class zzef extends ContentProvider {
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        Bundle bundle = null;
        try {
            bundle = Wrappers.packageManager(context).getApplicationInfo(context.getPackageName(), RecyclerView.C1119a0.FLAG_IGNORE).metaData;
        } catch (NullPointerException e) {
            zzcfi.zzh("Failed to load metadata: Null pointer exception.", e);
