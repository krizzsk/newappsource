...
public final class zzbu {
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            ...
                            zzcfi.zzj(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
    ...
    public static String zzl(zzfbl zzfbl) {
        if (zzfbl == null) {
            return null;
        }
        ...
        try {
            ...
            zzn(jsonWriter, zzfbl);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e) {
            zzcfi.zzh("Error when writing JSON.", e);
            return null;
        }
    }
