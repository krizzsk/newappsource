...
public final class zzj implements zzg {
    ...
    private final void zzR() {
        ...
        if (zzfvj != null && !zzfvj.isDone()) {
            try {
                ...
                zzcfi.zzk("Interrupted while waiting for preferences loaded.", e);
            } catch (CancellationException | ExecutionException | TimeoutException e2) {
                zzcfi.zzh("Fail to initialize AdSharedPreferenceManager.", e2);
            }
        }
    }

    private final void zzS() {
        zzcfv.zza.execute(new zzi(this));
    }
    ...
    public final void zzI(String str, String str2, boolean z) {
        ...
        synchronized (this.zza) {
            ...
            try {
                ...
                zzcfi.zzk("Could not update native advanced settings", e);
            }
            SharedPreferences.Editor editor = this.zzg;
            if (editor != null) {
    ...
    public final /* synthetic */ void zzQ(Context context, String str) {
        ...
        synchronized (this.zza) {
            ...
            this.zzt = this.zzf.getInt(AppboyConfigurationProvider.VERSION_CODE_KEY, this.zzt);
            ...
            try {
                ...
                zzcfi.zzk("Could not convert native advanced settings to json object", e);
            }
            zzS();
        }
    }
    ...
    public final void zzr(Context context) {
        synchronized (this.zza) {
            if (this.zzf == null) {
                this.zzd = zzcfv.zza.zza(new zzh(this, context, InneractiveMediationNameConsts.ADMOB));
                this.zzb = true;
            }
        }
    }
