...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            advertisingIdClient.zzc(zzd2, true, BitmapDescriptorFactory.HUE_RED, SystemClock.elapsedRealtime() - elapsedRealtime, "", (Throwable) null);
    ...
    public final boolean zzc(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        HashMap u = C0016g.m37u("app_context", str2);
        if (info != null) {
            if (true != info.isLimitAdTrackingEnabled()) {
                str2 = "0";
            }
            u.put("limit_ad_tracking", str2);
            String id = info.getId();
            if (id != null) {
                u.put("ad_id_size", Integer.toString(id.length()));
            }
        }
        if (th != null) {
            u.put("error", th.getClass().getName());
        }
        u.put("tag", "AdvertisingIdClient");
        u.put("time_spent", Long.toString(j));
        new zza(this, u).start();
        return true;
    }
