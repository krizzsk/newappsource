...
public abstract class PhenotypeFlag<T> {
    ...
    public /* synthetic */ PhenotypeFlag(Factory factory, String str, Object obj, zzr zzr) {
    ...
    private static boolean zzf() {
        if (zzan == null) {
            ...
            if (C24361g.m61183r(context, "com.google.android.providers.gsf.permission.READ_GSERVICES") == 0) {
                z = true;
            }
