    ...
    public static final class WalletOptions implements Api.ApiOptions.HasAccountOptions {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof WalletOptions) {
                ...
                if (!Objects.equal(Integer.valueOf(this.environment), Integer.valueOf(walletOptions.environment)) || !Objects.equal(Integer.valueOf(this.theme), Integer.valueOf(walletOptions.theme)) || !Objects.equal((Object) null, (Object) null) || !Objects.equal(Boolean.valueOf(this.zzb), Boolean.valueOf(walletOptions.zzb))) {
                    return false;
                }
                return true;
            }
