...
public final class OfferWalletObject extends AbstractSafeParcelable {
    ...
    public final class Builder {
        ...
        public /* synthetic */ Builder(zzu zzu) {
        }
    ...
    public OfferWalletObject(@SafeParcelable.Param(mo65742id = 1) int i, @SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) String str2, @SafeParcelable.Param(mo65742id = 4) CommonWalletObject commonWalletObject) {
        this.zzd = i;
        this.zzb = str2;
        if (i < 3) {
