...
final class zzc implements Runnable {
    ...
    public zzc(zzd zzd2, CallbackInput callbackInput, Messenger messenger, String str, int i) {
        this.zza = zzd2;
    ...
    public final void run() {
        if (Log.isLoggable("BaseCallbackTaskService", 4)) {
            String.format(Locale.US, "Running Callback Task w/ tag %s", new Object[]{this.zzc});
        }
        try {
