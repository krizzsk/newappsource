...
public class zzl {
        ...
        if (zzhs.zze() && zzo(context)) {
            try {
                ...
                if (zzby.zzb(zza2)) {
                    ...
                    logger.mo65859w("isUserRecoverableError status: " + valueOf, new Object[0]);
    ...
    private static TokenData zzg(Bundle bundle) throws GoogleAuthException, IOException {
        ...
        zzby zza2 = zzby.zza(string);
        if (zzby.zzb(zza2)) {
            zzd.mo65859w("isUserRecoverableError status: ".concat(String.valueOf(zza2)), new Object[0]);
            throw new UserRecoverableAuthException(string, intent);
        } else if (zzby.NETWORK_ERROR.equals(zza2) || zzby.zzf.equals(zza2) || zzby.INTNERNAL_ERROR.equals(zza2) || zzby.AUTH_SECURITY_ERROR.equals(zza2) || zzby.ACCOUNT_NOT_PRESENT.equals(zza2)) {
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzk, long j) throws IOException, GoogleAuthException {
        ...
        try {
            ...
            String.format("SecurityException while bind to auth service: %s", new Object[]{e2.getMessage()});
    ...
    public static Object zzj(Object obj) throws IOException {
        ...
        zzd.mo65859w("Service call returned null.", new Object[0]);
    ...
    private static void zzl(ApiException apiException, String str) {
        zzd.mo65859w("%s failed via GoogleAuthServiceClient, falling back to previous approach:\n%s", str, Log.getStackTraceString(apiException));
    }
