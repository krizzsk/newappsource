...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getScopes", mo65739id = 2)
    public final ArrayList zah;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo65739id = 3)
    public Account zai;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo65739id = 4)
    public boolean zaj;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo65739id = 5)
    public final boolean zak;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo65739id = 6)
    public final boolean zal;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo65739id = 7)
    public String zam;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo65739id = 8)
    public String zan;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo65739id = 9)
    public ArrayList zao;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getLogSessionId", mo65739id = 10)
    public String zap;
    private Map zaq;
    ...
    public GoogleSignInOptions(@SafeParcelable.Param(mo65742id = 1) int i, @SafeParcelable.Param(mo65742id = 2) ArrayList arrayList, @SafeParcelable.Param(mo65742id = 3) Account account, @SafeParcelable.Param(mo65742id = 4) boolean z, @SafeParcelable.Param(mo65742id = 5) boolean z2, @SafeParcelable.Param(mo65742id = 6) boolean z3, @SafeParcelable.Param(mo65742id = 7) String str, @SafeParcelable.Param(mo65742id = 8) String str2, @SafeParcelable.Param(mo65742id = 9) ArrayList arrayList2, @SafeParcelable.Param(mo65742id = 10) String str3) {
