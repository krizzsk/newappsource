...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsumerPkgName", mo65739id = 2)
    private final String zba;
    @SafeParcelable.Field(getter = "getGoogleConfig", mo65739id = 5)
    private GoogleSignInOptions zbb;

    @SafeParcelable.Constructor
    public SignInConfiguration(@SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 5) GoogleSignInOptions googleSignInOptions) {
