...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    private int zab;
    @SafeParcelable.Field(getter = "getBundle", mo65739id = 3)
    private Bundle zac;

    @SafeParcelable.Constructor
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(mo65742id = 1) int i, @SafeParcelable.Param(mo65742id = 2) int i2, @SafeParcelable.Param(mo65742id = 3) Bundle bundle) {
        this.zaa = i;
        this.zab = i2;
        this.zac = bundle;
    }
