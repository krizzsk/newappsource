...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "isPasswordLoginSupported", mo65739id = 1)
    private final boolean zbb;
    @SafeParcelable.Field(getter = "getAccountTypes", mo65739id = 2)
    private final String[] zbc;
    @SafeParcelable.Field(getter = "getCredentialPickerConfig", mo65739id = 3)
    private final CredentialPickerConfig zbd;
    @SafeParcelable.Field(getter = "getCredentialHintPickerConfig", mo65739id = 4)
    ...
    @SafeParcelable.Field(getter = "getRequireUserMediation", mo65739id = 8)
    ...
    public CredentialRequest(@SafeParcelable.Param(mo65742id = 1000) int i, @SafeParcelable.Param(mo65742id = 1) boolean z, @SafeParcelable.Param(mo65742id = 2) String[] strArr, @SafeParcelable.Param(mo65742id = 3) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(mo65742id = 4) CredentialPickerConfig credentialPickerConfig2, @SafeParcelable.Param(mo65742id = 5) boolean z2, @SafeParcelable.Param(mo65742id = 6) String str, @SafeParcelable.Param(mo65742id = 7) String str2, @SafeParcelable.Param(mo65742id = 8) boolean z3) {
        this.zba = i;
        this.zbb = z;
