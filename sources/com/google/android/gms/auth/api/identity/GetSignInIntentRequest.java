...
public class GetSignInIntentRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getServerClientId", mo65739id = 1)
    private final String zba;
    @SafeParcelable.Field(getter = "getHostedDomainFilter", mo65739id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getSessionId", mo65739id = 3)
    private String zbc;
    @SafeParcelable.Field(getter = "getNonce", mo65739id = 4)
    private final String zbd;
    @SafeParcelable.Field(getter = "requestVerifiedPhoneNumber", mo65739id = 5)
    private final boolean zbe;
    @SafeParcelable.Field(getter = "getTheme", mo65739id = 6)
    ...
    public GetSignInIntentRequest(@SafeParcelable.Param(mo65742id = 1) String str, @SafeParcelable.Param(mo65742id = 2) String str2, @SafeParcelable.Param(mo65742id = 3) String str3, @SafeParcelable.Param(mo65742id = 4) String str4, @SafeParcelable.Param(mo65742id = 5) boolean z, @SafeParcelable.Param(mo65742id = 6) int i) {
        Preconditions.checkNotNull(str);
        this.zba = str;
        this.zbb = str2;
        this.zbc = str3;
