...
public class SaveAccountLinkingTokenRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsentPendingIntent", mo65739id = 1)
    private final PendingIntent zba;
    @SafeParcelable.Field(getter = "getTokenType", mo65739id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getServiceId", mo65739id = 3)
    private final String zbc;
    @SafeParcelable.Field(getter = "getScopes", mo65739id = 4)
    private final List zbd;
    @SafeParcelable.Field(getter = "getSessionId", mo65739id = 5)
    ...
    public SaveAccountLinkingTokenRequest(@SafeParcelable.Param(mo65742id = 1) PendingIntent pendingIntent, @SafeParcelable.Param(mo65742id = 2) String str, @SafeParcelable.Param(mo65742id = 3) String str2, @SafeParcelable.Param(mo65742id = 4) List list, @SafeParcelable.Param(mo65742id = 5) String str3, @SafeParcelable.Param(mo65742id = 6) int i) {
        this.zba = pendingIntent;
        this.zbb = str;
        this.zbc = str2;
        this.zbd = list;
