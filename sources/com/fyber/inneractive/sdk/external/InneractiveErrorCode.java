...
public enum InneractiveErrorCode {
    ...
    /* renamed from: b */
    public final Metricable f9507b;

    /* renamed from: c */
    public final Metricable f9508c;
    ...
    InneractiveErrorCode(String str, Metricable metricable, Metricable metricable2) {
        this.f9506a = str;
        this.f9507b = metricable;
        this.f9508c = metricable2;
    }
    ...
    public boolean shouldSendTimeMetric() {
        return this.f9508c == Metricable.INCLUDED_IN_FAILED_METRICS;
    }
