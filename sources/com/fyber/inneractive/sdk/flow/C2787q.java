...
public abstract class C2787q<EventsListenerT extends InneractiveContentController.EventsListener> implements InneractiveContentController<EventsListenerT> {
    ...
    public InneractiveAdSpot getAdSpot() {
        return (InneractiveAdSpot) C3727s.m9987a(this.mAdSpot);
    }
