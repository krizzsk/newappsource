...
public final class C3405t {
    /* renamed from: a */
    public static Uri m8584a(String str, String str2) {
        String str3;
        ...
        if (a[0] != -1) {
            ...
            if (a[3] == 0) {
                ...
                if (i != 0) {
                    ...
                    sb.append(str, 0, i2);
                    sb.append(str2);
                    str3 = m8585a(sb, a[1] + i2, i2 + a[2]);
                } else if (str2.charAt(i) == '/') {
                    sb.append(str, 0, a2[1]);
                    sb.append(str2);
                    int i3 = a2[1];
                    str3 = m8585a(sb, i3, a[2] + i3);
                } else {
                    int i4 = a2[0] + 2;
                    int i5 = a2[1];
                    if (i4 >= i5 || i5 != a2[2]) {
                        ...
                        sb.append(str, 0, i6);
                        sb.append(str2);
                        str3 = m8585a(sb, a2[1], i6 + a[2]);
                    } else {
                        sb.append(str, 0, i5);
                        sb.append('/');
                        sb.append(str2);
                        int i7 = a2[1];
                        str3 = m8585a(sb, i7, a[2] + i7 + 1);
                    }
                }
            }
        }
    ...
    /* renamed from: a */
    public static String m8585a(StringBuilder sb, int i, int i2) {
        int i3;
        int i4;
        if (i >= i2) {
            return sb.toString();
    ...
    /* renamed from: a */
    public static int[] m8586a(String str) {
        int i;
        int[] iArr = new int[4];
