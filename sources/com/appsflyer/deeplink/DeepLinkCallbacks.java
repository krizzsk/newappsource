...
public class DeepLinkCallbacks {
    public static void $$b(DeepLinkResult deepLinkResult) {
    ...
    public static void onDeepLinkingError(String str) {
        if (AFDeepLinkManager.getInstance().deepLinkListener != null) {
            ...
            $$b(new DeepLinkResult((DeepLink) null, DeepLinkResult.Error.NETWORK));
    ...
    public static void onDeepLinkingSuccess(Map<String, String> map) {
        ...
        if (AFDeepLinkManager.getInstance().deepLinkListener != null) {
            try {
                ...
                values.$$b.put("is_deferred", false);
                ...
                $$b(new DeepLinkResult((DeepLink) null, (DeepLinkResult.Error) null));
                throw th;
            }
            $$b(deepLinkResult);
            return;
