...
public class Installation {
    ...
    /* renamed from: id */
    public static synchronized String m5498id(WeakReference<Context> weakReference) {
        synchronized (Installation.class) {
            ...
            if ($$b == null) {
                ...
                if ($$b != null) {
                    AppsFlyerProperties.getInstance().set(ServerParameters.AF_USER_ID, $$b);
                }
            }
            String str4 = $$b;
            return str4;
    ...
    private static java.lang.String values(java.io.File r6) {
        ...
        L_0x0052:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.Installation.values(java.io.File):java.lang.String");
    }
}
