...
public final class b$2 extends HashMap<String, String> {
    public b$2() {
        put("aa", "ro.arch");
        put("ab", "ro.chipname");
        put(Constants.APPBOY_PUSH_ACCENT_KEY, "ro.dalvik.vm.native.bridge");
        put(AttributionData.CREATIVE_KEY, "persist.sys.nativebridge");
