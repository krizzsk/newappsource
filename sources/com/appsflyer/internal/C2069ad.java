...
public final class C2069ad {
    private static C2069ad $$b = null;
    private static String AFDateFormat = "https://%smonitorsdk.%s/remote-debug?app_id=";
    public boolean $$a;
    private String AFDeepLinkManager = "-1";
    private int collectIntentsFromActivities = 0;
    private boolean dateFormatUTC;
    private final List<String> getDataFormatter = new ArrayList();
    private boolean getInstance;
    private JSONObject valueOf;
    private boolean values = true;

    public static C2069ad $$a() {
        if ($$b == null) {
            $$b = new C2069ad();
        }
        return $$b;
    ...
    private synchronized java.lang.String AFDeepLinkManager() {
        /*
            r4 = this;
            monitor-enter(r4)
            ...
            java.util.List<java.lang.String> r3 = r4.getDataFormatter     // Catch:{ JSONException -> 0x001c, all -> 0x0019 }
            ...
            r4.dateFormatUTC()     // Catch:{ JSONException -> 0x001d, all -> 0x0019 }
            goto L_0x001d
        L_0x0019:
            r0 = move-exception
            monitor-exit(r4)
        ...
        L_0x001d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C2069ad.AFDeepLinkManager():java.lang.String");
    }

    private synchronized void dateFormatUTC() {
        this.getDataFormatter.clear();
        this.collectIntentsFromActivities = 0;
    }

    private boolean getDataFormatter() {
        if (this.$$a) {
            return this.values || this.dateFormatUTC;
        }
        return false;
    }

    public final synchronized void AFDateFormat() {
        this.dateFormatUTC = true;
    ...
    public final synchronized void AFDateFormat(java.lang.String r4, java.lang.String r5, java.lang.String... r6) {
        /*
            ...
            int r0 = r3.collectIntentsFromActivities     // Catch:{ all -> 0x0093 }
        ...
        L_0x0010:
            ...
            r2.append(r0)     // Catch:{ all -> 0x008f }
            java.lang.String r0 = " _/AppsFlyer_6.1.4 ["
            r2.append(r0)     // Catch:{ all -> 0x008f }
        ...
        L_0x0051:
            ...
            java.lang.String r5 = "/AppsFlyer_6.1.4 "
            r4.append(r5)     // Catch:{ all -> 0x008f }
            r4.append(r6)     // Catch:{ all -> 0x008f }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x008f }
        L_0x007d:
            java.util.List<java.lang.String> r5 = r3.getDataFormatter     // Catch:{ all -> 0x008f }
            r5.add(r4)     // Catch:{ all -> 0x008f }
            int r5 = r3.collectIntentsFromActivities     // Catch:{ all -> 0x008f }
            int r4 = r4.length()     // Catch:{ all -> 0x008f }
            int r4 = r4 << 1
            int r5 = r5 + r4
            r3.collectIntentsFromActivities = r5     // Catch:{ all -> 0x008f }
            monitor-exit(r3)
            return
        L_0x008f:
            monitor-exit(r3)
        ...
        L_0x0093:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C2069ad.AFDateFormat(java.lang.String, java.lang.String, java.lang.String[]):void");
    }
    ...
    public static void $$a(String str, PackageManager packageManager) {
        try {
            ...
            BackgroundEvent trackingStopped = new ProxyEvent().body($$b.AFDeepLinkManager()).trackingStopped(AppsFlyerLib.getInstance().isStopped());
            StringBuilder sb = new StringBuilder();
            sb.append(ServerConfigHandler.getUrl(AFDateFormat));
            sb.append(str);
    ...
    private synchronized void $$b(java.lang.String r11, android.content.pm.PackageManager r12) {
        ...
        L_0x0019:
            ...
            java.lang.String r8 = r1.$$b     // Catch:{ all -> 0x0090 }
            java.lang.String r9 = r1.$$a     // Catch:{ all -> 0x0090 }
            r3 = r10
            r3.$$b(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0090 }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ all -> 0x0090 }
            java.lang.String r2 = "6.1.4."
            r1.<init>(r2)     // Catch:{ all -> 0x0090 }
            java.lang.String r2 = com.appsflyer.AppsFlyerLibCore.values     // Catch:{ all -> 0x0090 }
            ...
            r10.valueOf(r1, r2, r3, r4)     // Catch:{ all -> 0x0090 }
            r1 = 0
            ...
            r10.values(r11, r12, r1, r2)     // Catch:{ all -> 0x0074 }
        L_0x0074:
        ...
        L_0x007f:
            ...
            java.lang.String r0 = r10.AFDeepLinkManager     // Catch:{ JSONException -> 0x008a }
        ...
        L_0x0090:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C2069ad.$$b(java.lang.String, android.content.pm.PackageManager):void");
    }

    public static String[] AFDateFormat(String str, StackTraceElement[] stackTraceElementArr) {
