...
public class Banner {
    ...
    public static /* synthetic */ class C121751 {

        /* renamed from: $SwitchMap$com$unity3d$services$banners$api$Banner$BannerViewType */
        public static final /* synthetic */ int[] f30905xf0b64357;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f30905xf0b64357     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.banners.api.Banner.C121751.<clinit>():void");
        }
    }
    ...
    public static void load(String str, Integer num, Integer num2, String str2, WebViewCallback webViewCallback) {
        if (C121751.f30905xf0b64357[BannerViewType.fromString(str).ordinal()] == 1 && BannerViewCache.getInstance().loadWebPlayer(str2, new UnityBannerSize(num.intValue(), num2.intValue()))) {
