...
public class DeviceLog {
    ...
    public static /* synthetic */ class C122041 {

        /* renamed from: $SwitchMap$com$unity3d$services$core$log$DeviceLog$UnityAdsLogLevel */
        public static final /* synthetic */ int[] f30910xf32d8d1;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f30910xf32d8d1     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f30910xf32d8d1     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f30910xf32d8d1     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.log.DeviceLog.C122041.<clinit>():void");
        }
    }
    ...
    private static DeviceLogEntry createLogEntry(UnityAdsLogLevel unityAdsLogLevel, String str) {
        ...
        while (i < stackTrace.length) {
            ...
            if (!stackTraceElement2.getClassName().equals(cls.getName()) && z) {
                break;
            }
            i++;
        }
    ...
    public static void exception(String str, Exception exc) {
        String str2 = "";
        if (str != null) {
            str2 = C25541a.m63881k(str2, str);
        }
        if (exc != null) {
            StringBuilder t = C0016g.m36t(str2, ": ");
            t.append(exc.getMessage());
            str2 = t.toString();
        }
        if (!(exc == null || exc.getCause() == null)) {
            StringBuilder t2 = C0016g.m36t(str2, ": ");
    ...
    private static void write(UnityAdsLogLevel unityAdsLogLevel, String str) {
        boolean z;
        int i = C122041.f30910xf32d8d1[unityAdsLogLevel.ordinal()];
        boolean z2 = true;
        if (i == 1) {
            z = LOG_INFO;
        } else if (i == 2) {
