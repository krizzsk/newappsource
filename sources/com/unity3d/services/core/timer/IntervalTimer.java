...
public class IntervalTimer implements IIntervalTimer, IAppActiveListener {
    ...
    public static /* synthetic */ class C122122 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.timer.IntervalTimer.C122122.<clinit>():void");
        }
    }
    ...
    private void schedule() {
        try {
            ...
            StringBuilder k = C13555b.m33972k("ERROR: IntervalTimer failed to start due to exception ");
    ...
    public void onAppStateChanged(LifecycleEvent lifecycleEvent) {
        int i = C122122.$SwitchMap$com$unity3d$services$core$lifecycle$LifecycleEvent[lifecycleEvent.ordinal()];
        if (i == 1) {
