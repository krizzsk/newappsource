...
public class DeviceInfoReader implements IDeviceInfoReader {
    public Map<String, Object> getDeviceInfoData() {
        ...
        hashMap.put(ServerParameters.DEVICE_CURRENT_BATTERY_LEVEL, Float.valueOf(Device.getBatteryLevel()));
        hashMap.put("networkMetered", Boolean.valueOf(Device.getNetworkMetered()));
        hashMap.put(ServerParameters.TIMESTAMP_KEY, Long.valueOf(System.currentTimeMillis()));
        hashMap.put(UnityMediationAdapter.KEY_GAME_ID, ClientProperties.getGameId());
        hashMap.put("test", Boolean.valueOf(SdkProperties.isTestMode()));
        hashMap.put("callType", FirebaseMessagingService.EXTRA_TOKEN);
        return hashMap;
    }
}
