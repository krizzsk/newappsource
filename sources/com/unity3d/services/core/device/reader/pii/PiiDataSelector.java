...
public class PiiDataSelector {
    ...
    public static /* synthetic */ class C122032 {

        /* renamed from: $SwitchMap$com$unity3d$services$core$device$reader$pii$PiiPrivacyMode */
        public static final /* synthetic */ int[] f30909x6ad1d1a2;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f30909x6ad1d1a2     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f30909x6ad1d1a2     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.device.reader.pii.PiiDataSelector.C122032.<clinit>():void");
        }
    }
    ...
    private Map<String, Object> getPiiContentFromStorage() {
        ...
        if (obj instanceof JSONObject) {
            return Utilities.combineJsonIntoMap(hashMap, (JSONObject) obj, "unifiedconfig.pii.");
        }
        return hashMap;
    }
    ...
    public PiiDecisionData whatToDoWithPII() {
        int i = C122032.f30909x6ad1d1a2[this._piiTrackingStatusReader.getPrivacyMode().ordinal()];
        if (i == 1 || i == 2) {
            return allowTrackingDecision();
        }
        if (i != 3) {
