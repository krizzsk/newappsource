...
public class DeviceInfoReaderWithPII implements IDeviceInfoReader {
    ...
    public static /* synthetic */ class C122011 {

        /* renamed from: $SwitchMap$com$unity3d$services$core$device$reader$pii$DataSelectorResult */
        public static final /* synthetic */ int[] f30908x6a9b5bad;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f30908x6a9b5bad     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f30908x6a9b5bad     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.device.reader.DeviceInfoReaderWithPII.C122011.<clinit>():void");
        }
    }
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        int i = C122011.f30908x6a9b5bad[whatToDoWithPII.getResultType().ordinal()];
        if (i == 1) {
