...
public class DeviceInfoReaderWithStorageInfo implements IDeviceInfoReader {
    private static final List<String> _blackListOfKeys = Arrays.asList(new String[]{ServerParameters.TIMESTAMP_KEY, "exclude", "pii", "nonBehavioral", "nonbehavioral"});
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        if (deviceInfoData != null) {
            return Utilities.combineJsonIntoMap(deviceInfoData, new JsonFlattener(new JsonStorageAggregator(this._storageReaders).getData()).flattenJson(".", _includedKeys, Collections.singletonList("value"), _blackListOfKeys));
        }
