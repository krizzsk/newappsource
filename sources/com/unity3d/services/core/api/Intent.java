...
public class Intent {
    ...
    private static android.content.Intent intentFromMetadata(JSONObject jSONObject) throws IntentException {
        ...
        String str3 = (String) jSONObject.opt(Events.PROPERTY_ACTION);
        ...
        JSONArray jSONArray2 = (JSONArray) jSONObject.opt(InAppMessageBase.EXTRAS);
    ...
    private static boolean setExtras(android.content.Intent intent, JSONArray jSONArray) {
        ...
        while (i < jSONArray.length()) {
            try {
                ...
                if (!setExtra(intent, jSONObject.getString(LinksConfiguration.KEY_KEY), jSONObject.get("value"))) {
                    return false;
                }
                i++;
            } catch (Exception e) {
