...
public class DeviceInfo {
    ...
    public static /* synthetic */ class C121812 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.api.DeviceInfo.C121812.<clinit>():void");
        }
    }
    ...
    private static File getFileForStorageType(StorageType storageType) {
        int i = C121812.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i == 1) {
    ...
    public static void registerVolumeChangeListener(Integer num, WebViewCallback webViewCallback) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            C121801 r0 = new IVolumeChangeListener(num) {
