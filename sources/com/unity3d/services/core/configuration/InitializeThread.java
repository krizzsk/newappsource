...
public class InitializeThread extends Thread {
    ...
    public static class InitializeStateCleanCache extends InitializeState {
        ...
        public InitializeState execute() {
            try {
                ...
                StringBuilder k = C13555b.m33972k("Failure trying to clean cache: ");
    ...
    public static class InitializeStateConfig extends InitializeState {
        ...
        public InitializeState execute() {
            StringBuilder k = C13555b.m33972k("Unity Ads init: load configuration from ");
            k.append(SdkProperties.getConfigUrl());
            DeviceLog.info(k.toString());
    ...
    public static class InitializeStateCreate extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                DeviceLog.error(str);
                return new InitializeStateError(InitializeStateCreateStateName, new Exception(str), this._configuration);
    ...
    public static class InitializeStateDownloadWebView extends InitializeState {
        ...
        public InitializeState execute() {
            StringBuilder k = C13555b.m33972k("Unity Ads init: downloading webapp from ");
            k.append(this._configuration.getWebViewUrl());
            DeviceLog.info(k.toString());
            try {
                try {
                    ...
                    long retryScalingFactor = (long) (this._configuration.getRetryScalingFactor() * ((double) this._retryDelay));
    ...
    public static class InitializeStateError extends InitializeState {
        ...
        public InitializeState execute() {
            StringBuilder k = C13555b.m33972k("Unity Ads init: halting init in ");
            k.append(this._state);
            k.append(": ");
            k.append(this._exception.getMessage());
            DeviceLog.error(k.toString());
            for (String moduleConfiguration : this._configuration.getModuleConfigurationList()) {
                IModuleConfiguration moduleConfiguration2 = this._configuration.getModuleConfiguration(moduleConfiguration);
                if (moduleConfiguration2 != null) {
    ...
    public static class InitializeStateLoadCache extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                StringBuilder k = C13555b.m33972k("Unity Ads init: webapp not found in local cache: ");
    ...
    public static class InitializeStateLoadWeb extends InitializeState {
        ...
        public InitializeState execute() {
            StringBuilder k = C13555b.m33972k("Unity Ads init: loading webapp from ");
            k.append(this._configuration.getWebViewUrl());
            DeviceLog.info(k.toString());
            try {
                try {
    ...
    public static class InitializeStateRetry extends InitializeState {
        ...
        public InitializeState execute() {
            StringBuilder k = C13555b.m33972k("Unity Ads init: retrying in ");
            k.append(this._delay);
