...
public class EventSubject<T> {
    ...
    public EventSubject(String str, Queue<T> queue, Integer num, IIntervalTimerFactory iIntervalTimerFactory) {
        this._eventQueue = queue;
        this._intervalTimer = iIntervalTimerFactory.createTimer(str, num, Integer.valueOf(queue.size()), new IIntervalTimerListener() {
