...
public class AsyncTokenStorage {
    ...
    public static /* synthetic */ class C121483 {
        public static final /* synthetic */ int[] $SwitchMap$com$unity3d$services$core$device$TokenType;
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.ads.token.AsyncTokenStorage.C121483.<clinit>():void");
        }
    }
    ...
    private void sendTokenMetrics(String str, TokenType tokenType) {
        int i = C121483.$SwitchMap$com$unity3d$services$core$device$TokenType[tokenType.ordinal()];
        if (i == 1) {
