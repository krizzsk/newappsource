...
public class RegionMetadataParser {
    ...
    private static void addRegionEndpoint(Region region, Element element, boolean z) {
        ...
        if (!z || verifyLegacyEndpoint(childElementValue2)) {
            ...
            region.getHttpSupport().put(childElementValue, Boolean.valueOf(InneractiveMediationDefs.SHOW_HOUSE_AD_YES.equals(childElementValue3)));
            region.getHttpsSupport().put(childElementValue, Boolean.valueOf(InneractiveMediationDefs.SHOW_HOUSE_AD_YES.equals(childElementValue4)));
            return;
        }
        throw new IllegalStateException(C13437d.m33706k("Invalid service endpoint (", childElementValue2, ") is detected."));
    }
