...
public class StartStreamEncryptionRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (startStreamEncryptionRequest.getKeyId() == null || startStreamEncryptionRequest.getKeyId().equals(getKeyId())) {
            return true;
        }
        return false;
    }
    ...
    public StartStreamEncryptionRequest withEncryptionType(EncryptionType encryptionType2) {
        this.encryptionType = encryptionType2.toString();
        return this;
    }
}
