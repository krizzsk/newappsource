...
public class DisableEnhancedMonitoringResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (disableEnhancedMonitoringResult.getStreamName() == null) {
            z = true;
        } else {
            z = false;
        }
        ...
        if (disableEnhancedMonitoringResult.getCurrentShardLevelMetrics() == null) {
            z3 = true;
        } else {
            z3 = false;
        }
        ...
        if (disableEnhancedMonitoringResult.getDesiredShardLevelMetrics() == null) {
            z5 = true;
        } else {
            z5 = false;
        }
        ...
        if (disableEnhancedMonitoringResult.getDesiredShardLevelMetrics() == null || disableEnhancedMonitoringResult.getDesiredShardLevelMetrics().equals(getDesiredShardLevelMetrics())) {
            return true;
        }
        return false;
    }
