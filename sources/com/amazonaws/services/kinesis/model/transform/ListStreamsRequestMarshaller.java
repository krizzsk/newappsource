...
public class ListStreamsRequestMarshaller implements Marshaller<Request<ListStreamsRequest>, ListStreamsRequest> {
    public Request<ListStreamsRequest> marshall(ListStreamsRequest listStreamsRequest) {
        if (listStreamsRequest != null) {
            DefaultRequest defaultRequest = new DefaultRequest(listStreamsRequest, "AmazonKinesis");
            defaultRequest.addHeader("X-Amz-Target", "Kinesis_20131202.ListStreams");
            ...
            try {
                ...
                if (listStreamsRequest.getLimit() != null) {
                    Integer limit = listStreamsRequest.getLimit();
                    jsonWriter.name("Limit");
                    jsonWriter.value((Number) limit);
                }
                if (listStreamsRequest.getExclusiveStartStreamName() != null) {
                    String exclusiveStartStreamName = listStreamsRequest.getExclusiveStartStreamName();
                    jsonWriter.name("ExclusiveStartStreamName");
                    jsonWriter.value(exclusiveStartStreamName);
                }
