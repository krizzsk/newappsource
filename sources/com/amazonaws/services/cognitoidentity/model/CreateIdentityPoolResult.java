...
public class CreateIdentityPoolResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (createIdentityPoolResult.getIdentityPoolId() == null) {
            z = true;
        } else {
            z = false;
        }
        ...
        if (createIdentityPoolResult.getIdentityPoolName() == null) {
            z3 = true;
        } else {
            z3 = false;
        }
        ...
        if (createIdentityPoolResult.getAllowUnauthenticatedIdentities() == null) {
            z5 = true;
        } else {
            z5 = false;
        }
        ...
        if (createIdentityPoolResult.getAllowClassicFlow() == null) {
            z7 = true;
        } else {
            z7 = false;
        }
        ...
        if (createIdentityPoolResult.getSupportedLoginProviders() == null) {
            z9 = true;
        } else {
            z9 = false;
        }
        ...
        if (createIdentityPoolResult.getDeveloperProviderName() == null) {
            z12 = true;
        } else {
            z12 = false;
        }
        ...
        if (createIdentityPoolResult.getOpenIdConnectProviderARNs() == null) {
            z14 = true;
        } else {
            z14 = false;
        }
        ...
        if (createIdentityPoolResult.getCognitoIdentityProviders() == null) {
            z16 = true;
        } else {
            z16 = false;
        }
        ...
        if (createIdentityPoolResult.getSamlProviderARNs() == null) {
            z18 = true;
        } else {
            z18 = false;
        }
        ...
        if (createIdentityPoolResult.getIdentityPoolTags() == null) {
            z21 = true;
        } else {
            z21 = false;
        }
