...
public class RoleMapping implements Serializable {
    ...
    public int hashCode() {
        ...
        if (getAmbiguousRoleResolution() == null) {
            ...
            i2 = getAmbiguousRoleResolution().hashCode();
        }
        int i5 = (i4 + i2) * 31;
        if (getRulesConfiguration() != null) {
            i3 = getRulesConfiguration().hashCode();
        }
        return i5 + i3;
    }
    ...
    public String toString() {
        ...
        if (getType() != null) {
            StringBuilder k2 = C13555b.m33972k("Type: ");
            k2.append(getType());
            k2.append(AppboyConfigurationProvider.LOCALE_TO_API_KEY_MAPPING_SEPARATOR);
            k.append(k2.toString());
        }
        if (getAmbiguousRoleResolution() != null) {
            StringBuilder k3 = C13555b.m33972k("AmbiguousRoleResolution: ");
            k3.append(getAmbiguousRoleResolution());
            k3.append(AppboyConfigurationProvider.LOCALE_TO_API_KEY_MAPPING_SEPARATOR);
            k.append(k3.toString());
        }
        if (getRulesConfiguration() != null) {
            StringBuilder k4 = C13555b.m33972k("RulesConfiguration: ");
            k4.append(getRulesConfiguration());
