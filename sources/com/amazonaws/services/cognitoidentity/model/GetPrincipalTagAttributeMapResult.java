...
public class GetPrincipalTagAttributeMapResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getPrincipalTagAttributeMapResult.getIdentityPoolId() == null) {
            z = true;
        } else {
            z = false;
        }
        ...
        if (getPrincipalTagAttributeMapResult.getIdentityProviderName() == null) {
            z3 = true;
        } else {
            z3 = false;
        }
        ...
        if (getPrincipalTagAttributeMapResult.getUseDefaults() == null) {
            z5 = true;
        } else {
            z5 = false;
        }
        ...
        if (getPrincipalTagAttributeMapResult.getPrincipalTags() == null) {
            z7 = true;
        } else {
            z7 = false;
        }
        ...
        if (getPrincipalTagAttributeMapResult.getPrincipalTags() == null || getPrincipalTagAttributeMapResult.getPrincipalTags().equals(getPrincipalTags())) {
            return true;
        }
        return false;
    }
