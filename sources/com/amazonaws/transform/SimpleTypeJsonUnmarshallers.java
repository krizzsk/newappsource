...
public class SimpleTypeJsonUnmarshallers {
    ...
    public static /* synthetic */ class C19311 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazonaws.transform.SimpleTypeJsonUnmarshallers.C19311.<clinit>():void");
        }
    }
    ...
    public static class DateJsonUnmarshaller implements Unmarshaller<Date, JsonUnmarshallerContext> {
        ...
        public Date unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
            ...
            try {
                int i = C19311.$SwitchMap$com$amazonaws$transform$TimestampFormat[this.format.ordinal()];
                if (i == 1) {
                ...
                StringBuilder l = C13555b.m33973l("Unable to parse date '", nextString, "':  ");
                l.append(e.getMessage());
                throw new AmazonClientException(l.toString(), e);
            }
        }
