...
abstract class AbstractBase32Codec implements Codec {
    ...
    private final void decode1to4bytes(int i, byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        int pos5 = pos(bArr[i12 + 1]);
        bArr2[i11] = (byte) (((pos4 & 1) << 7) | (pos(bArr[i12]) << 2) | ((pos5 >>> 3) & 3));
    ...
    private final void decode5bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i12 = i11 + 1;
        int pos5 = ((pos4 & 1) << 7) | (pos(bArr[i11]) << 2);
        int i13 = i12 + 1;
        int pos6 = pos(bArr[i12]);
        bArr2[i9] = (byte) (pos5 | ((pos6 >>> 3) & 3));
        bArr2[i9 + 1] = (byte) (pos(bArr[i13]) | ((pos6 & 7) << 5));
    }
    ...
    private final void encode5bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        bArr2[i11] = bArr3[(b4 >>> 2) & 31];
        byte b5 = bArr[i12];
        bArr2[i13] = bArr3[((b4 & 3) << 3) | ((b5 >>> 5) & 7)];
        bArr2[i13 + 1] = bArr3[b5 & 31];
    }
    ...
    public final byte[] decode(byte[] bArr, int i) {
        ...
        if (i % 8 == 0) {
            ...
            if (i4 == 0) {
                ...
                throw new IllegalArgumentException(C16759e.m42349e("Invalid number of paddings ", i4));
            }
            int i5 = ((i / 8) * 5) - (5 - i2);
        ...
        throw new IllegalArgumentException(C16759e.m42349e("Input is expected to be encoded in multiple of 8 bytes but found: ", i));
    }
