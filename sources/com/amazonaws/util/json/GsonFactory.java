...
final class GsonFactory implements AwsJsonFactory {
    ...
    public static /* synthetic */ class C19371 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazonaws.util.json.GsonFactory.C19371.<clinit>():void");
        }
    }
    ...
    public static final class GsonWriter implements AwsJsonWriter {
        ...
        public AwsJsonWriter value(Date date) throws IOException {
            this.writer.value((Number) BigDecimal.valueOf(date.getTime()).scaleByPowerOfTen(NEGATIVE_THREE));
            return this;
        }
    ...
    public static AwsJsonToken convert(JsonToken jsonToken) {
        ...
        switch (C19371.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()]) {
            case 1:
