...
public class KeyProvider18 implements KeyProvider {
    ...
    public static final String AWS_KEY_VALUE_STORE_VERSION_1_KEY_STORE_ALIAS_FOR_RSA_SUFFIX = ".rsaKeyStoreAlias";
    public static final int CIPHER_AES_GCM_NOPADDING_KEY_LENGTH_IN_BITS = 256;
    public static final String CIPHER_PROVIDER_NAME_FOR_RSA = "AndroidOpenSSL";
    public static final String CIPHER_RSA_MODE = "RSA/ECB/PKCS1Padding";
    public static final String ENCRYPTED_AES_KEY = "AesGcmNoPadding18-encrypted-encryption-key";
    ...
    public KeyProvider18(Context context2, SharedPreferences sharedPreferences2) {
    ...
    private byte[] rsaEncrypt(String str, byte[] bArr) {
        try {
            ...
            Log log = logger;
            StringBuilder k = C13555b.m33972k("Exception occurred while encrypting data. ");
    ...
    public synchronized Key generateKey(String str) throws KeyNotGeneratedException {
        ...
        try {
            ...
            KeyGenerator instance4 = KeyGenerator.getInstance(KEY_ALGORITHM_AES);
