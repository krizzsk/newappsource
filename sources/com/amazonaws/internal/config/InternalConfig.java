...
public class InternalConfig {
    ...
    private static Map<String, SignerConfig> getDefaultServiceSigners() {
        ...
        hashMap.put(ServiceAbbreviations.f6722S3, new SignerConfig("AWSS3V4SignerType"));
    ...
    public void dump() {
        StringBuilder k = C13555b.m33972k("defaultSignerConfig: ");
        k.append(this.defaultSignerConfig);
        k.append("\n");
        k.append("serviceRegionSigners: ");
        k.append(this.serviceRegionSigners);
        k.append("\n");
        k.append("regionSigners: ");
        k.append(this.regionSigners);
        k.append("\n");
        k.append("serviceSigners: ");
        k.append(this.serviceSigners);
        k.append("\n");
        k.append("hostRegexToRegionMappings: ");
        k.append(this.hostRegexToRegionMappings);
    ...
    public SignerConfig getSignerConfig(String str, String str2) {
        if (str != null) {
            if (str2 != null) {
                SignerConfig signerConfig = this.serviceRegionSigners.get(C13437d.m33706k(str, SERVICE_REGION_DELIMITOR, str2));
