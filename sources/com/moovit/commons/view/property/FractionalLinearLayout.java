...
public class FractionalLinearLayout extends LinearLayout implements C15828a {

    /* renamed from: b */
    public C15828a.C15829a f41310b;
    ...
    public void setFractionX(float f) {
        if (getWidth() == 0) {
            if (this.f41310b == null) {
                this.f41310b = new C15828a.C15829a(this, this);
            }
            this.f41310b.f41314d = f;
            return;
        }
        this.f41310b = null;
    ...
    public FractionalLinearLayout(Context context, AttributeSet attributeSet, int i) {
