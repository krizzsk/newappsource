...
public class WorkFavoriteItemFragment extends C14940f {
    /* renamed from: k */
    ...
    public final Intent mo45113m2(LocationDescriptor locationDescriptor) {
        ...
        Intent intent = new Intent(a, FavoriteLocationEditorActivity.class);
        FavoriteLocationEditorActivity.m37667z2(intent, FavoriteLocationEditorActivity.FavoriteType.WORK, FavoriteLocationEditorActivity.ActionType.ADD, locationDescriptor);
        return intent;
    }
    ...
    public final void mo45120u2(LocationFavorite locationFavorite) {
        ...
        aVar.mo49939g(AnalyticsAttributeKey.TYPE, "edit_work_clicked");
        ...
        if (locationFavorite == null) {
            mo45150w2(R.string.favorite_work_label);
        } else {
            startActivityForResult(FavoriteLocationEditorActivity.m37665D2(this.f40822c), 1002);
        }
    }
    ...
    public final void mo45121v2(C16753e eVar) {
        C17474b.C17475a aVar = new C17474b.C17475a(AnalyticsEventKey.BUTTON_CLICK);
        aVar.mo49939g(AnalyticsAttributeKey.TYPE, "remove_work_clicked");
        mo46797j2(aVar.mo49933a());
        eVar.mo49430A((LocationFavorite) null);
        mo45147D2(R.string.work_location_reset);
    }
}
