...
public final class StopSuggestionFragment$special$$inlined$viewModels$default$3 extends Lambda implements C24225a<C1034p0> {
    public final /* synthetic */ C21049c $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public StopSuggestionFragment$special$$inlined$viewModels$default$3(C21049c cVar) {
        super(0);
