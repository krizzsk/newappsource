...
final class TodShuttleUiUtils$getSubscriptionEnrollDescription$1 extends Lambda implements C24236l<DayOfWeek, CharSequence> {
    public final /* synthetic */ Locale $locale;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TodShuttleUiUtils$getSubscriptionEnrollDescription$1(Locale locale) {
        super(1);
        this.$locale = locale;
    }
