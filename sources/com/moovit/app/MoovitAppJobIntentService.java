...
public abstract class MoovitAppJobIntentService extends MoovitJobIntentService {
    public final Object getSystemService(String str) {
        ...
        switch (c) {
            case 0:
                return mo44578f("LATEST_ITINERARY_CONTROLLER");
            case 1:
                return ((UserAccountManager) mo44578f("USER_ACCOUNT")).mo46572c();
            case 2:
                return ((UserAccountManager) mo44578f("USER_ACCOUNT")).mo46573d();
            case 3:
                return mo44578f("USER_ACCOUNT");
            case 4:
                return mo44578f("ACCESSIBILITY_CONFIGURATION");
            case 5:
                return mo44578f("TAXI_PROVIDERS_MANAGER");
            case 6:
                return mo44578f("HISTORY");
            case 7:
                return ((UserAccountManager) mo44578f("USER_ACCOUNT")).mo46574e();
            case 8:
                return mo44578f("UI_CONFIGURATION");
            case 9:
                return AccessTokenManager.m39875b(this);
            case 10:
                return ((UserAccountManager) mo44578f("USER_ACCOUNT")).mo46575f();
            default:
