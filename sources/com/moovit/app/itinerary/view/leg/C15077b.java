...
/* renamed from: com.moovit.app.itinerary.view.leg.b */
public final class C15077b extends AbstractLegView<BicycleRentalLeg> implements MicroMobilityIntegrationView.C4150c {

    /* renamed from: C */
    public TextView f38713C;

    public C15077b(Context context) {
    ...
    public final ServerId mo45368A(Leg leg) {
        ...
        if (bicycleRentalLeg.mo48334e2().f23647b == LocationDescriptor.LocationType.STOP) {
            return bicycleRentalLeg.mo48334e2().f23649d;
        }
        return null;
    }
    ...
    public final List mo45383q(LinearLayout linearLayout, Leg leg, Leg leg2) {
        BicycleRentalLeg bicycleRentalLeg = (BicycleRentalLeg) leg;
        if (bicycleRentalLeg.f41955j == null) {
        ...
        microMobilityIntegrationView.setLayoutParams(C13532d.m33907b(getResources()));
        microMobilityIntegrationView.setIntegrationItem(bicycleRentalLeg.f41955j);
    ...
    public final List mo45384r(Leg leg, Leg leg2) {
        ...
        Context context = getContext();
        this.f38713C = (TextView) LayoutInflater.from(context).inflate(R.layout.bicycle_rental_leg_availability_view, this, false);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        int g = UiUtils.m40248g(context, 9.0f);
        layoutParams.setMargins(0, g, 0, g);
        this.f38713C.setLayoutParams(layoutParams);
        this.f38713C.setVisibility(8);
        arrayList.add(this.f38713C);
        return arrayList;
    }
    ...
    public final String mo45385s(Leg leg) {
        BicycleRentalLeg bicycleRentalLeg = (BicycleRentalLeg) leg;
        Context context = getContext();
        SpannableStringBuilder e = C7925b.f23935b.mo24605e(context, bicycleRentalLeg.f41947b.mo24631g(), bicycleRentalLeg.f41948c.mo24631g());
        return DistanceUtils.m17934a((int) DistanceUtils.m17936c(context, bicycleRentalLeg.f41953h.mo24339Z0()), context) + context.getString(R.string.string_list_delimiter_dot) + e;
    }

    public void setAvailableBicycleDocksAtDestination(int i) {
        if (i == -1) {
            this.f38713C.setVisibility(8);
            mo45377J();
            return;
        }
        String quantityString = getResources().getQuantityString(R.plurals.available_bicycle_docks, i, new Object[]{Integer.valueOf(i)});
        this.f38713C.setText(quantityString);
        this.f38713C.setContentDescription(quantityString);
        this.f38713C.setVisibility(0);
        mo45377J();
    }
    ...
    public final View mo45392t(Leg leg) {
        ...
        directionsView.mo24678a(C16783l.m42478j(getContext(), ((BicycleRentalLeg) leg).f41954i));
        return directionsView;
    }

    /* renamed from: u */
    public final AbstractLegView.FooterViewType mo45393u(Leg leg) {
        if (C13717b.m34258e(((BicycleRentalLeg) leg).f41954i)) {
    ...
    public final Image mo45395w(Leg leg) {
        ...
        if (bicycleRentalLeg.mo48344b() == null) {
            return bicycleRentalLeg.mo48334e2().f23655j;
        }
        Context context = getContext();
        bicycleRentalLeg.mo48344b().get().getClass();
        return BicycleStop.m17760c(context);
    }
    ...
    public final List mo45397y(Leg leg) {
        return ((BicycleRentalLeg) leg).mo48334e2().f23652g;
    }

    /* renamed from: z */
    public final CharSequence mo45398z(Leg leg) {
        return ((BicycleRentalLeg) leg).mo48334e2().f23651f;
    }
}
