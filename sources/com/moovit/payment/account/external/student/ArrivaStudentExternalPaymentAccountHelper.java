...
public class ArrivaStudentExternalPaymentAccountHelper implements ExternalPaymentAccountHelper {
    public static final Parcelable.Creator<ArrivaStudentExternalPaymentAccountHelper> CREATOR = new C25666a();

    /* renamed from: com.moovit.payment.account.external.student.ArrivaStudentExternalPaymentAccountHelper$a */
    public class C25666a implements Parcelable.Creator<ArrivaStudentExternalPaymentAccountHelper> {
        public final Object createFromParcel(Parcel parcel) {
            return new ArrivaStudentExternalPaymentAccountHelper();
        }

        public final Object[] newArray(int i) {
            return new ArrivaStudentExternalPaymentAccountHelper[i];
        }
    }

    /* renamed from: com.moovit.payment.account.external.student.ArrivaStudentExternalPaymentAccountHelper$b */
    public static /* synthetic */ class C25667b {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f64005a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f64005a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f64005a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.moovit.payment.account.external.student.ArrivaStudentExternalPaymentAccountHelper.C25667b.<clinit>():void");
        }
    }
    ...
    public final int getIconResId() {
        return C25749d.ic_student_24_on_surface_emphasis_high;
    }

    public final int getNameResId() {
        return C25754i.payment_my_account_student_title;
    }
    ...
    public final ExternalPaymentAccountHelper.C25647a mo44695u1(Context context, PaymentAccountContextStatus paymentAccountContextStatus) {
        int i;
        int i2 = C25667b.f64005a[paymentAccountContextStatus.ordinal()];
        Intent intent = null;
        if (i2 == 1) {
            ...
            intent = PaymentRegistrationActivity.m41717A2(context, PaymentRegistrationType.PURCHASE, "Arriva@Student Account");
            i = i3;
        } else {
            i = 0;
        }
