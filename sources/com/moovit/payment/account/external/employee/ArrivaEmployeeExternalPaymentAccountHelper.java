...
public class ArrivaEmployeeExternalPaymentAccountHelper implements ExternalPaymentAccountHelper {
    public static final Parcelable.Creator<ArrivaEmployeeExternalPaymentAccountHelper> CREATOR = new C25657a();

    /* renamed from: com.moovit.payment.account.external.employee.ArrivaEmployeeExternalPaymentAccountHelper$a */
    public class C25657a implements Parcelable.Creator<ArrivaEmployeeExternalPaymentAccountHelper> {
        public final Object createFromParcel(Parcel parcel) {
            return new ArrivaEmployeeExternalPaymentAccountHelper();
        }

        public final Object[] newArray(int i) {
            return new ArrivaEmployeeExternalPaymentAccountHelper[i];
        }
    }

    /* renamed from: com.moovit.payment.account.external.employee.ArrivaEmployeeExternalPaymentAccountHelper$b */
    public static /* synthetic */ class C25658b {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f63997a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f63997a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f63997a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.moovit.payment.account.external.employee.ArrivaEmployeeExternalPaymentAccountHelper.C25658b.<clinit>():void");
        }
    }
    ...
    public final int getIconResId() {
        return C25749d.ic_work_24_on_surface_emphasis_high;
    }

    public final int getNameResId() {
        return C25754i.payment_my_account_business_title;
    }
    ...
    public final ExternalPaymentAccountHelper.C25647a mo44695u1(Context context, PaymentAccountContextStatus paymentAccountContextStatus) {
        int i;
        int i2 = C25658b.f63997a[paymentAccountContextStatus.ordinal()];
        Intent intent = null;
        if (i2 == 1) {
            int i3 = C25754i.payment_my_account_services_connected;
            int i4 = EmployeeAccountActivity.f63998U;
            Intent intent2 = new Intent(context, EmployeeAccountActivity.class);
            i = i3;
            intent = intent2;
        } else if (i2 == 2) {
            i = C25754i.payment_my_account_services_blacklist_not_tappable;
        } else if (i2 == 3 || i2 == 4) {
            int i5 = C25754i.payment_my_account_services_join;
            intent = PaymentRegistrationActivity.m41717A2(context, PaymentRegistrationType.PURCHASE, "Arriva@Connect Verified Account");
            i = i5;
        } else {
            i = 0;
        }
