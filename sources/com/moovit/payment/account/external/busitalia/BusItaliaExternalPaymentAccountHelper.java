package com.moovit.payment.account.external.busitalia;
...
public class BusItaliaExternalPaymentAccountHelper implements ExternalPaymentAccountHelper {
    public static final Parcelable.Creator<BusItaliaExternalPaymentAccountHelper> CREATOR = new C25655a();

    /* renamed from: com.moovit.payment.account.external.busitalia.BusItaliaExternalPaymentAccountHelper$a */
    public class C25655a implements Parcelable.Creator<BusItaliaExternalPaymentAccountHelper> {
        public final Object createFromParcel(Parcel parcel) {
            return new BusItaliaExternalPaymentAccountHelper();
        }

        public final Object[] newArray(int i) {
            return new BusItaliaExternalPaymentAccountHelper[i];
        }
    }

    /* renamed from: com.moovit.payment.account.external.busitalia.BusItaliaExternalPaymentAccountHelper$b */
    public static /* synthetic */ class C25656b {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f63996a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f63996a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f63996a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.moovit.payment.account.external.busitalia.BusItaliaExternalPaymentAccountHelper.C25656b.<clinit>():void");
        }
    }
    ...
    public final int getIconResId() {
        return C25749d.img_logo_bus_italia_24;
    }
    ...
    public final ExternalPaymentAccountHelper.C25647a mo44695u1(Context context, PaymentAccountContextStatus paymentAccountContextStatus) {
        int i;
        int i2 = C25656b.f63996a[paymentAccountContextStatus.ordinal()];
        Intent intent = null;
        if (i2 == 1) {
            ...
            intent = PaymentRegistrationActivity.m41717A2(context, PaymentRegistrationType.PURCHASE, "BusItalia");
            i = i3;
        } else {
            i = 0;
        }
