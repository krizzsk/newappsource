...
public enum MVAnalyticsEventKey {
    END_SERVER_SIDE(1),
    ...
    METRO_SELECTED(297),
    SURVEY_NOTIFICATION_RECEIVED(298),
    SURVEY_SHOWN(299),
    SET_TIME_CLICKED(Strategy.TTL_SECONDS_DEFAULT),
    EXPLAIN_TIME_CLICKED(301),
    GOT_IT_CLICKED(302),
    LINE_SELECTED(303),
    DISSMIS_CLICKED(304),
    EXPERIMENT_DATA(305),
    LAYOUT_CHANGED(306),
    SERVICE_ALERT_STATUS_SHOWN(307),
    LINE_STATUS_CLICKED(308),
    LOCATION_SEARCH_CLICKED(309),
    REVERSE_GEOCODER(310),
    FORWARD_GEOCODER(311),
    CONTENT_SHOWN(312),
    CAMPAIGN_CLICKED(313),
    TWITTER_SHOWN(314),
    CLOCK(315),
    STATE_RESTORATION(316),
    AUTO_CHOOSE_GTFS_LANGUAGE(317),
    INSTALL_CONVERSION_LOADED(318),
    EVENTS_BREAKDOWN(319),
    ZOOM_DONE(320),
    RT_LOCATION_REFRESH(321),
    STEP_SIGN_IN(322),
    STEP_SIGN_UP(323),
    STEP_WELCOME(324),
    STEP_PERSONAL_DETAILS(325),
    STEP_COMPLETED(326),
    STEPS_COMPLETED(327),
    STEP_SETTINGS(328),
    STEP_EMAIL(329),
    ON_FOCUS(330),
    TICKET_PURCHASE_RESULT(331),
    NO_CAMERA_ACCESS(332),
    CLOSE_AR_SCREEN(333),
    PHONE_CODE_VERIFIED(334),
    PHOTO_TAKEN(335),
    TASK_COMPLETED(336),
    SCREEN_LOADED(337),
    PULL_TO_REFRESH(338),
    BOTTOM_SHEET_STATE_CHANGED(339),
    WALLET_CONTENT(340),
    SET_PANGO_CARD_RESULT(341),
    PAY_WITH_BIT_DEEPLINK_RESULT(342),
    SET_CREDIT_CARD_RESULT(343),
    WEB_AUTH_VERIFIED(344),
    TOUCHPASS_MIGRATION(345),
    MOT_TRIP_ALGORITHM(346),
    QR_READ(347),
    LICENSE_SET(348),
    REPORT_CLICK(349),
    AD(350),
    ...
    IAM_CLOSED(352),
    IAM_DISMISSED(353),
    IAM_MESSAGE_CLICK(354),
    IAM_BUTTON_CLICK(355),
    STATUS_CHANGED(356),
    MICRO_MOBILITY_PURCHASE_RESULT(357),
    MICRO_MOBILITY_ACTION_RESULT(358),
    OFF_ROUTE_DETECTED(359),
    EMAIL_AUTH_VERIFIED(360),
    WEB_RESULT(361),
    WEB_LOGIN(362),
    STEP_SKIPPED(363),
    RESPONSE(364),
    SUBSCRIPTION_RESULT(365),
    SUBSCRIPTION_RESTORE_RESULT(366),
    SUBSCRIPTIONS_OFFERS(367),
    TRANSIT_TYPE_CLICKED_ON(368),
    TRANSIT_TYPE_CLICKED_OFF(369),
    MICRO_MOBILITY_TYPE_CLICKED_ON(370),
    MICRO_MOBILITY_TYPE_CLICKED_OFF(371),
    NOTIFY_DRIVER_CLICK(372),
    NOTIFY_DRIVER_SUCCESS(373),
    NOTIFY_DRIVER_FAILED(374),
    FAVORITES_WIDGET_UPDATE(375),
    SEARCH_ROUTE_REQUEST(376),
    DATA_LOADED(377),
    DEFERRED_DEEP_LINK_LOADED(378),
    ITINERARY_LOAD_FAILED(379),
    SCREEN_SHOT(388),
    DEEP_LINK_LOADED(389),
    OPEN_ACTIVITY(390),
    DEEP_LINK_INSTALL_IMPRESSION(391),
    IOS_APPLICATION_STATE(392);
    
    private final int value;

    private MVAnalyticsEventKey(int i) {
        this.value = i;
    }

    public static MVAnalyticsEventKey findByValue(int i) {
        switch (i) {
            case 1:
                                ...
                                switch (i) {
                                    ...
                                    default:
                                        switch (i) {
                                            ...
                                            case 297:
                                                return METRO_SELECTED;
                                            case 298:
                                                return SURVEY_NOTIFICATION_RECEIVED;
                                            case 299:
                                                return SURVEY_SHOWN;
                                            case Strategy.TTL_SECONDS_DEFAULT:
                                                return SET_TIME_CLICKED;
                                            case 301:
                                                return EXPLAIN_TIME_CLICKED;
                                            case 302:
                                                return GOT_IT_CLICKED;
                                            case 303:
                                                return LINE_SELECTED;
                                            case 304:
                                                return DISSMIS_CLICKED;
                                            case 305:
                                                return EXPERIMENT_DATA;
                                            case 306:
                                                return LAYOUT_CHANGED;
                                            case 307:
                                                return SERVICE_ALERT_STATUS_SHOWN;
                                            case 308:
                                                return LINE_STATUS_CLICKED;
                                            case 309:
                                                return LOCATION_SEARCH_CLICKED;
                                            case 310:
                                                return REVERSE_GEOCODER;
                                            case 311:
                                                return FORWARD_GEOCODER;
                                            case 312:
                                            ...
                                            case 317:
                                                return AUTO_CHOOSE_GTFS_LANGUAGE;
                                            case 318:
                                                return INSTALL_CONVERSION_LOADED;
                                            case 319:
                                                return EVENTS_BREAKDOWN;
                                            case 320:
                                                return ZOOM_DONE;
                                            case 321:
                                                return RT_LOCATION_REFRESH;
                                            case 322:
                                                return STEP_SIGN_IN;
                                            case 323:
                                                return STEP_SIGN_UP;
                                            ...
                                            case 330:
                                                return ON_FOCUS;
                                            case 331:
                                                return TICKET_PURCHASE_RESULT;
                                            case 332:
                                                return NO_CAMERA_ACCESS;
                                            case 333:
                                                return CLOSE_AR_SCREEN;
                                            case 334:
                                                return PHONE_CODE_VERIFIED;
                                            case 335:
                                                return PHOTO_TAKEN;
                                            case 336:
                                            ...
                                            case 339:
                                                return BOTTOM_SHEET_STATE_CHANGED;
                                            case 340:
                                                return WALLET_CONTENT;
                                            case 341:
                                                return SET_PANGO_CARD_RESULT;
                                            case 342:
                                                return PAY_WITH_BIT_DEEPLINK_RESULT;
                                            case 343:
                                                return SET_CREDIT_CARD_RESULT;
                                            case 344:
                                                return WEB_AUTH_VERIFIED;
                                            case 345:
                                                return TOUCHPASS_MIGRATION;
                                            case 346:
                                                return MOT_TRIP_ALGORITHM;
                                            case 347:
                                                return QR_READ;
                                            case 348:
                                                return LICENSE_SET;
                                            ...
                                            case 354:
                                                return IAM_MESSAGE_CLICK;
                                            case 355:
                                                return IAM_BUTTON_CLICK;
                                            case 356:
                                                return STATUS_CHANGED;
                                            case 357:
                                                return MICRO_MOBILITY_PURCHASE_RESULT;
                                            case 358:
                                                return MICRO_MOBILITY_ACTION_RESULT;
                                            case 359:
                                                return OFF_ROUTE_DETECTED;
                                            case 360:
                                                return EMAIL_AUTH_VERIFIED;
                                            case 361:
                                                return WEB_RESULT;
                                            case 362:
                                                return WEB_LOGIN;
                                            ...
                                            case 367:
                                                return SUBSCRIPTIONS_OFFERS;
                                            case 368:
                                                return TRANSIT_TYPE_CLICKED_ON;
                                            case 369:
                                                return TRANSIT_TYPE_CLICKED_OFF;
                                            case 370:
                                                return MICRO_MOBILITY_TYPE_CLICKED_ON;
                                            case 371:
                                                return MICRO_MOBILITY_TYPE_CLICKED_OFF;
                                            case 372:
                                                return NOTIFY_DRIVER_CLICK;
                                            case 373:
                                                return NOTIFY_DRIVER_SUCCESS;
                                            case 374:
                                                return NOTIFY_DRIVER_FAILED;
                                            case 375:
                                                return FAVORITES_WIDGET_UPDATE;
                                            case 376:
                                                return SEARCH_ROUTE_REQUEST;
                                            case 377:
                                                return DATA_LOADED;
                                            case 378:
                                                return DEFERRED_DEEP_LINK_LOADED;
                                            case 379:
                                                return ITINERARY_LOAD_FAILED;
                                            default:
                                                switch (i) {
                                                    case 388:
                                                        return SCREEN_SHOT;
                                                    case 389:
                                                        return DEEP_LINK_LOADED;
                                                    case 390:
                                                        return OPEN_ACTIVITY;
                                                    case 391:
                                                        return DEEP_LINK_INSTALL_IMPRESSION;
                                                    case 392:
                                                        return IOS_APPLICATION_STATE;
                                                    default:
                                                        return null;
                                                }
                                        }
