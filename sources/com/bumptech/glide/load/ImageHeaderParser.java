    ...
    public static /* synthetic */ class C2136a {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.ImageHeaderParser.C2136a.<clinit>():void");
        }
    }

    /* renamed from: a */
    int mo10892a(InputStream inputStream, C4564b bVar) throws IOException;

    /* renamed from: b */
    ImageType mo10893b(ByteBuffer byteBuffer) throws IOException;

    /* renamed from: c */
    ImageType mo10894c(InputStream inputStream) throws IOException;

    /* renamed from: d */
    int mo10895d(ByteBuffer byteBuffer, C4564b bVar) throws IOException;
}
