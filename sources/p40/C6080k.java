...
/* renamed from: p40.k */
public final class C6080k extends C6066a<Boolean> {
    /* renamed from: m */
    public final boolean mo20295m(Context context, C18299a aVar, ServerId serverId, long j) {
        ...
        return C19731i.m47197a(context).mo52084b(serverId, j).mo51802d().mo52120l(gtfsConfiguration.f15147b & 3903, context);
    }
    ...
    public final Boolean mo6593o(C13752e eVar, C18299a aVar, ServerId serverId, long j) throws IOException, AppDataPartLoadFailedException, ServerException {
        try {
            return new C5603c(eVar.f33852a, serverId, j, ((C19728f) aVar.mo50690c("METRO_CONTEXT")).f50165a.f16128c, ((GtfsConfiguration) aVar.mo50690c("GTFS_CONFIGURATION")).f15147b & 3903, false).call();
        } catch (Exception e) {
