...
/* renamed from: xt.n */
public final class C20607n extends C20589d {
    public C20607n() {
        super(14);
    }
    ...
    public final void mo52782a(C12797f fVar, Itinerary itinerary, TripPlannerLocations tripPlannerLocations) {
        ...
        ((TextView) fVar.mo39639f(R.id.metadata)).setText(DistanceUtils.m17934a((int) DistanceUtils.m17936c(e, ((BicycleLeg) mo52791j(itinerary)).f41943f.mo24339Z0()), e));
    }
    ...
    public final void mo52789b(C20590e.C20591a aVar, Itinerary itinerary) {
        ...
        BicycleLeg bicycleLeg = (BicycleLeg) mo52791j(itinerary);
        aVar.f52079a.setVisibility(0);
        aVar.f52081c.setText(R.string.tripplan_itinerary_bike_label);
        aVar.f52080b.setImageResource(R.drawable.ic_bicycle_24_on_surface_emphasis_high);
        int c = (int) DistanceUtils.m17936c(context, bicycleLeg.f41943f.mo24339Z0());
        ...
        long t = C16783l.m42488t(bicycleLeg, TimeUnit.MINUTES);
    ...
    public final View mo52786h(ViewGroup viewGroup) {
        return C13715c.m34239e(viewGroup, R.layout.suggested_routes_single_bicycle_leg_result, viewGroup, false);
    }
    ...
    public final boolean mo52788n(Itinerary itinerary) {
        return C16783l.m42465B(itinerary, 11);
    }
}
