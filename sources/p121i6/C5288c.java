...
/* renamed from: i6.c */
public final class C5288c implements C5104n<Uri, InputStream> {

    /* renamed from: a */
    public final Context f17459a;

    /* renamed from: i6.c$a */
    public static class C5289a implements C5106o<Uri, InputStream> {
        ...
        public final C5104n<Uri, InputStream> mo20818b(C5112r rVar) {
            return new C5288c(this.f17460a);
        }
    }

    public C5288c(Context context) {
    ...
    public final C5104n.C5105a mo20816b(Object obj, int i, int i2, C1492e eVar) {
        ...
        if (z) {
            Long l = (Long) eVar.mo5848c(VideoDecoder.f7161d);
            ...
            if (z2) {
                ...
                return new C5104n.C5105a(dVar, C1793a.m5102c(context, uri, new C1793a.C1795b(context.getContentResolver())));
            }
        }
        return null;
    }
