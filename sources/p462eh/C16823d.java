...
public final class C16823d {
    ...
    /* renamed from: a */
    public static String m42608a(int i, String str) {
        int i2;
        int i3;
        ...
        if (i4 >= 0) {
            ...
            for (int i6 = 0; i6 < 0 + length; i6++) {
                int i7 = i - 1;
                char charAt = cArr[i7] ^ str.charAt(i6);
                while (i7 > 0) {
                    if (charAt == 0 || (i3 = iArr2[i7]) == 0) {
                        ...
                        int[] iArr3 = f43795d;
                        int[] iArr4 = f43794c;
                        cArr[i7] = (char) (iArr3[(iArr4[charAt] + iArr4[i3]) % ValidationUtils.APPBOY_STRING_MAX_LENGTH] ^ c);
                    }
                    i7--;
                }
                if (charAt == 0 || (i2 = iArr2[0]) == 0) {
                    ...
                    int[] iArr5 = f43795d;
                    int[] iArr6 = f43794c;
                    cArr[0] = (char) iArr5[(iArr6[charAt] + iArr6[i2]) % ValidationUtils.APPBOY_STRING_MAX_LENGTH];
                }
            }
