...
class BlipsPermissions {
    ...
    public static /* synthetic */ class C253521 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: zendesk.core.BlipsPermissions.C253521.<clinit>():void");
        }
    }
    ...
    public boolean isEnabled(BlipsGroup blipsGroup) {
        int i = C253521.$SwitchMap$zendesk$core$BlipsGroup[blipsGroup.ordinal()];
        if (i == 1) {
