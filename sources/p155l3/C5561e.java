...
/* renamed from: l3.e */
public final class C5561e extends C5558c<C5463b> {
    static {
        C4656h.m11961e("NetworkMeteredCtrlr");
    }

    public C5561e(Context context, C6165a aVar) {
        super(C5677g.m13960a(context, aVar).f18455c);
    }

    /* renamed from: b */
    public final boolean mo21396b(C5956p pVar) {
        if (pVar.f19091j.f15877a == NetworkType.METERED) {
            return true;
        }
        return false;
    }
