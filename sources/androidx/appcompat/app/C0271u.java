...
public final class C0271u {
    ...
    /* renamed from: a */
    public final void mo987a(double d, double d2, long j) {
        ...
        if (sin3 >= 1.0d) {
            ...
            this.f785a = Math.round((sin2 + acos) * 8.64E7d) + 946728000000L;
            long round = Math.round((sin2 - acos) * 8.64E7d) + 946728000000L;
            this.f786b = round;
            if (round >= j || this.f785a <= j) {
                this.f787c = 1;
            } else {
                this.f787c = 0;
            }
