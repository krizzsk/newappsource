...
public class ViewPager extends ViewGroup {
    ...
    public class MyAccessibilityDelegate extends C6315a {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, C6531g gVar) {
            ...
            gVar.mo22644i(ViewPager.class.getName());
            gVar.mo22648m(canScroll());
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder k = C13555b.m33972k("FragmentPager.SavedState{");
            k.append(Integer.toHexString(System.identityHashCode(this)));
            k.append(" position=");
            return C13437d.m33707l(k, this.position, "}");
        }
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        while (i14 < size2) {
            ...
            while (true) {
                ...
                f7 += this.mAdapter.getPageWidth(i13) + f;
                i13++;
            }
            if (i2 == i11) {
    ...
    private void completeScroll(boolean z) {
        ...
        if (z) {
            ...
            C6333d0.C6337d.m15053m(this, runnable);
            return;
        }
    ...
    public void initViewPager() {
        ...
        C6333d0.m15029q(this, new MyAccessibilityDelegate());
        if (C6333d0.C6337d.m15043c(this) == 0) {
            C6333d0.C6337d.m15059s(this, 1);
        }
        C6333d0.C6342i.m15104u(this, new C6391t() {
            private final Rect mTempRect = new Rect();

            public C6396v0 onApplyWindowInsets(View view, C6396v0 v0Var) {
                C6396v0 l = C6333d0.m15024l(view, v0Var);
                if (l.f20044a.mo22528m()) {
                    return l;
                }
                Rect rect = this.mTempRect;
                rect.left = l.mo22504c();
                rect.top = l.mo22506e();
                rect.right = l.mo22505d();
                rect.bottom = l.mo22503b();
                int childCount = ViewPager.this.getChildCount();
                for (int i = 0; i < childCount; i++) {
                    C6396v0 b = C6333d0.m15014b(ViewPager.this.getChildAt(i), l);
                    rect.left = Math.min(b.mo22504c(), rect.left);
                    rect.top = Math.min(b.mo22506e(), rect.top);
                    rect.right = Math.min(b.mo22505d(), rect.right);
                    rect.bottom = Math.min(b.mo22503b(), rect.bottom);
                }
                return l.mo22508g(rect.left, rect.top, rect.right, rect.bottom);
            }
        });
    }
    ...
    public void populate(int r15) {
        ...
        L_0x0208:
            return
        L_0x0209:
            android.content.res.Resources r15 = r14.getResources()     // Catch:{ NotFoundException -> 0x0216 }
            int r0 = r14.getId()     // Catch:{ NotFoundException -> 0x0216 }
            java.lang.String r15 = r15.getResourceName(r0)     // Catch:{ NotFoundException -> 0x0216 }
            goto L_0x021e
        L_0x0216:
            int r15 = r14.getId()
        ...
        L_0x021e:
            ...
            p001a0.C0016g.m41y(r1, r3, r4, r2, r5)
            r1.append(r15)
    ...
    public void smoothScrollTo(int i, int i2, int i3) {
        ...
        if (abs > 0) {
            ...
            i5 = (int) (((((float) Math.abs(i7)) / ((this.mAdapter.getPageWidth(this.mCurItem) * f) + ((float) this.mPageMargin))) + 1.0f) * 100.0f);
        }
    ...
    public void setPageMarginDrawable(int i) {
        setPageMarginDrawable(C4732a.getDrawable(getContext(), i));
    }
