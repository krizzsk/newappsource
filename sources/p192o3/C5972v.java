...
public final class C5972v {
    ...
    /* renamed from: o3.v$a */
    public static /* synthetic */ class C5973a {
        ...
        /* renamed from: c */
        public static final /* synthetic */ int[] f19117c;

        /* renamed from: d */
        public static final /* synthetic */ int[] f19118d;
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f19118d     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x0043:
                r3 = 4
                int[] r4 = f19117c     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                r4 = 5
                int[] r5 = f19117c     // Catch:{ NoSuchFieldError -> 0x0059 }
            ...
            L_0x006a:
                int[] r5 = f19116b     // Catch:{ NoSuchFieldError -> 0x0074 }
            ...
            L_0x0085:
                int[] r1 = f19115a     // Catch:{ NoSuchFieldError -> 0x008f }
            ...
            L_0x008f:
                int[] r0 = f19115a     // Catch:{ NoSuchFieldError -> 0x0099 }
            ...
            L_0x0099:
                int[] r0 = f19115a     // Catch:{ NoSuchFieldError -> 0x00a3 }
            ...
            L_0x00a3:
                int[] r0 = f19115a     // Catch:{ NoSuchFieldError -> 0x00ad }
            ...
            L_0x00ad:
                int[] r0 = f19115a     // Catch:{ NoSuchFieldError -> 0x00b8 }
            ...
            L_0x00b8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p192o3.C5972v.C5973a.<clinit>():void");
        }
    }
    ...
    public static p081f3.C4650c m14454a(byte[] r7) {
        /*
            f3.c r0 = new f3.c
            r0.<init>()
        ...
        L_0x0017:
            ...
            f3.c$a r5 = new f3.c$a     // Catch:{ IOException -> 0x003d }
            r5.<init>(r4, r3)     // Catch:{ IOException -> 0x003d }
            java.util.HashSet r3 = r0.f15892a     // Catch:{ IOException -> 0x003d }
        ...
        L_0x006f:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p192o3.C5972v.m14454a(byte[]):f3.c");
    }

    /* renamed from: b */
    public static BackoffPolicy m14455b(int i) {
        if (i == 0) {
        ...
        throw new IllegalArgumentException(C25541a.m63878h("Could not convert ", i, " to BackoffPolicy"));
    }

    /* renamed from: c */
    public static NetworkType m14456c(int i) {
        if (i == 0) {
        ...
        throw new IllegalArgumentException(C25541a.m63878h("Could not convert ", i, " to NetworkType"));
    }

    /* renamed from: d */
    public static OutOfQuotaPolicy m14457d(int i) {
        if (i == 0) {
        ...
        throw new IllegalArgumentException(C25541a.m63878h("Could not convert ", i, " to OutOfQuotaPolicy"));
    }

    /* renamed from: e */
    public static WorkInfo$State m14458e(int i) {
        if (i == 0) {
        ...
        throw new IllegalArgumentException(C25541a.m63878h("Could not convert ", i, " to State"));
    }

    /* renamed from: f */
    public static int m14459f(WorkInfo$State workInfo$State) {
        switch (C5973a.f19115a[workInfo$State.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
