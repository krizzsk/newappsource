...
/* renamed from: er.e */
public final class C16863e extends C20664g<Boolean> {
    /* renamed from: b */
    ...
    public final Object mo6591f(Context context, C18299a aVar, String str) throws IOException, AppDataPartLoadFailedException, ServerException {
        ...
        if (aVar2 != null && ((Boolean) aVar2.mo51505b(C19053d.f48487z)).booleanValue()) {
            return Boolean.TRUE;
        }
        throw new AppDataPartLoadFailedException("Carpool not supported in the current metro configuration.", (String) null, (Throwable) null);
    }
}
